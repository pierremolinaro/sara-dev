...
//                    february 10th, 2005, at 21h55'17"                      *
//                                                                           *
...
:mStringValue (1 COMMA_HERE) {
  mBoolValue [0] = 0 ;
  mBoolValue [1] = 0 ;
  mBoolValue [2] = false ; // Extra unused entry
...
bool sara_cli_options::getBoolOptionValue (const sint32 inIndex) const {
  return ((inIndex >= 0) && (inIndex < 2)) ? mBoolValue [inIndex] : false ;
}
...
char sara_cli_options::getBoolOptionChar (const sint32 inIndex) const {
  const char kCharArray [3] = {99, 118, '\0'} ;
...
sint32 sara_cli_options::getStringOptionsCount (void) const {
  return 0 ;
}
