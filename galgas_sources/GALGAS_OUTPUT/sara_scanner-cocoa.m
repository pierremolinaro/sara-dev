...
static const BOOL kEndOfScriptInTemplateArray_sara_5F_scanner [53] = {
  NO /* identifier */,
  NO /* literal_string */,
  NO /* machineIdf */,
  NO /* literal_integer */,
...
static SInt32 search_into_sara_5F_scanner_keyWordList (NSString * inSearchedString) {
...
- (UInt32) styleIndexForTerminal: (SInt32) inTerminal {
  static const UInt32 kTerminalSymbolStyles [54] = {0,
