...
appendTerminalMessageToSyntaxErrorMessage (const sint16 inTerminalIndex,
  ...
  static const char * syntaxErrorMessageArray [45] = {"end of source",
...
const sint16 sara_scanner::sara_scanner_table_size_keyWordList = 22 ;

const C_lexique_table_entry sara_scanner::sara_scanner_table_for_keyWordList [22] = {
  ...
  while (mCurrentTokenCode < 0) {
    ...
    try{
      if (testForInputChar ('a', 'z') ||
        ...
        enterDigitIntoUlong (ulongValue, getPreviousChar (), gErrorMessage_3, gErrorMessage_4, * this) ;
        do {
...
getTerminalStyleIndex (const sint32 inTerminal) {
  static const uint8 kTerminalSymbolStyles [45] = {0,
