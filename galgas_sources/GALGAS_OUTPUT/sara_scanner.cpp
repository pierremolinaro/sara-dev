  ...
  while ((token.mTokenCode < 0) && (UNICODE_VALUE (mCurrentChar) != '\0')) {
    ...
    try{
      if (testForInputUTF32CharRange (TO_UNICODE ('a'), TO_UNICODE ('z')) ||
        ...
        do {
          ::scanner_action_enterCharacterIntoString (*this, token.identifierString, previousChar ()) ;
          if (testForInputUTF32CharRange (TO_UNICODE ('a'), TO_UNICODE ('z')) ||
              testForInputUTF32CharRange (TO_UNICODE ('A'), TO_UNICODE ('Z')) ||
        ...
        do {
          if (testForInputUTF32Char (TO_UNICODE ('\\'))) {
            if (testForInputUTF32Char (TO_UNICODE ('n'))) {
              ::scanner_action_enterCharacterIntoString (*this, token.identifierString, TO_UNICODE ('\n')) ;
            }else if (testForInputUTF32Char (TO_UNICODE ('\\'))) {
              ::scanner_action_enterCharacterIntoString (*this, token.identifierString, TO_UNICODE ('\\')) ;
            }else if (testForInputUTF32Char (TO_UNICODE ('\"'))) {
              ::scanner_action_enterCharacterIntoString (*this, token.identifierString, TO_UNICODE ('\"')) ;
        ...
        ::scanner_action_enterDigitIntoUlong (*this, token.ulongValue, previousChar (), gErrorMessage_3, gErrorMessage_4) ;
        do {
