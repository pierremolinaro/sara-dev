...
//--- Syntax error message for terminal '$out$' :
static const char * gSyntaxErrorMessage_out = "the 'out' key word" ;
...
const sint16 sara_scanner::sara_scanner_table_size_keyWordList = 8 ;

const C_lexique_table_entry sara_scanner::sara_scanner_table_for_keyWordList [8] = {
  C_lexique_table_entry ("out", 3, sara_scanner_1_out),
...
const sint16 sara_scanner::sara_scanner_table_size_delimitorsList = 12 ;

const C_lexique_table_entry sara_scanner::sara_scanner_table_for_delimitorsList [12] = {
