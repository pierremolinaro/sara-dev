  ...
  while (mCurrentTokenCode < 0) {
    ...
    try{
      if (testForInputChar ('a', 'z') ||
        ...
        mCurrentTokenCode = sara_scanner_1__7E ;
        ...
        mCurrentTokenCode = sara_scanner_1__2B ;
        ...
        loop_ = true ;
        if (testForInputChar ('\"')) {
          mCurrentTokenCode = sara_scanner_1_literal_5Fstring ;
...
void sara_scanner::_restoreContextFromToken (void) {
  ...
  identifierString = _p->identifierString ;
  ulongValue = _p->ulongValue ;
}
