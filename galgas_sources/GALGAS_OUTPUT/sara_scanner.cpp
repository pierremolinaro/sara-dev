  ...
  while (currentTokenCode_ < 0) {
    ...
    try{
      if (testForInputChar ('a', 'z') ||
        ...
        loop_ = true ;
        currentTokenCode_ = search_into_keyWordList (identifierString) ;
        if (currentTokenCode_ == -1) {
          currentTokenCode_ = sara_scanner_1_identifier ;
        }
        _enterToken (currentTokenCode_) ;
      }else if (testForInputString ("->", 2)) {
        currentTokenCode_ = sara_scanner_1__2D_3E ;
        _enterToken (sara_scanner_1__2D_3E) ;
      }else if (testForInputString ("||", 2)) {
        currentTokenCode_ = sara_scanner_1__7C_7C ;
        _enterToken (sara_scanner_1__7C_7C) ;
      }else if (testForInputString (":=", 2)) {
        currentTokenCode_ = sara_scanner_1__3A_3D ;
        _enterToken (sara_scanner_1__3A_3D) ;
      }else if (testForInputString ("**", 2)) {
        currentTokenCode_ = sara_scanner_1__2A_2A ;
        _enterToken (sara_scanner_1__2A_2A) ;
      }else if (testForInputString (",", 1)) {
        currentTokenCode_ = sara_scanner_1__2C ;
        _enterToken (sara_scanner_1__2C) ;
      }else if (testForInputString (";", 1)) {
        currentTokenCode_ = sara_scanner_1__3B ;
        _enterToken (sara_scanner_1__3B) ;
      }else if (testForInputString (":", 1)) {
        currentTokenCode_ = sara_scanner_1__3A ;
        _enterToken (sara_scanner_1__3A) ;
      }else if (testForInputString ("{", 1)) {
        currentTokenCode_ = sara_scanner_1__7B ;
        _enterToken (sara_scanner_1__7B) ;
      }else if (testForInputString ("}", 1)) {
        currentTokenCode_ = sara_scanner_1__7D ;
        _enterToken (sara_scanner_1__7D) ;
      }else if (testForInputString ("&", 1)) {
        currentTokenCode_ = sara_scanner_1__26 ;
        _enterToken (sara_scanner_1__26) ;
      }else if (testForInputString ("~", 1)) {
        currentTokenCode_ = sara_scanner_1__7E ;
        _enterToken (sara_scanner_1__7E) ;
      }else if (testForInputString ("\?", 1)) {
        currentTokenCode_ = sara_scanner_1__3F ;
        _enterToken (sara_scanner_1__3F) ;
      }else if (testForInputString ("!", 1)) {
        currentTokenCode_ = sara_scanner_1__21 ;
        _enterToken (sara_scanner_1__21) ;
      }else if (testForInputString ("|", 1)) {
        currentTokenCode_ = sara_scanner_1__7C ;
        _enterToken (sara_scanner_1__7C) ;
      }else if (testForInputString ("+", 1)) {
        currentTokenCode_ = sara_scanner_1__2B ;
        _enterToken (sara_scanner_1__2B) ;
      }else if (testForInputString ("(", 1)) {
        currentTokenCode_ = sara_scanner_1__28 ;
        _enterToken (sara_scanner_1__28) ;
      }else if (testForInputString (")", 1)) {
        currentTokenCode_ = sara_scanner_1__29 ;
        _enterToken (sara_scanner_1__29) ;
      }else if (testForInputString ("^", 1)) {
        currentTokenCode_ = sara_scanner_1__5E ;
        _enterToken (sara_scanner_1__5E) ;
      }else if (testForInputString ("=", 1)) {
        currentTokenCode_ = sara_scanner_1__3D ;
        _enterToken (sara_scanner_1__3D) ;
      }else if (testForInputString ("*", 1)) {
        currentTokenCode_ = sara_scanner_1__2A ;
        _enterToken (sara_scanner_1__2A) ;
      }else if (testForInputString ("@", 1)) {
        currentTokenCode_ = sara_scanner_1__40 ;
        _enterToken (sara_scanner_1__40) ;
      }else if (testForInputChar ('\"')) {
        do {
          if (testForInputChar ('\\')) {
            if (testForInputChar ('n')) {
              scanner_action_enterCharacterIntoString (identifierString, '\n') ;
            }else if (testForInputChar ('\\')) {
              scanner_action_enterCharacterIntoString (identifierString, '\\') ;
            }else if (testForInputChar ('\"')) {
              scanner_action_enterCharacterIntoString (identifierString, '\"') ;
        ...
        loop_ = true ;
        if (testForInputChar ('\"')) {
          currentTokenCode_ = sara_scanner_1_literal_5Fstring ;
          _enterToken (sara_scanner_1_literal_5Fstring) ;
        }else{
        ...
        currentTokenCode_ = sara_scanner_1_machineIdf ;
        _enterToken (sara_scanner_1_machineIdf) ;
      }else if (testForInputChar ('0', '9')) {
        scanner_action_enterDigitIntoUlong (ulongValue, previousChar (), gErrorMessage_3, gErrorMessage_4) ;
        do {
        ...
        loop_ = true ;
        currentTokenCode_ = sara_scanner_1_literal_5Finteger ;
        _enterToken (sara_scanner_1_literal_5Finteger) ;
        ...
        currentTokenCode_ = sara_scanner_1_ ; // Empty string code
...
void sara_scanner::_enterToken (const sint16 inTokenCode) {
  ...
  _p->identifierString = identifierString ;
  _p->ulongValue = ulongValue ;
