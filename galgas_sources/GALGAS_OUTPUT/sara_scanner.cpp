...
appendTerminalMessageToSyntaxErrorMessage (const sint16 inTerminalIndex,
  ...
  static const char * syntaxErrorMessageArray [52] = {"end of source",
...
const sint16 sara_scanner::sara_scanner_table_size_delimitorsList = 20 ;

const C_lexique_table_entry sara_scanner::sara_scanner_table_for_delimitorsList [20] = {
...
const sint16 sara_scanner::sara_scanner_table_size_keyWordList = 27 ;

const C_lexique_table_entry sara_scanner::sara_scanner_table_for_keyWordList [27] = {
  ...
  while (mCurrentTokenCode < 0) {
    ...
    try{
      if (testForInputChar ('a', 'z') ||
        ...
        do {
          enterCharacterIntoString (identifierString, previousChar (), * this) ;
          if (testForInputChar ('a', 'z') ||
              testForInputChar ('A', 'Z') ||
              testForInputChar ('_') ||
        ...
        do {
          if (testForInputChar ('\\')) {
            if (testForInputChar ('n')) {
              ...
              enterCharacterIntoString (identifierString, '\\', * this) ;
            }else if (testForInputChar ('\"')) {
              enterCharacterIntoString (identifierString, '\"', * this) ;
            }else{
              lexicalError (gErrorMessage_1) ;
            }
          }else if (testForInputChar (' ') ||
              testForInputChar ('!') ||
        ...
        enterDigitIntoUlong (ulongValue, previousChar (), gErrorMessage_3, gErrorMessage_4, * this) ;
        do {
...
terminalStyleIndex (const sint32 inTerminal) {
  static const uint8 kTerminalSymbolStyles [52] = {0,
