...
void C_Lexique_sara_5F_scanner::appendTerminalMessageToSyntaxErrorMessage (const PMSInt16 inTerminalIndex,
...
PMSInt16 C_Lexique_sara_5F_scanner::search_into_delimitorsList (const C_String & inSearchedString) {
...
PMSInt16 C_Lexique_sara_5F_scanner::search_into_keyWordList (const C_String & inSearchedString) {
...
PMUInt32 C_Lexique_sara_5F_scanner::attributeValue_ulongValue (void) const {
  cTokenFor_sara_5F_scanner * ptr = (cTokenFor_sara_5F_scanner *) mCurrentTokenPtr ;
...
void C_Lexique_sara_5F_scanner::assignFromAttribute_identifierString (GGS_lstring & outValue) const {
  cTokenFor_sara_5F_scanner * ptr = (cTokenFor_sara_5F_scanner *) mCurrentTokenPtr ;
...
void C_Lexique_sara_5F_scanner::assignFromAttribute_ulongValue (GGS_luint & outValue) const {
  cTokenFor_sara_5F_scanner * ptr = (cTokenFor_sara_5F_scanner *) mCurrentTokenPtr ;
...
GALGASap_lstring C_Lexique_sara_5F_scanner::synthetizedAttribute_identifierString (void) const {
  cTokenFor_sara_5F_scanner * ptr = (cTokenFor_sara_5F_scanner *) mCurrentTokenPtr ;
  macroValidObject (ptr, cTokenFor_sara_5F_scanner) ;
...
GALGASap_luint C_Lexique_sara_5F_scanner::synthetizedAttribute_ulongValue (void) const {
  cTokenFor_sara_5F_scanner * ptr = (cTokenFor_sara_5F_scanner *) mCurrentTokenPtr ;
  macroValidObject (ptr, cTokenFor_sara_5F_scanner) ;
  GALGASap_location currentLocation (GALGASap_location::constructor_new (ptr->mStartLocation, ptr->mEndLocation, sourceText () COMMA_HERE)) ;
  GALGASap_uint value (GALGASap_uint::constructor_new (ptr->mLexicalAttribute_ulongValue COMMA_HERE)) ;
