...
appendTerminalMessageToSyntaxErrorMessage (const sint16 inTerminalIndex,
  ...
  static const char * syntaxErrorMessageArray [24] = {"end of source",
...
const sint16 sara_scanner::sara_scanner_table_size_delimitorsList = 14 ;

const C_lexique_table_entry sara_scanner::sara_scanner_table_for_delimitorsList [14] = {
...
getTerminalStyleIndex (const sint32 inTerminal) {
  static const uint8 kTerminalSymbolStyles [24] = {0,
