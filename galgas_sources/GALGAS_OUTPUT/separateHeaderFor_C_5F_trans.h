...
//--- Attribute accessors
  public : VIRTUAL_IN_DEBUG GALGAS_AC_5F_boolExpression reader_mSourceStateExpression (UNUSED_LOCATION_ARGS) const ;
  public : VIRTUAL_IN_DEBUG GALGAS_AC_5F_boolExpression reader_mTargetStateExpression (UNUSED_LOCATION_ARGS) const ;
//--- Description
