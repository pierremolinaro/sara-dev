...
//---------------------------------------------------------------------------*
//                                                                           *
//                        class 'C_modalComposition'                         *
//                                                                           *
//---------------------------------------------------------------------------*

#define macro_C_modalComposition

#define macroInheritFrom_C_modalComposition

class cPtr_C_modalComposition : public cPtr_AC_machineDefinition {
  private : typedef cPtr_AC_machineDefinition inherited ;
  macroInheritFrom_AC_machineDefinition
  macro_C_modalComposition
  public : cPtr_C_modalComposition (const GGS_AC_machineDefinition & ,
                                const GGS_location & ,
                                const GGS_AC_machineDefinition & ) ;
  public : GGS_AC_machineDefinition  mLeftOperand ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//                  GALGAS class 'GGS_C_modalComposition'                    *
//                                                                           *
//---------------------------------------------------------------------------*

class GGS_C_modalComposition {
  #ifndef DO_NOT_GENERATE_MEMORY_CHECK_CODE
    public : static cPtr_C_modalComposition * constructor_new (const GGS_AC_machineDefinition & argument_0,
                                const GGS_location & argument_1,
                                const GGS_AC_machineDefinition & argument_2) ;
  #else
    public : inline static cPtr_C_modalComposition * constructor_new (const GGS_AC_machineDefinition & argument_0,
                                const GGS_location & argument_1,
                                const GGS_AC_machineDefinition & argument_2) {
      return new cPtr_C_modalComposition(argument_0,
                                argument_1,
                                argument_2) ;
    }
  #endif
