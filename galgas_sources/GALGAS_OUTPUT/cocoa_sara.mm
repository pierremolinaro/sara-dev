...
#import "sara_scanner.h"
#import "sara_cli_options.h"
...
static sara_cli_options gOption0 ;
...
static sara_scanner * gScannerPtr = NULL ;
...
static const uint16 * kPopUpListData [54] = {
  NULL,
  NULL,
  NULL,
  NULL,
...
sint32 getStylesCount (void) {
  return sara_scanner::getStylesCount () ;
}

//---------------------------------------------------------------------------*

const char * getStyleName (const sint32 inIndex) {
  return sara_scanner::getStyleName (inIndex) ;
}

//---------------------------------------------------------------------------*

const char * getStyleIdentifier (const sint32 inIndex) {
  return sara_scanner::getStyleIdentifier (inIndex) ;
}
...
scanThenGetStyledRangeArray (NSString * inSourceString,
  ...
  if (gScannerPtr == NULL) {
    ...
    macroMyNew (gScannerPtr, sara_scanner (gIOParametersPtr COMMA_HERE)) ;
  }
