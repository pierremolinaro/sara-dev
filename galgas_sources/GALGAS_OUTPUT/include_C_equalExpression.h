...
#ifndef C_equalExpression_DEFINED
#define C_equalExpression_DEFINED
...
class GGG_C_equalExpression : public GGG_AC_boolExpression {
  private : typedef GGG_AC_boolExpression inherited ;
  public : GGG_C_equalExpression (const GGS_AC_boolExpression & ,
                                const GGS_AC_boolExpression &  COMMA_LOCATION_ARGS) ;
} ;
