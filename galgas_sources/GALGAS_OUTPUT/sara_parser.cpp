...
void sara_parser::
pr_start_symbol_sara_parser_233_20_ (sara_scanner & lexique_var_) {
...
void sara_parser::
pr_component_sara_parser_245_17_ (sara_scanner & lexique_var_,
  ...
  nt_definition_expression_ (lexique_var_, var_cas_inputVariableMap, var_cas_outputVariableMap, var_cas_definition) ;
...
void sara_parser::
pr_input_expression_sara_parser_286_24_ (sara_scanner & lexique_var_,
...
void sara_parser::
pr_input_and_expression_sara_parser_302_28_ (sara_scanner & lexique_var_,
                                GGS_M_inputOutputVarMap  &var_cas_ioInputVarMap,
                                GGS_AC_expression  &var_cas_outExpression) {
...
void sara_parser::
pr_input_primary_sara_parser_318_21_ (sara_scanner & lexique_var_,
                                GGS_M_inputOutputVarMap  &var_cas_ioInputVarMap,
                                GGS_AC_expression  &var_cas_outExpression) {
  lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1__28) ;
...
void sara_parser::
pr_input_primary_sara_parser_329_21_ (sara_scanner & lexique_var_,
                                GGS_M_inputOutputVarMap  &var_cas_ioInputVarMap,
                                GGS_AC_expression  &var_cas_outExpression) {
  GGS_lstring  var_cas_inputVarName ;
  lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1_identifier) ;
...
void sara_parser::
pr_input_primary_sara_parser_342_21_ (sara_scanner & lexique_var_,
                                GGS_M_inputOutputVarMap  &var_cas_ioInputVarMap,
                                GGS_AC_expression  &var_cas_outExpression) {
...
void sara_parser::
pr_input_primary_sara_parser_354_21_ (sara_scanner & lexique_var_,
                                GGS_M_inputOutputVarMap  &/* var_cas_ioInputVarMap */,
                                GGS_AC_expression  &var_cas_outExpression) {
...
void sara_parser::
pr_input_primary_sara_parser_364_21_ (sara_scanner & lexique_var_,
                                GGS_M_inputOutputVarMap  &/* var_cas_ioInputVarMap */,
                                GGS_AC_expression  &var_cas_outExpression) {
...
void sara_parser::
pr_definition_expression_sara_parser_376_29_ (sara_scanner & lexique_var_,
                                GGS_M_inputOutputVarMap  &var_cas_inputVariableMap,
                                GGS_M_inputOutputVarMap  &var_cas_outputVariableMap,
                                GGS_AC_machineDefinition  &var_cas_outDefinition) {
  nt_explicit_automaton_ (lexique_var_, var_cas_inputVariableMap, var_cas_outputVariableMap, var_cas_outDefinition) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_sara_parser_5 (lexique_var_)) {
        case 2 : {
          ...
          nt_explicit_automaton_ (lexique_var_, var_cas_inputVariableMap, var_cas_outputVariableMap, var_cas_rightOperand) ;
...
void sara_parser::
pr_explicit_automaton_sara_parser_396_26_ (sara_scanner & lexique_var_,
                                GGS_M_inputOutputVarMap  &var_cas_inputVariableMap,
                                GGS_M_inputOutputVarMap  &var_cas_outputVariableMap,
                                GGS_AC_machineDefinition  &var_cas_outDefinition) {
  GGS_M_stateMap  var_cas_statesMap ;
  ...
  GGS_M_stateMap::element_type * operand_14537 = var_cas_statesMap.getFirstItem () ;
  while (operand_14537 != NULL) {
    macroValidPointer (operand_14537) ;
    if (((! var_cas_stateDefinitionMap.reader_hasKey (operand_14537->mKey))).isBuiltAndTrue ()) {
        GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "'")) + (operand_14537->mKey.reader_value ()))) + (GGS_string (true, "' state is not described")))) ;
    }
    operand_14537 = operand_14537->getNextItem () ;
  }
  lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1__7D) ;
