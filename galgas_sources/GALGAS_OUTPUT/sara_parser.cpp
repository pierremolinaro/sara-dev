...
//                    november 17th, 2006, at 19h34'40"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
pr_component_sara_parser_124_17_ (sara_scanner & _inLexique,
  ...
  if (var_cas_ioMachinesMap._isBuilt ()) {
    var_cas_ioMachinesMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_machineName, var_cas_machineIndex, automatic_var_0, automatic_var_1, automatic_var_2 SOURCE_FILE_AT_LINE (138)) ;
  }
...
pr_component_sara_parser_146_17_ (sara_scanner & _inLexique,
  ...
  if (var_cas_ioMachinesMap._isBuilt ()) {
    var_cas_ioMachinesMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_machineName1, var_cas_machineIndex1, automatic_var_3, automatic_var_4, automatic_var_5 SOURCE_FILE_AT_LINE (163)) ;
  }
  ...
  if (var_cas_ioMachinesMap._isBuilt ()) {
    var_cas_ioMachinesMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_machineName2, var_cas_machineIndex2, automatic_var_6, automatic_var_7, automatic_var_8 SOURCE_FILE_AT_LINE (166)) ;
  }
  GGS_AC_job  var_cas_job ;
...
pr_component_sara_parser_174_17_ (sara_scanner & _inLexique,
  ...
  if (var_cas_ioMachinesMap._isBuilt ()) {
    var_cas_ioMachinesMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_machineName, var_cas_machineIndex, automatic_var_9, automatic_var_10, automatic_var_11 SOURCE_FILE_AT_LINE (188)) ;
  }
  GGS_AC_job  var_cas_job ;
      ...
      switch (select_repeat_sara_parser_29 (_inLexique)) {
        case 2 : {
          ...
          if (var_cas_outModeMap._isBuilt ()) {
            var_cas_outModeMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_sourceModeName, var_cas_sourceModeIndex, automatic_var_12 SOURCE_FILE_AT_LINE (862)) ;
          }
          ...
          if (var_cas_outModeMap._isBuilt ()) {
            var_cas_outModeMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_targetModeName, var_cas_targetModeIndex, automatic_var_13 SOURCE_FILE_AT_LINE (867)) ;
          }
          _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__3B) ;
    ...
    while (syntaxRepeat) {
      switch (select_repeat_sara_parser_31 (_inLexique)) {
        case 2 : {
          ...
          if (var_cas_outModeMap._isBuilt ()) {
            var_cas_outModeMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_sourceModeName, var_cas_sourceModeIndex, automatic_var_14 SOURCE_FILE_AT_LINE (903)) ;
          }
          _inLexique.acceptTerminal (sara_scanner::sara_scanner_1_to) ;
          GGS_lstring  var_cas_targetModeName ;
          _inLexique.acceptTerminal (sara_scanner::sara_scanner_1_identifier) ;
          ...
          if (var_cas_outModeMap._isBuilt ()) {
            var_cas_outModeMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_targetModeName, var_cas_targetModeIndex, automatic_var_15 SOURCE_FILE_AT_LINE (908)) ;
          }
          _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__3B) ;
