...
//                    september 24th, 2008, at 19h13'21"                     *
//                                                                           *
//---------------------------------------------------------------------------*
              ...
              { bool syntaxRepeat_19 = true ;
                while (syntaxRepeat_19) {
                    ...
                    if (((var_cas_v.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (523)))._operator_strictSup (GGS_uint (true, 1U))).isBuiltAndTrue ()) {
                      var_cas_v.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this value is not a  binary digit") COMMA_SOURCE_FILE_AT_LINE (525)) ;
                    }
  ...
  }
  {
    ...
    while (((operand_36154 = enumerator_36154.nextObject ()))) {
      ...
      if (((var_cas_stateDefinitionMap.reader_hasKey (_inLexique, operand_36154->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1146)) COMMA_SOURCE_FILE_AT_LINE (1146)))._operator_not ()).isBuiltAndTrue ()) {
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "'"))._operator_concat (operand_36154->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1147))))._operator_concat (GGS_string (true, "' state is not described")) COMMA_SOURCE_FILE_AT_LINE (1148)) ;
      }
    }
  }
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__7D) COMMA_HERE) ;
