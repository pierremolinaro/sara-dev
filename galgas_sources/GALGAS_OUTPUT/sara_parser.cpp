...
//                    november 14th, 2006, at 18h47'55"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
pr_io_primary_sara_parser_709_18_ (sara_scanner & _inLexique,
  ...
  if (((var_cas_inputVariablesCount) != (var_cas_machineInputVariableCount)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((((((GGS_string (true, "The '$")) + (var_cas_machineIdentifier))) + (GGS_string (true, "' machine defines ")))) + (var_cas_machineInputVariableCount.reader_string (_inLexique SOURCE_FILE_AT_LINE (736))))) + (GGS_string (true, " input variable(s), but this operand defines ")))) + (var_cas_inputVariablesCount.reader_string (_inLexique SOURCE_FILE_AT_LINE (737))))) + (GGS_string (true, " input variable(s)"))) SOURCE_FILE_AT_LINE (738)) ;
  }
  _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__28) ;
    ...
    while (syntaxRepeat) {
      switch (select_repeat_sara_parser_29 (_inLexique)) {
        case 2 : {
          ...
          GGS_AC_machineDefinition  var_cas_25846 ;
          if (var_cas_outModeMap._isBuilt ()) {
            var_cas_outModeMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_sourceModeName, var_cas_sourceModeIndex, var_cas_25846 SOURCE_FILE_AT_LINE (862)) ;
          }
          ...
          GGS_AC_machineDefinition  var_cas_26025 ;
          if (var_cas_outModeMap._isBuilt ()) {
            var_cas_outModeMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_targetModeName, var_cas_targetModeIndex, var_cas_26025 SOURCE_FILE_AT_LINE (867)) ;
          }
          _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__3B) ;
    ...
    while (syntaxRepeat) {
      switch (select_repeat_sara_parser_31 (_inLexique)) {
        case 2 : {
          ...
          var_cas_sourceModeName.defineAttributeFromScanner (_inLexique.identifierString, _inLexique) ;
          GGS_luint  var_cas_sourceModeIndex ;
          GGS_AC_machineDefinition  var_cas_27144 ;
          if (var_cas_outModeMap._isBuilt ()) {
            var_cas_outModeMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_sourceModeName, var_cas_sourceModeIndex, var_cas_27144 SOURCE_FILE_AT_LINE (903)) ;
          }
          _inLexique.acceptTerminal (sara_scanner::sara_scanner_1_to) ;
          GGS_lstring  var_cas_targetModeName ;
          _inLexique.acceptTerminal (sara_scanner::sara_scanner_1_identifier) ;
          var_cas_targetModeName.defineAttributeFromScanner (_inLexique.identifierString, _inLexique) ;
          GGS_luint  var_cas_targetModeIndex ;
          GGS_AC_machineDefinition  var_cas_27323 ;
          if (var_cas_outModeMap._isBuilt ()) {
            var_cas_outModeMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_targetModeName, var_cas_targetModeIndex, var_cas_27323 SOURCE_FILE_AT_LINE (908)) ;
          }
          _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__3B) ;
...
pr_explicit_automaton_sara_parser_1112_26_ (sara_scanner & _inLexique,
  ...
  GGS_M_stateMap::element_type * operand_36882 = var_cas_statesMap.firstObject () ;
  while ((operand_36882 != NULL)) {
    macroValidPointer (operand_36882) ;
    if (((! (var_cas_stateDefinitionMap.reader_hasKey (_inLexique, operand_36882->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1197)) SOURCE_FILE_AT_LINE (1197))))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "'")) + (operand_36882->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1198))))) + (GGS_string (true, "' state is not described"))) SOURCE_FILE_AT_LINE (1199)) ;
    }
    operand_36882 = operand_36882->nextObject () ;
  }
  _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__7D) ;
