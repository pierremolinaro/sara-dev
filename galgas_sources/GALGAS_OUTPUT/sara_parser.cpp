...
pr_explicit_automaton_sara_parser_1061_25_ (sara_scanner & inLexique,
  ...
  }
  {
    ...
    while (((operand_36154 = enumerator_36154.nextObject ()))) {
      ...
      if (((var_cas_stateDefinitionMap.reader_hasKey (inLexique, operand_36154->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1146)) COMMA_SOURCE_FILE_AT_LINE (1146))).operator_not ()).isBuiltAndTrue ()) {
        GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("'")).operator_concat (operand_36154->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1147)))).operator_concat (GGS_string ("' state is not described")) COMMA_SOURCE_FILE_AT_LINE (1148)) ;
      }
    }
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__7D) COMMA_HERE) ;
