...
void sara_parser::
pr_start_symbol_sara_parser_288_20_ (sara_scanner & lexique_var_) {
...
void sara_parser::
pr_component_sara_parser_300_17_ (sara_scanner & lexique_var_,
  ...
  nt_definition_expression_ (lexique_var_, var_cas_variablesMap, var_cas_definition) ;
  GGS_AC_component  var_cas_component ;
  var_cas_component = GGS_C_machineComponent::constructor_new (var_cas_inputVariablesCount, var_cas_variablesMap, var_cas_definition) ;
...
void sara_parser::
pr_io_expression_sara_parser_341_21_ (sara_scanner & lexique_var_,
                                GGS_M_variablesMap  &var_cas_ioInputVarMap,
...
void sara_parser::
pr_io_and_expression_sara_parser_372_25_ (sara_scanner & lexique_var_,
                                GGS_M_variablesMap  &var_cas_ioInputVarMap,
                                GGS_AC_expression  &var_cas_outExpression) {
  nt_io_primary_ (lexique_var_, var_cas_ioInputVarMap, var_cas_outExpression) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_sara_parser_4 (lexique_var_)) {
        case 2 : {
          ...
          GGS_AC_expression  var_cas_rightExpression ;
          nt_io_primary_ (lexique_var_, var_cas_ioInputVarMap, var_cas_rightExpression) ;
...
void sara_parser::
pr_io_primary_sara_parser_388_18_ (sara_scanner & lexique_var_,
                                GGS_M_variablesMap  &var_cas_ioInputVarMap,
                                GGS_AC_expression  &var_cas_outExpression) {
  lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1__28) ;
...
void sara_parser::
pr_io_primary_sara_parser_399_18_ (sara_scanner & lexique_var_,
                                GGS_M_variablesMap  &var_cas_ioInputVarMap,
                                GGS_AC_expression  &var_cas_outExpression) {
  GGS_lstring  var_cas_inputVarName ;
  lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1_identifier) ;
...
void sara_parser::
pr_io_primary_sara_parser_412_18_ (sara_scanner & lexique_var_,
                                GGS_M_variablesMap  &var_cas_ioInputVarMap,
                                GGS_AC_expression  &var_cas_outExpression) {
  lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1__21) ;
  GGS_AC_expression  var_cas_expression ;
  nt_io_primary_ (lexique_var_, var_cas_ioInputVarMap, var_cas_expression) ;
...
void sara_parser::
pr_io_primary_sara_parser_424_18_ (sara_scanner & lexique_var_,
                                GGS_M_variablesMap  &/* var_cas_ioInputVarMap */,
                                GGS_AC_expression  &var_cas_outExpression) {
...
void sara_parser::
pr_io_primary_sara_parser_434_18_ (sara_scanner & lexique_var_,
                                GGS_M_variablesMap  &/* var_cas_ioInputVarMap */,
                                GGS_AC_expression  &var_cas_outExpression) {
...
void sara_parser::
pr_definition_expression_sara_parser_446_29_ (sara_scanner & lexique_var_,
                                GGS_M_variablesMap  &var_cas_variablesMap,
                                GGS_AC_machineDefinition  &var_cas_outDefinition) {
  nt_definition_expression_term_ (lexique_var_, var_cas_variablesMap, var_cas_outDefinition) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_sara_parser_5 (lexique_var_)) {
        case 2 : {
          ...
          nt_definition_expression_term_ (lexique_var_, var_cas_variablesMap, var_cas_rightOperand) ;
...
void sara_parser::
pr_definition_expression_term_sara_parser_481_34_ (sara_scanner & lexique_var_,
                                GGS_M_variablesMap  &var_cas_variablesMap,
                                GGS_AC_machineDefinition  &var_cas_outDefinition) {
  nt_definition_expression_factor_ (lexique_var_, var_cas_variablesMap, var_cas_outDefinition) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_sara_parser_6 (lexique_var_)) {
        case 2 : {
          ...
          var_cas_leftOperand = var_cas_outDefinition ;
          GGS_AC_machineDefinition  var_cas_rightOperand ;
          nt_definition_expression_factor_ (lexique_var_, var_cas_variablesMap, var_cas_rightOperand) ;
...
void sara_parser::
pr_definition_expression_factor_sara_parser_498_36_ (sara_scanner & lexique_var_,
                                GGS_M_variablesMap  &var_cas_variablesMap,
                                GGS_AC_machineDefinition  &var_cas_outDefinition) {
  switch (select_sara_parser_7 (lexique_var_)) {
    ...
    case 2 : {
      lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1__28) ;
      nt_definition_expression_ (lexique_var_, var_cas_variablesMap, var_cas_outDefinition) ;
      lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1__29) ;
      } break ;
    case 3 : {
      ...
      nt_definition_expression_ (lexique_var_, var_cas_variablesMap, var_cas_def) ;
      lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1__29) ;
      var_cas_outDefinition = GGS_C_existsDefinition::constructor_new (var_cas_def, var_cas_varIndex) ;
      } break ;
    case 4 : {
      lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1__21) ;
      GGS_AC_machineDefinition  var_cas_def ;
      nt_definition_expression_factor_ (lexique_var_, var_cas_variablesMap, var_cas_def) ;
...
void sara_parser::
pr_explicit_automaton_sara_parser_537_26_ (sara_scanner & lexique_var_,
                                GGS_M_variablesMap  &var_cas_variablesMap,
                                GGS_AC_machineDefinition  &var_cas_outDefinition) {
  GGS_M_stateMap  var_cas_statesMap ;
  var_cas_statesMap = GGS_M_stateMap::constructor_empty () ;
  ...
  GGS_M_stateMap::element_type * operand_18288 = var_cas_statesMap.getFirstItem () ;
  while (operand_18288 != NULL) {
    macroValidPointer (operand_18288) ;
    if (((! var_cas_stateDefinitionMap.reader_hasKey (operand_18288->mKey))).isBuiltAndTrue ()) {
        GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "'")) + (operand_18288->mKey.reader_value ()))) + (GGS_string (true, "' state is not described")))) ;
    }
    operand_18288 = operand_18288->getNextItem () ;
  }
  lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1__7D) ;
