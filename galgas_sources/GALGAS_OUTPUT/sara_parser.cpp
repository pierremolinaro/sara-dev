...
pr_component_sara_parser_507_17_ (sara_scanner & lexique_var_,
  ...
  GGS_uint  var_cas_15408 ;
  GGS_uint  var_cas_15411 ;
  GGS_M_variablesMap  var_cas_15414 ;
  if (var_cas_ioMachinesMap.isBuilt ()) {
    var_cas_ioMachinesMap ()->methode_searchKeyGetIndex (lexique_var_, var_cas_machineName, var_cas_machineIndex, var_cas_15408, var_cas_15411, var_cas_15414) ;
  }
...
pr_component_sara_parser_529_17_ (sara_scanner & lexique_var_,
  ...
  GGS_uint  var_cas_16127 ;
  GGS_uint  var_cas_16130 ;
  GGS_M_variablesMap  var_cas_16133 ;
  if (var_cas_ioMachinesMap.isBuilt ()) {
    var_cas_ioMachinesMap ()->methode_searchKeyGetIndex (lexique_var_, var_cas_machineName1, var_cas_machineIndex1, var_cas_16127, var_cas_16130, var_cas_16133) ;
  }
  GGS_luint  var_cas_machineIndex2 ;
  GGS_uint  var_cas_16267 ;
  GGS_uint  var_cas_16270 ;
  GGS_M_variablesMap  var_cas_16273 ;
  if (var_cas_ioMachinesMap.isBuilt ()) {
    var_cas_ioMachinesMap ()->methode_searchKeyGetIndex (lexique_var_, var_cas_machineName2, var_cas_machineIndex2, var_cas_16267, var_cas_16270, var_cas_16273) ;
  }
  GGS_AC_job  var_cas_job ;
...
pr_component_sara_parser_557_17_ (sara_scanner & lexique_var_,
  ...
  lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1__3B) ;
  GGS_luint  var_cas_machineIndex ;
  GGS_uint  var_cas_16928 ;
  GGS_uint  var_cas_16931 ;
  GGS_M_variablesMap  var_cas_16934 ;
  if (var_cas_ioMachinesMap.isBuilt ()) {
    var_cas_ioMachinesMap ()->methode_searchKeyGetIndex (lexique_var_, var_cas_machineName, var_cas_machineIndex, var_cas_16928, var_cas_16931, var_cas_16934) ;
  }
  GGS_AC_job  var_cas_job ;
    ...
    while (syntaxRepeat) {
      switch (select_repeat_sara_parser_29 (lexique_var_)) {
        case 2 : {
          ...
          GGS_AC_machineDefinition  var_cas_37177 ;
          if (var_cas_outModeMap.isBuilt ()) {
            var_cas_outModeMap ()->methode_searchKeyGetIndex (lexique_var_, var_cas_sourceModeName, var_cas_sourceModeIndex, var_cas_37177) ;
          }
          ...
          GGS_AC_machineDefinition  var_cas_37358 ;
          if (var_cas_outModeMap.isBuilt ()) {
            var_cas_outModeMap ()->methode_searchKeyGetIndex (lexique_var_, var_cas_targetModeName, var_cas_targetModeIndex, var_cas_37358) ;
          }
          lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1__3B) ;
    ...
    while (syntaxRepeat) {
      switch (select_repeat_sara_parser_31 (lexique_var_)) {
        case 2 : {
          ...
          var_cas_sourceModeName.defineAttribute (lexique_var_.identifierString, lexique_var_) ;
          GGS_luint  var_cas_sourceModeIndex ;
          GGS_AC_machineDefinition  var_cas_38474 ;
          if (var_cas_outModeMap.isBuilt ()) {
            var_cas_outModeMap ()->methode_searchKeyGetIndex (lexique_var_, var_cas_sourceModeName, var_cas_sourceModeIndex, var_cas_38474) ;
          }
          lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1_to) ;
          GGS_lstring  var_cas_targetModeName ;
          lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1_identifier) ;
          var_cas_targetModeName.defineAttribute (lexique_var_.identifierString, lexique_var_) ;
          GGS_luint  var_cas_targetModeIndex ;
          GGS_AC_machineDefinition  var_cas_38655 ;
          if (var_cas_outModeMap.isBuilt ()) {
            var_cas_outModeMap ()->methode_searchKeyGetIndex (lexique_var_, var_cas_targetModeName, var_cas_targetModeIndex, var_cas_38655) ;
          }
          lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1__3B) ;
          if (((var_cas_sourceModeIndex.reader_value ()) == (var_cas_targetModeIndex.reader_value ())).isBuiltAndTrue ()) {
              var_cas_targetModeIndex.reader_location ().signalGGSSemanticWarning (lexique_var_, GGS_string (true, "unuseful include: 'modalcompadd' operator never adds transitions from terminal states to initial states of the same mode")) ;
...
pr_explicit_automaton_sara_parser_1495_26_ (sara_scanner & lexique_var_,
  ...
  GGS_M_stateMap::element_type * operand_48204 = var_cas_statesMap.firstObject () ;
  while ((operand_48204 != NULL)) {
    macroValidPointer (operand_48204) ;
    if (((! var_cas_stateDefinitionMap.reader_hasKey (operand_48204->mKey.reader_value ()))).isBuiltAndTrue ()) {
        GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "'")) + (operand_48204->mKey.reader_value ()))) + (GGS_string (true, "' state is not described")))) ;
    }
    operand_48204 = operand_48204->nextObject () ;
  }
  lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1__7D) ;
