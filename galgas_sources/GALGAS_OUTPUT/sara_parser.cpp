              ...
              { bool syntaxRepeat = true ;
                while (syntaxRepeat) {
                    ...
                    if (((var_cas_v.reader_value (_inLexique SOURCE_FILE_AT_LINE (959))) > (GGS_uint (true, 1UL))).isBuiltAndTrue ()) {
                      var_cas_v.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this value is not a  binary digit") SOURCE_FILE_AT_LINE (961)) ;
                    }
...
pr_io_primary_sara_parser_1094_18_ (sara_scanner & _inLexique,
  ...
  if (((var_cas_inputVariablesCount) != (var_cas_machineInputVariableCount)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((((((GGS_string (true, "The '$")) + (var_cas_machineIdentifier.reader_value (_inLexique SOURCE_FILE_AT_LINE (1121))))) + (GGS_string (true, "' machine defines ")))) + (var_cas_machineInputVariableCount.reader_string (_inLexique SOURCE_FILE_AT_LINE (1121))))) + (GGS_string (true, " input variable(s), but this operand defines ")))) + (var_cas_inputVariablesCount.reader_string (_inLexique SOURCE_FILE_AT_LINE (1122))))) + (GGS_string (true, " input variable(s)"))) SOURCE_FILE_AT_LINE (1123)) ;
  }
  _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__28) ;
  ...
  if (((var_cas_inputAndInternalVariablesCount) != (var_cas_machineInputAndInternalVariableCount)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((((((GGS_string (true, "The '$")) + (var_cas_machineIdentifier.reader_value (_inLexique SOURCE_FILE_AT_LINE (1141))))) + (GGS_string (true, "' machine defines ")))) + (var_cas_machineInputAndInternalVariableCount.reader_string (_inLexique SOURCE_FILE_AT_LINE (1141))))) + (GGS_string (true, " input and internal variable(s), but this operand defines ")))) + (var_cas_inputAndInternalVariablesCount.reader_string (_inLexique SOURCE_FILE_AT_LINE (1142))))) + (GGS_string (true, " input and internal variable(s)"))) SOURCE_FILE_AT_LINE (1143)) ;
  }
  _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__28) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
...
pr_definition_expression_factor_sara_parser_1422_36_ (sara_scanner & _inLexique,
  ...
  if (((var_cas_inputVariablesCount) != (var_cas_machineInputVariableCount)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((((((GGS_string (true, "The '$")) + (var_cas_machineIdentifier.reader_value (_inLexique SOURCE_FILE_AT_LINE (1449))))) + (GGS_string (true, "' machine defines ")))) + (var_cas_machineInputVariableCount.reader_string (_inLexique SOURCE_FILE_AT_LINE (1449))))) + (GGS_string (true, " input variable(s), but this operand defines ")))) + (var_cas_inputVariablesCount.reader_string (_inLexique SOURCE_FILE_AT_LINE (1450))))) + (GGS_string (true, " input variable(s)"))) SOURCE_FILE_AT_LINE (1451)) ;
  }
  _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__28) ;
  ...
  if (((var_cas_inputAndInternalVariablesCount) != (var_cas_machineInputAndInternalVariableCount)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((((((GGS_string (true, "The '$")) + (var_cas_machineIdentifier.reader_value (_inLexique SOURCE_FILE_AT_LINE (1469))))) + (GGS_string (true, "' machine defines ")))) + (var_cas_machineInputAndInternalVariableCount.reader_string (_inLexique SOURCE_FILE_AT_LINE (1469))))) + (GGS_string (true, " input and internal variable(s), but this operand defines ")))) + (var_cas_inputAndInternalVariablesCount.reader_string (_inLexique SOURCE_FILE_AT_LINE (1470))))) + (GGS_string (true, " input and internal variable(s)"))) SOURCE_FILE_AT_LINE (1471)) ;
  }
  _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__28) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
...
pr_explicit_automaton_sara_parser_1497_26_ (sara_scanner & _inLexique,
  ...
  while ((operand_47794 != NULL)) {
    ...
    if (((! (var_cas_stateDefinitionMap.reader_hasKey (_inLexique, operand_47794->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (1582)) SOURCE_FILE_AT_LINE (1582))))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "'")) + (operand_47794->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (1583))))) + (GGS_string (true, "' state is not described"))) SOURCE_FILE_AT_LINE (1584)) ;
    }
