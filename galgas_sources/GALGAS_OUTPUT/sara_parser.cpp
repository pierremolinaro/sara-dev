...
void sara_parser::
pr_start_symbol_sara_parser_72_19_ (sara_scanner & _inLexique) {
  GGS_semanticContext var_cas_semanticContext ;
  var_cas_semanticContext = GGS_semanticContext::constructor_new (GGS_L_jobList ::constructor_emptyList (), GGS_M_machinesMap ::constructor_emptyMap (_inLexique COMMA_HERE)) ;
  ...
  if (var_cas_semanticContext.reader_componentsMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (82)).isBuilt ()) {
    ::routine_performComputations (_inLexique,  var_cas_semanticContext.reader_componentsMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (82)) COMMA_SOURCE_FILE_AT_LINE (82)) ;
  }
}
...
void sara_parser::
pr_component_sara_parser_87_16_ (sara_scanner & _inLexique,
  ...
  const GGS_M_machinesMap  _temp_2896 = var_cas_ioSemanticContext.reader_machinesMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (100)) ;
  if (_temp_2896.isBuilt ()) {
    _temp_2896 (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_machineName, var_cas_machineIndex, automatic_var_0, automatic_var_1, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (100)) ;
  }
  GGS_AC_job  var_cas_job ;
  var_cas_job = GGS_C_machineCheck ::constructor_new (_inLexique, var_cas_machineIndex, GGS_bool (false) COMMA_HERE) ;
...
void sara_parser::
pr_component_sara_parser_108_16_ (sara_scanner & _inLexique,
                                GGS_semanticContext &var_cas_ioSemanticContext) {
  GGS_M_variablesMap  var_cas_variablesMap ;
  var_cas_variablesMap = GGS_M_variablesMap ::constructor_emptyMap (_inLexique COMMA_HERE) ;
  GGS_M_stateMap  var_cas_statesMap ;
  ...
  const GGS_M_machinesMap  _temp_3643 = var_cas_ioSemanticContext.reader_machinesMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (124)) ;
  if (_temp_3643.isBuilt ()) {
    _temp_3643 (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_machineName1, var_cas_machineIndex1, automatic_var_3, automatic_var_4, automatic_var_5 COMMA_SOURCE_FILE_AT_LINE (124)) ;
  }
  GGS_luint  var_cas_machineIndex2 ;
  GGS_uint  automatic_var_6 ;
  GGS_uint  automatic_var_7 ;
  GGS_M_variablesMap  automatic_var_8 ;
  const GGS_M_machinesMap  _temp_3799 = var_cas_ioSemanticContext.reader_machinesMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (127)) ;
  if (_temp_3799.isBuilt ()) {
    _temp_3799 (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_machineName2, var_cas_machineIndex2, automatic_var_6, automatic_var_7, automatic_var_8 COMMA_SOURCE_FILE_AT_LINE (127)) ;
  }
  GGS_AC_job  var_cas_job ;
...
void sara_parser::
pr_component_sara_parser_135_16_ (sara_scanner & _inLexique,
                                GGS_semanticContext &var_cas_ioSemanticContext) {
  GGS_M_variablesMap  var_cas_variablesMap ;
  var_cas_variablesMap = GGS_M_variablesMap ::constructor_emptyMap (_inLexique COMMA_HERE) ;
  GGS_M_stateMap  var_cas_statesMap ;
  ...
  const GGS_M_machinesMap  _temp_4492 = var_cas_ioSemanticContext.reader_machinesMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (148)) ;
  if (_temp_4492.isBuilt ()) {
    _temp_4492 (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_machineName, var_cas_machineIndex, automatic_var_9, automatic_var_10, automatic_var_11 COMMA_SOURCE_FILE_AT_LINE (148)) ;
  }
  GGS_AC_job  var_cas_job ;
  var_cas_job = GGS_C_machineCheck ::constructor_new (_inLexique, var_cas_machineIndex, GGS_bool (true) COMMA_HERE) ;
  var_cas_ioSemanticContext.componentsMap._addAssign_operation (var_cas_job) ;
}
...
void sara_parser::
pr_component_sara_parser_156_16_ (sara_scanner & _inLexique,
                                GGS_semanticContext &var_cas_ioSemanticContext) {
...
void sara_parser::
pr_component_sara_parser_167_16_ (sara_scanner & _inLexique,
                                GGS_semanticContext &var_cas_ioSemanticContext) {
...
void sara_parser::
pr_component_sara_parser_178_16_ (sara_scanner & _inLexique,
                                GGS_semanticContext &var_cas_ioSemanticContext) {
...
void sara_parser::
pr_component_sara_parser_189_16_ (sara_scanner & _inLexique,
                                GGS_semanticContext &var_cas_ioSemanticContext) {
...
void sara_parser::
pr_component_sara_parser_201_16_ (sara_scanner & _inLexique,
                                GGS_semanticContext &var_cas_ioSemanticContext) {
...
void sara_parser::
pr_component_sara_parser_214_16_ (sara_scanner & _inLexique,
                                GGS_semanticContext &var_cas_ioSemanticContext) {
...
void sara_parser::
pr_component_sara_parser_227_16_ (sara_scanner & _inLexique,
                                GGS_semanticContext &var_cas_ioSemanticContext) {
...
void sara_parser::
pr_component_sara_parser_238_16_ (sara_scanner & _inLexique,
                                GGS_semanticContext &var_cas_ioSemanticContext) {
  GGS_M_variablesMap  var_cas_variablesMap ;
  var_cas_variablesMap = GGS_M_variablesMap ::constructor_emptyMap (_inLexique COMMA_HERE) ;
  GGS_M_stateMap  var_cas_statesMap ;
...
void sara_parser::
pr_component_sara_parser_297_16_ (sara_scanner & _inLexique,
                                GGS_semanticContext &var_cas_ioSemanticContext) {
  GGS_M_variablesMap  var_cas_variablesMap ;
  var_cas_variablesMap = GGS_M_variablesMap ::constructor_emptyMap (_inLexique COMMA_HERE) ;
  GGS_M_stateMap  var_cas_statesMap ;
...
void sara_parser::
pr_component_sara_parser_371_16_ (sara_scanner & _inLexique,
                                GGS_semanticContext &var_cas_ioSemanticContext) {
  GGS_M_variablesMap  var_cas_variablesMap ;
  var_cas_variablesMap = GGS_M_variablesMap ::constructor_emptyMap (_inLexique COMMA_HERE) ;
  GGS_M_stateMap  var_cas_statesMap ;
...
void sara_parser::
pr_component_sara_parser_443_16_ (sara_scanner & _inLexique,
                                GGS_semanticContext &var_cas_ioSemanticContext) {
  ...
  const GGS_M_machinesMap  _temp_12634 = var_cas_ioSemanticContext.reader_machinesMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (458)) ;
  if (_temp_12634.isBuilt ()) {
    _temp_12634 (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_machineName, var_cas_machineIndex, var_cas_inputVariablesCountFromDefinition, var_cas_inputAndInternalVariablesCountFromDefinition, var_cas_variablesMapFromDefinition COMMA_SOURCE_FILE_AT_LINE (458)) ;
  }
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__28) COMMA_HERE) ;
  ...
  if (((var_cas_inputVariablesCountFromDefinition)._operator_isNotEqual (var_cas_inputVariablesCount)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string ("This declaration names "))._operator_concat (var_cas_inputVariablesCount.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (472))))._operator_concat (GGS_string (" input variable(s), but machine definition names ")))._operator_concat (var_cas_inputVariablesCountFromDefinition.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (473))))._operator_concat (GGS_string (" input variable(s)")) COMMA_SOURCE_FILE_AT_LINE (474)) ;
  }
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__28) COMMA_HERE) ;
  ...
  if (((var_cas_inputAndInternalVariablesCountFromDefinition)._operator_isNotEqual (var_cas_inputAndInternalVariablesCount)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string ("This declaration names "))._operator_concat (var_cas_inputAndInternalVariablesCount.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (491))))._operator_concat (GGS_string (" input and internal variable(s), but machine definition names ")))._operator_concat (var_cas_inputAndInternalVariablesCountFromDefinition.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (492))))._operator_concat (GGS_string (" input and internal variable(s)")) COMMA_SOURCE_FILE_AT_LINE (493)) ;
  }
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__28) COMMA_HERE) ;
  ...
  if (((var_cas_outputVariablesCountFromDefinition)._operator_isNotEqual (var_cas_outputVariablesCount)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string ("This declaration names "))._operator_concat (var_cas_outputVariablesCount.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (508))))._operator_concat (GGS_string (" variables, but machine definition names ")))._operator_concat (var_cas_outputVariablesCountFromDefinition.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (509))))._operator_concat (GGS_string (" variables")) COMMA_SOURCE_FILE_AT_LINE (510)) ;
  }
          ...
          while (syntaxRepeat_18) {
              ...
              { bool syntaxRepeat_19 = true ;
                while (syntaxRepeat_19) {
                    ...
                    _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_literal_5Finteger) COMMA_HERE) ;
                    if (((var_cas_v.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (523)))._operator_strictSup (GGS_uint (1U))).isBuiltAndTrue ()) {
                      var_cas_v.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("this value is not a  binary digit") COMMA_SOURCE_FILE_AT_LINE (525)) ;
                    }
              ...
              if (((var_cas_inputVariablesCount)._operator_isNotEqual (var_cas_inputConfigurationForScenario.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (530)))).isBuiltAndTrue ()) {
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (((GGS_string ("this input configuration names "))._operator_concat (var_cas_inputConfigurationForScenario.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (531)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (531))))._operator_concat (GGS_string (" input variable(s), instead of ")))._operator_concat (var_cas_inputVariablesCount.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (531))) COMMA_SOURCE_FILE_AT_LINE (532)) ;
              }
...
void sara_parser::
pr_io_bool_expression_sara_parser_548_25_ (sara_scanner & _inLexique,
...
void sara_parser::
pr_io_and_expression_sara_parser_580_24_ (sara_scanner & _inLexique,
                                const GGS_semanticContext var_cas_inSemanticContext,
                                GGS_M_variablesMap  &var_cas_ioVarMap,
                                GGS_AC_boolExpression  &var_cas_outExpression) {
...
void sara_parser::
pr_io_primary_sara_parser_597_17_ (sara_scanner & _inLexique,
                                const GGS_semanticContext var_cas_inSemanticContext,
                                GGS_M_variablesMap  &var_cas_ioVarMap,
                                GGS_AC_boolExpression  &var_cas_outExpression) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__28) COMMA_HERE) ;
...
void sara_parser::
pr_io_primary_sara_parser_609_17_ (sara_scanner & _inLexique,
                                const GGS_semanticContext /* var_cas_inSemanticContext */,
                                GGS_M_variablesMap  &var_cas_ioVarMap,
                                GGS_AC_boolExpression  &var_cas_outExpression) {
  GGS_lstring  var_cas_inputVarName ;
  ...
  if (_temp_18233.isBuilt ()) {
    _temp_18233 (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_inputVarName, var_cas_inputVarIndex COMMA_SOURCE_FILE_AT_LINE (617)) ;
  }
...
void sara_parser::
pr_io_primary_sara_parser_623_17_ (sara_scanner & _inLexique,
                                const GGS_semanticContext var_cas_inSemanticContext,
                                GGS_M_variablesMap  &var_cas_ioVarMap,
                                GGS_AC_boolExpression  &var_cas_outExpression) {
...
void sara_parser::
pr_io_primary_sara_parser_636_17_ (sara_scanner & _inLexique,
                                const GGS_semanticContext /* var_cas_inSemanticContext */,
                                GGS_M_variablesMap  &/* var_cas_ioVarMap */,
                                GGS_AC_boolExpression  &var_cas_outExpression) {
...
void sara_parser::
pr_io_primary_sara_parser_647_17_ (sara_scanner & _inLexique,
                                const GGS_semanticContext /* var_cas_inSemanticContext */,
                                GGS_M_variablesMap  &/* var_cas_ioVarMap */,
                                GGS_AC_boolExpression  &var_cas_outExpression) {
...
void sara_parser::
pr_io_primary_sara_parser_658_17_ (sara_scanner & _inLexique,
                                const GGS_semanticContext var_cas_inSemanticContext,
                                GGS_M_variablesMap  &var_cas_ioVarMap,
                                GGS_AC_boolExpression  &var_cas_outExpression) {
  ...
  const GGS_M_machinesMap  _temp_19772 = var_cas_inSemanticContext.reader_machinesMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (669)) ;
  if (_temp_19772.isBuilt ()) {
    _temp_19772 (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_machineIdentifier, var_cas_indexOfImportedMachine, var_cas_machineInputVariableCount, var_cas_machineInputAndInternalVariableCount, var_cas_machineVariablesMap COMMA_SOURCE_FILE_AT_LINE (669)) ;
  }
  ...
  { bool syntaxRepeat_22 = true ;
    while (syntaxRepeat_22) {
        ...
        if (_temp_20116.isBuilt ()) {
          _temp_20116 (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_inputVar, var_cas_inputVarIndex COMMA_SOURCE_FILE_AT_LINE (677)) ;
        }
  ...
  if (((var_cas_inputVariablesCount)._operator_isNotEqual (var_cas_machineInputVariableCount)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((GGS_string ("The '$"))._operator_concat (var_cas_machineIdentifier))._operator_concat (GGS_string ("' machine defines ")))._operator_concat (var_cas_machineInputVariableCount.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (685))))._operator_concat (GGS_string (" input variable(s), but this operand defines ")))._operator_concat (var_cas_inputVariablesCount.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (686))))._operator_concat (GGS_string (" input variable(s)")) COMMA_SOURCE_FILE_AT_LINE (687)) ;
  }
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__28) COMMA_HERE) ;
      ...
      { bool syntaxRepeat_24 = true ;
        while (syntaxRepeat_24) {
            ...
            if (_temp_20766.isBuilt ()) {
              _temp_20766 (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_internalVar, var_cas_internalVarIndex COMMA_SOURCE_FILE_AT_LINE (696)) ;
            }
  ...
  if (((var_cas_inputAndInternalVariablesCount)._operator_isNotEqual (var_cas_machineInputAndInternalVariableCount)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((GGS_string ("The '$"))._operator_concat (var_cas_machineIdentifier.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (705))))._operator_concat (GGS_string ("' machine defines ")))._operator_concat (var_cas_machineInputAndInternalVariableCount.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (705))))._operator_concat (GGS_string (" input and internal variable(s), but this operand defines ")))._operator_concat (var_cas_inputAndInternalVariablesCount.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (706))))._operator_concat (GGS_string (" input and internal variable(s)")) COMMA_SOURCE_FILE_AT_LINE (707)) ;
  }
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__28) COMMA_HERE) ;
  { bool syntaxRepeat_25 = true ;
    while (syntaxRepeat_25) {
        ...
        if (_temp_21507.isBuilt ()) {
          _temp_21507 (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_outputVar, var_cas_outputVarIndex COMMA_SOURCE_FILE_AT_LINE (714)) ;
        }
  ...
  if (((var_cas_allVariablesCount)._operator_isNotEqual (var_cas_machineAllVariablesCount)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((GGS_string ("The '$"))._operator_concat (var_cas_machineIdentifier.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (723))))._operator_concat (GGS_string ("' machine defines ")))._operator_concat (var_cas_machineAllVariablesCount.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (723))))._operator_concat (GGS_string (" variables, but this operand defines ")))._operator_concat (var_cas_allVariablesCount.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (724))))._operator_concat (GGS_string (" variables")) COMMA_SOURCE_FILE_AT_LINE (725)) ;
  }
...
void sara_parser::
pr_definition_expression_sara_parser_737_28_ (sara_scanner & _inLexique,
                                const GGS_semanticContext var_cas_inSemanticContext,
                                GGS_M_variablesMap  &var_cas_variablesMap,
...
void sara_parser::
pr_definition_expression_term_sara_parser_755_33_ (sara_scanner & _inLexique,
                                const GGS_semanticContext var_cas_inSemanticContext,
                                GGS_M_variablesMap  &var_cas_variablesMap,
                                GGS_AC_machineDefinition  &var_cas_outDefinition) {
...
void sara_parser::
pr_modalcompadd_definition_sara_parser_787_30_ (sara_scanner & _inLexique,
                                const GGS_semanticContext var_cas_inSemanticContext,
                                GGS_M_variablesMap  &var_cas_variablesMap,
      ...
      switch (select_repeat_sara_parser_29 (_inLexique)) {
        case 2 : {
          ...
          if (_temp_24992.isBuilt ()) {
            _temp_24992 (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_sourceModeName, var_cas_sourceModeIndex, automatic_var_12 COMMA_SOURCE_FILE_AT_LINE (811)) ;
          }
          ...
          if (_temp_25171.isBuilt ()) {
            _temp_25171 (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_targetModeName, var_cas_targetModeIndex, automatic_var_13 COMMA_SOURCE_FILE_AT_LINE (816)) ;
          }
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__3B) COMMA_HERE) ;
          if (((var_cas_sourceModeIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (818)))._operator_isEqual (var_cas_targetModeIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (818)))).isBuiltAndTrue ()) {
            var_cas_targetModeIndex.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string ("unuseful include: 'modalcompadd' operator never adds transitions from terminal states to initial states of the same mode") COMMA_SOURCE_FILE_AT_LINE (819)) ;
          }else{
...
void sara_parser::
pr_modalcompsub_definition_sara_parser_828_30_ (sara_scanner & _inLexique,
                                const GGS_semanticContext var_cas_inSemanticContext,
                                GGS_M_variablesMap  &var_cas_variablesMap,
                                GGS_M_modesMap  &var_cas_outModeMap,
      ...
      switch (select_repeat_sara_parser_31 (_inLexique)) {
        case 2 : {
          ...
          if (_temp_26299.isBuilt ()) {
            _temp_26299 (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_sourceModeName, var_cas_sourceModeIndex, automatic_var_14 COMMA_SOURCE_FILE_AT_LINE (852)) ;
          }
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_to) COMMA_HERE) ;
          GGS_lstring  var_cas_targetModeName ;
          _inLexique._assignFromAttribute_identifierString (var_cas_targetModeName) ;
          ...
          if (_temp_26478.isBuilt ()) {
            _temp_26478 (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_targetModeName, var_cas_targetModeIndex, automatic_var_15 COMMA_SOURCE_FILE_AT_LINE (857)) ;
          }
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__3B) COMMA_HERE) ;
          if (((var_cas_sourceModeIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (859)))._operator_isEqual (var_cas_targetModeIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (859)))).isBuiltAndTrue ()) {
            var_cas_targetModeIndex.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string ("unuseful include: 'modalcompadd' operator never adds transitions from terminal states to initial states of the same mode") COMMA_SOURCE_FILE_AT_LINE (860)) ;
          }else{
...
void sara_parser::
pr_definition_expression_factor_sara_parser_869_35_ (sara_scanner & _inLexique,
                                const GGS_semanticContext var_cas_inSemanticContext,
                                GGS_M_variablesMap  &var_cas_variablesMap,
                                GGS_AC_machineDefinition  &var_cas_outDefinition) {
...
void sara_parser::
pr_definition_expression_factor_sara_parser_986_35_ (sara_scanner & _inLexique,
                                const GGS_semanticContext var_cas_inSemanticContext,
                                GGS_M_variablesMap  &var_cas_ioVarMap,
                                GGS_AC_machineDefinition  &var_cas_outDefinition) {
  GGS_lstring  var_cas_machineIdentifier ;
  ...
  GGS_M_variablesMap  var_cas_machineVariablesMap ;
  GGS_luint  var_cas_indexOfImportedMachine ;
  const GGS_M_machinesMap  _temp_30992 = var_cas_inSemanticContext.reader_machinesMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (997)) ;
  if (_temp_30992.isBuilt ()) {
    _temp_30992 (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_machineIdentifier, var_cas_indexOfImportedMachine, var_cas_machineInputVariableCount, var_cas_machineInputAndInternalVariableCount, var_cas_machineVariablesMap COMMA_SOURCE_FILE_AT_LINE (997)) ;
  }
  GGS_L_translationVector  var_cas_translationVector ;
  var_cas_translationVector = GGS_L_translationVector ::constructor_emptyList () ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__28) COMMA_HERE) ;
  { bool syntaxRepeat_35 = true ;
    while (syntaxRepeat_35) {
        ...
        if (_temp_31336.isBuilt ()) {
          _temp_31336 (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_inputVar, var_cas_inputVarIndex COMMA_SOURCE_FILE_AT_LINE (1005)) ;
        }
        var_cas_translationVector._addAssign_operation (var_cas_inputVarIndex) ;
  ...
  if (((var_cas_inputVariablesCount)._operator_isNotEqual (var_cas_machineInputVariableCount)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((GGS_string ("The '$"))._operator_concat (var_cas_machineIdentifier.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1013))))._operator_concat (GGS_string ("' machine defines ")))._operator_concat (var_cas_machineInputVariableCount.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1013))))._operator_concat (GGS_string (" input variable(s), but this operand defines ")))._operator_concat (var_cas_inputVariablesCount.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1014))))._operator_concat (GGS_string (" input variable(s)")) COMMA_SOURCE_FILE_AT_LINE (1015)) ;
  }
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__28) COMMA_HERE) ;
      ...
      { bool syntaxRepeat_37 = true ;
        while (syntaxRepeat_37) {
            ...
            if (_temp_31995.isBuilt ()) {
              _temp_31995 (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_internalVar, var_cas_internalVarIndex COMMA_SOURCE_FILE_AT_LINE (1024)) ;
            }
            var_cas_translationVector._addAssign_operation (var_cas_internalVarIndex) ;
  ...
  if (((var_cas_inputAndInternalVariablesCount)._operator_isNotEqual (var_cas_machineInputAndInternalVariableCount)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((GGS_string ("The '$"))._operator_concat (var_cas_machineIdentifier.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1033))))._operator_concat (GGS_string ("' machine defines ")))._operator_concat (var_cas_machineInputAndInternalVariableCount.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1033))))._operator_concat (GGS_string (" input and internal variable(s), but this operand defines ")))._operator_concat (var_cas_inputAndInternalVariablesCount.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1034))))._operator_concat (GGS_string (" input and internal variable(s)")) COMMA_SOURCE_FILE_AT_LINE (1035)) ;
  }
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__28) COMMA_HERE) ;
  { bool syntaxRepeat_38 = true ;
    while (syntaxRepeat_38) {
        ...
        if (_temp_32736.isBuilt ()) {
          _temp_32736 (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_outputVar, var_cas_outputVarIndex COMMA_SOURCE_FILE_AT_LINE (1042)) ;
        }
        var_cas_translationVector._addAssign_operation (var_cas_outputVarIndex) ;
  ...
  if (((var_cas_allVariablesCount)._operator_isNotEqual (var_cas_machineAllVariablesCount)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((GGS_string ("The '$"))._operator_concat (var_cas_machineIdentifier.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1051))))._operator_concat (GGS_string ("' machine defines ")))._operator_concat (var_cas_machineAllVariablesCount.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1051))))._operator_concat (GGS_string (" variables, but this operand defines ")))._operator_concat (var_cas_allVariablesCount.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1052))))._operator_concat (GGS_string (" variables")) COMMA_SOURCE_FILE_AT_LINE (1053)) ;
  }
...
void sara_parser::
pr_explicit_automaton_sara_parser_1061_25_ (sara_scanner & _inLexique,
                                const GGS_semanticContext var_cas_inSemanticContext,
                                GGS_M_variablesMap  &var_cas_variablesMap,
                                GGS_AC_machineDefinition  &var_cas_outDefinition) {
  GGS_M_stateMap  var_cas_statesMap ;
  ...
  { bool syntaxRepeat_40 = true ;
    while (syntaxRepeat_40) {
        ...
        if (_temp_34256.isBuilt ()) {
          _temp_34256 (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_initialState, var_cas_initialStateIndex COMMA_SOURCE_FILE_AT_LINE (1087)) ;
        }
      ...
      { bool syntaxRepeat_42 = true ;
        while (syntaxRepeat_42) {
            ...
            if (_temp_34660.isBuilt ()) {
              _temp_34660 (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_terminalState, var_cas_terminalStateIndex COMMA_SOURCE_FILE_AT_LINE (1102)) ;
            }
  ...
  { bool syntaxRepeat_43 = true ;
    while (syntaxRepeat_43) {
        ...
        if (_temp_35047.isBuilt ()) {
          _temp_35047 (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_stateName, var_cas_stateIndex COMMA_SOURCE_FILE_AT_LINE (1116)) ;
        }
            ...
            switch (select_repeat_sara_parser_44 (_inLexique)) {
              case 2 : {
                ...
                if (_temp_35787.isBuilt ()) {
                  _temp_35787 (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_targetStateName, var_cas_targetStateIndex COMMA_SOURCE_FILE_AT_LINE (1135)) ;
                }
  ...
  }
  {
    ...
    while (((operand_36154 = enumerator_36154.nextObject ()))) {
      ...
      if (((var_cas_stateDefinitionMap.reader_hasKey (_inLexique, operand_36154->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1146)) COMMA_SOURCE_FILE_AT_LINE (1146)))._operator_not ()).isBuiltAndTrue ()) {
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string ("'"))._operator_concat (operand_36154->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1147))))._operator_concat (GGS_string ("' state is not described")) COMMA_SOURCE_FILE_AT_LINE (1148)) ;
      }
    }
  }
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__7D) COMMA_HERE) ;
