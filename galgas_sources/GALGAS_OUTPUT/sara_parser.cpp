...
void sara_parser::
sara_parser::
pr_start_symbol_sara_parser_72_6_ (sara_scanner & _inLexique) {
  ...
  if (var_cas_componentsMap._isBuilt ()) {
    ::routine_performComputations (_inLexique,  var_cas_componentsMap COMMA_SOURCE_FILE_AT_LINE (80)) ;
  }
}
...
void sara_parser::
sara_parser::
pr_component_sara_parser_85_6_ (sara_scanner & _inLexique,
  ...
  if (var_cas_ioMachinesMap._isBuilt ()) {
    var_cas_ioMachinesMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_machineName, var_cas_machineIndex, automatic_var_0, automatic_var_1, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (99)) ;
  }
...
void sara_parser::
sara_parser::
pr_component_sara_parser_107_6_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
                                GGS_L_jobList  &var_cas_ioJobList) {
  GGS_M_variablesMap  var_cas_variablesMap ;
  var_cas_variablesMap = GGS_M_variablesMap::constructor_emptyMap (_inLexique COMMA_HERE) ;
  ...
  if (var_cas_ioMachinesMap._isBuilt ()) {
    var_cas_ioMachinesMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_machineName1, var_cas_machineIndex1, automatic_var_3, automatic_var_4, automatic_var_5 COMMA_SOURCE_FILE_AT_LINE (124)) ;
  }
  ...
  if (var_cas_ioMachinesMap._isBuilt ()) {
    var_cas_ioMachinesMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_machineName2, var_cas_machineIndex2, automatic_var_6, automatic_var_7, automatic_var_8 COMMA_SOURCE_FILE_AT_LINE (127)) ;
  }
  GGS_AC_job  var_cas_job ;
...
void sara_parser::
sara_parser::
pr_component_sara_parser_135_6_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
                                GGS_L_jobList  &var_cas_ioJobList) {
  GGS_M_variablesMap  var_cas_variablesMap ;
  var_cas_variablesMap = GGS_M_variablesMap::constructor_emptyMap (_inLexique COMMA_HERE) ;
  ...
  if (var_cas_ioMachinesMap._isBuilt ()) {
    var_cas_ioMachinesMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_machineName, var_cas_machineIndex, automatic_var_9, automatic_var_10, automatic_var_11 COMMA_SOURCE_FILE_AT_LINE (149)) ;
  }
  GGS_AC_job  var_cas_job ;
...
void sara_parser::
sara_parser::
pr_component_sara_parser_157_6_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &/* var_cas_ioMachinesMap */,
                                GGS_L_jobList  &var_cas_ioJobList) {
...
void sara_parser::
sara_parser::
pr_component_sara_parser_169_6_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &/* var_cas_ioMachinesMap */,
                                GGS_L_jobList  &var_cas_ioJobList) {
...
void sara_parser::
sara_parser::
pr_component_sara_parser_181_6_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &/* var_cas_ioMachinesMap */,
                                GGS_L_jobList  &var_cas_ioJobList) {
...
void sara_parser::
sara_parser::
pr_component_sara_parser_193_6_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &/* var_cas_ioMachinesMap */,
                                GGS_L_jobList  &var_cas_ioJobList) {
...
void sara_parser::
sara_parser::
pr_component_sara_parser_206_6_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &/* var_cas_ioMachinesMap */,
                                GGS_L_jobList  &var_cas_ioJobList) {
...
void sara_parser::
sara_parser::
pr_component_sara_parser_220_6_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &/* var_cas_ioMachinesMap */,
                                GGS_L_jobList  &var_cas_ioJobList) {
...
void sara_parser::
sara_parser::
pr_component_sara_parser_234_6_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &/* var_cas_ioMachinesMap */,
                                GGS_L_jobList  &var_cas_ioJobList) {
...
void sara_parser::
sara_parser::
pr_component_sara_parser_246_6_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
                                GGS_L_jobList  &var_cas_ioJobList) {
  GGS_M_variablesMap  var_cas_variablesMap ;
  var_cas_variablesMap = GGS_M_variablesMap::constructor_emptyMap (_inLexique COMMA_HERE) ;
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        var_cas_variablesMap.modifier_insertKey (_inLexique, var_cas_inputVarName COMMA_SOURCE_FILE_AT_LINE (261)) ;
  ...
  var_cas_inputVariablesCount = var_cas_variablesMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (265)) ;
    ...
    case 2 : {
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
            var_cas_variablesMap.modifier_insertKey (_inLexique, var_cas_outputVarName COMMA_SOURCE_FILE_AT_LINE (274)) ;
  ...
  var_cas_inputAndInternalVariablesCount = var_cas_variablesMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (280)) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__28) COMMA_HERE) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        GGS_lstring  var_cas_outputVarName ;
        _inLexique._assignFromAttribute_identifierString (var_cas_outputVarName) ;
        _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
        var_cas_variablesMap.modifier_insertKey (_inLexique, var_cas_outputVarName COMMA_SOURCE_FILE_AT_LINE (286)) ;
  ...
  GGS_luint  var_cas_machineIndex ;
  var_cas_ioMachinesMap.modifier_insertKeyGetIndex (_inLexique, var_cas_machineName, var_cas_machineIndex, var_cas_inputVariablesCount, var_cas_inputAndInternalVariablesCount, var_cas_variablesMap COMMA_SOURCE_FILE_AT_LINE (297)) ;
...
pr_component_sara_parser_306_6_ (sara_scanner & _inLexique,
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        _inLexique._assignFromAttribute_identifierString (var_cas_inputVarName) ;
        _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
        var_cas_variablesMap.modifier_insertKey (_inLexique, var_cas_inputVarName COMMA_SOURCE_FILE_AT_LINE (322)) ;
  ...
  GGS_uint  var_cas_inputVariablesCount ;
  var_cas_inputVariablesCount = var_cas_variablesMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (326)) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__29) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__28) COMMA_HERE) ;
    ...
    case 2 : {
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            _inLexique._assignFromAttribute_identifierString (var_cas_outputVarName) ;
            _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
            var_cas_variablesMap.modifier_insertKey (_inLexique, var_cas_outputVarName COMMA_SOURCE_FILE_AT_LINE (335)) ;
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__29) COMMA_HERE) ;
  GGS_uint  var_cas_inputAndInternalVariablesCount ;
  var_cas_inputAndInternalVariablesCount = var_cas_variablesMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (341)) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__28) COMMA_HERE) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        GGS_lstring  var_cas_outputVarName ;
        _inLexique._assignFromAttribute_identifierString (var_cas_outputVarName) ;
        _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
        var_cas_variablesMap.modifier_insertKey (_inLexique, var_cas_outputVarName COMMA_SOURCE_FILE_AT_LINE (347)) ;
  ...
  GGS_luint  var_cas_machineIndex ;
  var_cas_ioMachinesMap.modifier_insertKeyGetIndex (_inLexique, var_cas_machineName, var_cas_machineIndex, var_cas_inputVariablesCount, var_cas_inputAndInternalVariablesCount, var_cas_variablesMap COMMA_SOURCE_FILE_AT_LINE (364)) ;
  GGS_AC_job  var_cas_machine ;
...
void sara_parser::
sara_parser::
pr_component_sara_parser_381_6_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
                                GGS_L_jobList  &var_cas_ioJobList) {
  GGS_M_variablesMap  var_cas_variablesMap ;
  var_cas_variablesMap = GGS_M_variablesMap::constructor_emptyMap (_inLexique COMMA_HERE) ;
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        _inLexique._assignFromAttribute_identifierString (var_cas_inputVarName) ;
        _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
        var_cas_variablesMap.modifier_insertKey (_inLexique, var_cas_inputVarName COMMA_SOURCE_FILE_AT_LINE (397)) ;
  ...
  GGS_uint  var_cas_inputVariablesCount ;
  var_cas_inputVariablesCount = var_cas_variablesMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (401)) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__29) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__28) COMMA_HERE) ;
    ...
    case 2 : {
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            _inLexique._assignFromAttribute_identifierString (var_cas_outputVarName) ;
            _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
            var_cas_variablesMap.modifier_insertKey (_inLexique, var_cas_outputVarName COMMA_SOURCE_FILE_AT_LINE (410)) ;
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__29) COMMA_HERE) ;
  GGS_uint  var_cas_inputAndInternalVariablesCount ;
  var_cas_inputAndInternalVariablesCount = var_cas_variablesMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (416)) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__28) COMMA_HERE) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        GGS_lstring  var_cas_outputVarName ;
        _inLexique._assignFromAttribute_identifierString (var_cas_outputVarName) ;
        _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
        var_cas_variablesMap.modifier_insertKey (_inLexique, var_cas_outputVarName COMMA_SOURCE_FILE_AT_LINE (422)) ;
  ...
  GGS_luint  var_cas_machineIndex ;
  var_cas_ioMachinesMap.modifier_insertKeyGetIndex (_inLexique, var_cas_machineName, var_cas_machineIndex, var_cas_inputVariablesCount, var_cas_inputAndInternalVariablesCount, var_cas_variablesMap COMMA_SOURCE_FILE_AT_LINE (439)) ;
  GGS_AC_job  var_cas_machine ;
...
void sara_parser::
sara_parser::
pr_component_sara_parser_454_6_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
                                GGS_L_jobList  &var_cas_ioJobList) {
  ...
  if (var_cas_ioMachinesMap._isBuilt ()) {
    var_cas_ioMachinesMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_machineName, var_cas_machineIndex, var_cas_inputVariablesCountFromDefinition, var_cas_inputAndInternalVariablesCountFromDefinition, var_cas_variablesMapFromDefinition COMMA_SOURCE_FILE_AT_LINE (470)) ;
  }
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__28) COMMA_HERE) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        _inLexique._assignFromAttribute_identifierString (var_cas_inputVarName) ;
        _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
        var_cas_variablesMap.modifier_insertKey (_inLexique, var_cas_inputVarName COMMA_SOURCE_FILE_AT_LINE (476)) ;
  ...
  GGS_uint  var_cas_inputVariablesCount ;
  var_cas_inputVariablesCount = var_cas_variablesMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (480)) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__29) COMMA_HERE) ;
  if (((var_cas_inputVariablesCountFromDefinition)._operator_isNotEqual (var_cas_inputVariablesCount)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "This declaration names "))._operator_concat (var_cas_inputVariablesCount.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (484))))._operator_concat (GGS_string (true, " input variable(s), but machine definition names ")))._operator_concat (var_cas_inputVariablesCountFromDefinition.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (485))))._operator_concat (GGS_string (true, " input variable(s)")) COMMA_SOURCE_FILE_AT_LINE (486)) ;
  }
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__28) COMMA_HERE) ;
    ...
    case 2 : {
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            _inLexique._assignFromAttribute_identifierString (var_cas_outputVarName) ;
            _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
            var_cas_variablesMap.modifier_insertKey (_inLexique, var_cas_outputVarName COMMA_SOURCE_FILE_AT_LINE (494)) ;
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__29) COMMA_HERE) ;
  GGS_uint  var_cas_inputAndInternalVariablesCount ;
  var_cas_inputAndInternalVariablesCount = var_cas_variablesMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (501)) ;
  if (((var_cas_inputAndInternalVariablesCountFromDefinition)._operator_isNotEqual (var_cas_inputAndInternalVariablesCount)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "This declaration names "))._operator_concat (var_cas_inputAndInternalVariablesCount.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (503))))._operator_concat (GGS_string (true, " input and internal variable(s), but machine definition names ")))._operator_concat (var_cas_inputAndInternalVariablesCountFromDefinition.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (504))))._operator_concat (GGS_string (true, " input and internal variable(s)")) COMMA_SOURCE_FILE_AT_LINE (505)) ;
  }
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__28) COMMA_HERE) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        _inLexique._assignFromAttribute_identifierString (var_cas_outputVarName) ;
        _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
        var_cas_variablesMap.modifier_insertKey (_inLexique, var_cas_outputVarName COMMA_SOURCE_FILE_AT_LINE (511)) ;
  ...
  var_cas_outputVariablesCount = var_cas_variablesMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (517)) ;
  GGS_uint  var_cas_outputVariablesCountFromDefinition ;
  var_cas_outputVariablesCountFromDefinition = var_cas_variablesMapFromDefinition.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (518)) ;
  if (((var_cas_outputVariablesCountFromDefinition)._operator_isNotEqual (var_cas_outputVariablesCount)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "This declaration names "))._operator_concat (var_cas_outputVariablesCount.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (520))))._operator_concat (GGS_string (true, " variables, but machine definition names ")))._operator_concat (var_cas_outputVariablesCountFromDefinition.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (521))))._operator_concat (GGS_string (true, " variables")) COMMA_SOURCE_FILE_AT_LINE (522)) ;
  }
          ...
          while (syntaxRepeat) {
              ...
              { bool syntaxRepeat = true ;
                while (syntaxRepeat) {
                    ...
                    _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_literal_5Finteger) COMMA_HERE) ;
                    if (((var_cas_v.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (535)))._operator_strictSup (GGS_uint (true, 1U))).isBuiltAndTrue ()) {
                      var_cas_v.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this value is not a  binary digit") COMMA_SOURCE_FILE_AT_LINE (537)) ;
                    }
              ...
              if (((var_cas_inputVariablesCount)._operator_isNotEqual (var_cas_inputConfigurationForScenario.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (542)))).isBuiltAndTrue ()) {
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (((GGS_string (true, "this input configuration names "))._operator_concat (var_cas_inputConfigurationForScenario.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (543)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (543))))._operator_concat (GGS_string (true, " input variable(s), instead of ")))._operator_concat (var_cas_inputVariablesCount.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (543))) COMMA_SOURCE_FILE_AT_LINE (544)) ;
              }
...
void sara_parser::
sara_parser::
pr_io_bool_expression_sara_parser_560_6_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
...
void sara_parser::
sara_parser::
pr_io_and_expression_sara_parser_592_6_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
                                GGS_M_variablesMap  &var_cas_ioVarMap,
                                GGS_AC_boolExpression  &var_cas_outExpression) {
...
void sara_parser::
sara_parser::
pr_io_primary_sara_parser_609_6_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
                                GGS_M_variablesMap  &var_cas_ioVarMap,
                                GGS_AC_boolExpression  &var_cas_outExpression) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__28) COMMA_HERE) ;
...
void sara_parser::
sara_parser::
pr_io_primary_sara_parser_621_6_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &/* var_cas_ioMachinesMap */,
                                GGS_M_variablesMap  &var_cas_ioVarMap,
                                GGS_AC_boolExpression  &var_cas_outExpression) {
  GGS_lstring  var_cas_inputVarName ;
  ...
  if (var_cas_ioVarMap._isBuilt ()) {
    var_cas_ioVarMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_inputVarName, var_cas_inputVarIndex COMMA_SOURCE_FILE_AT_LINE (629)) ;
  }
...
void sara_parser::
sara_parser::
pr_io_primary_sara_parser_635_6_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
                                GGS_M_variablesMap  &var_cas_ioVarMap,
                                GGS_AC_boolExpression  &var_cas_outExpression) {
...
void sara_parser::
sara_parser::
pr_io_primary_sara_parser_648_6_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &/* var_cas_ioMachinesMap */,
                                GGS_M_variablesMap  &/* var_cas_ioVarMap */,
                                GGS_AC_boolExpression  &var_cas_outExpression) {
...
void sara_parser::
sara_parser::
pr_io_primary_sara_parser_659_6_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &/* var_cas_ioMachinesMap */,
                                GGS_M_variablesMap  &/* var_cas_ioVarMap */,
                                GGS_AC_boolExpression  &var_cas_outExpression) {
...
void sara_parser::
sara_parser::
pr_io_primary_sara_parser_670_6_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
                                GGS_M_variablesMap  &var_cas_ioVarMap,
                                GGS_AC_boolExpression  &var_cas_outExpression) {
  ...
  if (var_cas_ioMachinesMap._isBuilt ()) {
    var_cas_ioMachinesMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_machineIdentifier, var_cas_indexOfImportedMachine, var_cas_machineInputVariableCount, var_cas_machineInputAndInternalVariableCount, var_cas_machineVariablesMap COMMA_SOURCE_FILE_AT_LINE (681)) ;
  }
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        GGS_luint  var_cas_inputVarIndex ;
        if (var_cas_ioVarMap._isBuilt ()) {
          var_cas_ioVarMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_inputVar, var_cas_inputVarIndex COMMA_SOURCE_FILE_AT_LINE (689)) ;
        }
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__29) COMMA_HERE) ;
  GGS_uint  var_cas_inputVariablesCount ;
  var_cas_inputVariablesCount = var_cas_translationVector.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (695)) ;
  if (((var_cas_inputVariablesCount)._operator_isNotEqual (var_cas_machineInputVariableCount)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((GGS_string (true, "The '$"))._operator_concat (var_cas_machineIdentifier))._operator_concat (GGS_string (true, "' machine defines ")))._operator_concat (var_cas_machineInputVariableCount.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (697))))._operator_concat (GGS_string (true, " input variable(s), but this operand defines ")))._operator_concat (var_cas_inputVariablesCount.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (698))))._operator_concat (GGS_string (true, " input variable(s)")) COMMA_SOURCE_FILE_AT_LINE (699)) ;
  }
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__28) COMMA_HERE) ;
    ...
    case 2 : {
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            if (var_cas_ioVarMap._isBuilt ()) {
              var_cas_ioVarMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_internalVar, var_cas_internalVarIndex COMMA_SOURCE_FILE_AT_LINE (708)) ;
            }
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__29) COMMA_HERE) ;
  GGS_uint  var_cas_inputAndInternalVariablesCount ;
  var_cas_inputAndInternalVariablesCount = var_cas_translationVector.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (715)) ;
  if (((var_cas_inputAndInternalVariablesCount)._operator_isNotEqual (var_cas_machineInputAndInternalVariableCount)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((GGS_string (true, "The '$"))._operator_concat (var_cas_machineIdentifier.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (717))))._operator_concat (GGS_string (true, "' machine defines ")))._operator_concat (var_cas_machineInputAndInternalVariableCount.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (717))))._operator_concat (GGS_string (true, " input and internal variable(s), but this operand defines ")))._operator_concat (var_cas_inputAndInternalVariablesCount.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (718))))._operator_concat (GGS_string (true, " input and internal variable(s)")) COMMA_SOURCE_FILE_AT_LINE (719)) ;
  }
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__28) COMMA_HERE) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        if (var_cas_ioVarMap._isBuilt ()) {
          var_cas_ioVarMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_outputVar, var_cas_outputVarIndex COMMA_SOURCE_FILE_AT_LINE (726)) ;
        }
  ...
  var_cas_allVariablesCount = var_cas_translationVector.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (732)) ;
  GGS_uint  var_cas_machineAllVariablesCount ;
  var_cas_machineAllVariablesCount = var_cas_machineVariablesMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (733)) ;
  if (((var_cas_allVariablesCount)._operator_isNotEqual (var_cas_machineAllVariablesCount)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((GGS_string (true, "The '$"))._operator_concat (var_cas_machineIdentifier.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (735))))._operator_concat (GGS_string (true, "' machine defines ")))._operator_concat (var_cas_machineAllVariablesCount.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (735))))._operator_concat (GGS_string (true, " variables, but this operand defines ")))._operator_concat (var_cas_allVariablesCount.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (736))))._operator_concat (GGS_string (true, " variables")) COMMA_SOURCE_FILE_AT_LINE (737)) ;
  }
  var_cas_outExpression = GGS_C_importBoolMachine::constructor_new (_inLexique, var_cas_indexOfImportedMachine.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (739)), var_cas_machineIdentifier.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (740)), var_cas_translationVector COMMA_HERE) ;
}
...
void sara_parser::
sara_parser::
pr_definition_expression_sara_parser_749_6_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
                                GGS_M_variablesMap  &var_cas_variablesMap,
...
void sara_parser::
sara_parser::
pr_definition_expression_term_sara_parser_767_6_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
                                GGS_M_variablesMap  &var_cas_variablesMap,
                                GGS_AC_machineDefinition  &var_cas_outDefinition) {
...
void sara_parser::
sara_parser::
pr_modalcompadd_definition_sara_parser_799_6_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
                                GGS_M_variablesMap  &var_cas_variablesMap,
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        var_cas_outModeMap.modifier_insertKey (_inLexique, var_cas_modeName, var_cas_def COMMA_SOURCE_FILE_AT_LINE (813)) ;
        _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__3B) COMMA_HERE) ;
      ...
      switch (select_repeat_sara_parser_29 (_inLexique)) {
        case 2 : {
          ...
          if (var_cas_outModeMap._isBuilt ()) {
            var_cas_outModeMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_sourceModeName, var_cas_sourceModeIndex, automatic_var_12 COMMA_SOURCE_FILE_AT_LINE (823)) ;
          }
          ...
          if (var_cas_outModeMap._isBuilt ()) {
            var_cas_outModeMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_targetModeName, var_cas_targetModeIndex, automatic_var_13 COMMA_SOURCE_FILE_AT_LINE (828)) ;
          }
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__3B) COMMA_HERE) ;
          if (((var_cas_sourceModeIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (830)))._operator_isEqual (var_cas_targetModeIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (830)))).isBuiltAndTrue ()) {
            var_cas_targetModeIndex.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "unuseful include: 'modalcompadd' operator never adds transitions from terminal states to initial states of the same mode") COMMA_SOURCE_FILE_AT_LINE (831)) ;
          }else{
...
void sara_parser::
sara_parser::
pr_modalcompsub_definition_sara_parser_840_6_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
                                GGS_M_variablesMap  &var_cas_variablesMap,
                                GGS_M_modesMap  &var_cas_outModeMap,
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        GGS_AC_machineDefinition  var_cas_def ;
        nt_definition_expression_ (_inLexique, var_cas_ioMachinesMap, var_cas_variablesMap, var_cas_def) ;
        var_cas_outModeMap.modifier_insertKey (_inLexique, var_cas_modeName, var_cas_def COMMA_SOURCE_FILE_AT_LINE (854)) ;
        _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__3B) COMMA_HERE) ;
    ...
    while (syntaxRepeat) {
      switch (select_repeat_sara_parser_31 (_inLexique)) {
        case 2 : {
          ...
          if (var_cas_outModeMap._isBuilt ()) {
            var_cas_outModeMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_sourceModeName, var_cas_sourceModeIndex, automatic_var_14 COMMA_SOURCE_FILE_AT_LINE (864)) ;
          }
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_to) COMMA_HERE) ;
          GGS_lstring  var_cas_targetModeName ;
          _inLexique._assignFromAttribute_identifierString (var_cas_targetModeName) ;
          ...
          if (var_cas_outModeMap._isBuilt ()) {
            var_cas_outModeMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_targetModeName, var_cas_targetModeIndex, automatic_var_15 COMMA_SOURCE_FILE_AT_LINE (869)) ;
          }
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__3B) COMMA_HERE) ;
          if (((var_cas_sourceModeIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (871)))._operator_isEqual (var_cas_targetModeIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (871)))).isBuiltAndTrue ()) {
            var_cas_targetModeIndex.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "unuseful include: 'modalcompadd' operator never adds transitions from terminal states to initial states of the same mode") COMMA_SOURCE_FILE_AT_LINE (872)) ;
          }else{
...
void sara_parser::
sara_parser::
pr_definition_expression_factor_sara_parser_881_6_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
                                GGS_M_variablesMap  &var_cas_variablesMap,
                                GGS_AC_machineDefinition  &var_cas_outDefinition) {
  switch (select_sara_parser_32 (_inLexique)) {
    ...
    case 3 : {
      ...
      var_cas_previousVariableCount = var_cas_extendedVariablesMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (894)) ;
      ...
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
            var_cas_extendedVariablesMap.modifier_insertKey (_inLexique, var_cas_variableName COMMA_SOURCE_FILE_AT_LINE (899)) ;
      ...
      var_cas_actualVariableCount = var_cas_extendedVariablesMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (903)) ;
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__28) COMMA_HERE) ;
      GGS_AC_machineDefinition  var_cas_def ;
    ...
    case 4 : {
      ...
      var_cas_extendedVariablesMap = var_cas_variablesMap ;
      GGS_uint  var_cas_previousVariableCount ;
      var_cas_previousVariableCount = var_cas_extendedVariablesMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (911)) ;
      ...
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            _inLexique._assignFromAttribute_identifierString (var_cas_variableName) ;
            _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
            var_cas_extendedVariablesMap.modifier_insertKey (_inLexique, var_cas_variableName COMMA_SOURCE_FILE_AT_LINE (916)) ;
      ...
      GGS_uint  var_cas_actualVariableCount ;
      var_cas_actualVariableCount = var_cas_extendedVariablesMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (920)) ;
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__28) COMMA_HERE) ;
      GGS_AC_machineDefinition  var_cas_def ;
      nt_definition_expression_ (_inLexique, var_cas_ioMachinesMap, var_cas_extendedVariablesMap, var_cas_def) ;
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__29) COMMA_HERE) ;
...
void sara_parser::
sara_parser::
pr_definition_expression_factor_sara_parser_998_6_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
                                GGS_M_variablesMap  &var_cas_ioVarMap,
                                GGS_AC_machineDefinition  &var_cas_outDefinition) {
  GGS_lstring  var_cas_machineIdentifier ;
  ...
  GGS_luint  var_cas_indexOfImportedMachine ;
  if (var_cas_ioMachinesMap._isBuilt ()) {
    var_cas_ioMachinesMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_machineIdentifier, var_cas_indexOfImportedMachine, var_cas_machineInputVariableCount, var_cas_machineInputAndInternalVariableCount, var_cas_machineVariablesMap COMMA_SOURCE_FILE_AT_LINE (1009)) ;
  }
  GGS_L_translationVector  var_cas_translationVector ;
  var_cas_translationVector = GGS_L_translationVector::constructor_emptyList (_inLexique COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__28) COMMA_HERE) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        GGS_luint  var_cas_inputVarIndex ;
        if (var_cas_ioVarMap._isBuilt ()) {
          var_cas_ioVarMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_inputVar, var_cas_inputVarIndex COMMA_SOURCE_FILE_AT_LINE (1017)) ;
        }
        var_cas_translationVector._addAssign_operation (var_cas_inputVarIndex) ;
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__29) COMMA_HERE) ;
  GGS_uint  var_cas_inputVariablesCount ;
  var_cas_inputVariablesCount = var_cas_translationVector.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1023)) ;
  if (((var_cas_inputVariablesCount)._operator_isNotEqual (var_cas_machineInputVariableCount)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((GGS_string (true, "The '$"))._operator_concat (var_cas_machineIdentifier.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1025))))._operator_concat (GGS_string (true, "' machine defines ")))._operator_concat (var_cas_machineInputVariableCount.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1025))))._operator_concat (GGS_string (true, " input variable(s), but this operand defines ")))._operator_concat (var_cas_inputVariablesCount.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1026))))._operator_concat (GGS_string (true, " input variable(s)")) COMMA_SOURCE_FILE_AT_LINE (1027)) ;
  }
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__28) COMMA_HERE) ;
    ...
    case 2 : {
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            GGS_luint  var_cas_internalVarIndex ;
            if (var_cas_ioVarMap._isBuilt ()) {
              var_cas_ioVarMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_internalVar, var_cas_internalVarIndex COMMA_SOURCE_FILE_AT_LINE (1036)) ;
            }
            var_cas_translationVector._addAssign_operation (var_cas_internalVarIndex) ;
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__29) COMMA_HERE) ;
  GGS_uint  var_cas_inputAndInternalVariablesCount ;
  var_cas_inputAndInternalVariablesCount = var_cas_translationVector.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1043)) ;
  if (((var_cas_inputAndInternalVariablesCount)._operator_isNotEqual (var_cas_machineInputAndInternalVariableCount)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((GGS_string (true, "The '$"))._operator_concat (var_cas_machineIdentifier.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1045))))._operator_concat (GGS_string (true, "' machine defines ")))._operator_concat (var_cas_machineInputAndInternalVariableCount.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1045))))._operator_concat (GGS_string (true, " input and internal variable(s), but this operand defines ")))._operator_concat (var_cas_inputAndInternalVariablesCount.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1046))))._operator_concat (GGS_string (true, " input and internal variable(s)")) COMMA_SOURCE_FILE_AT_LINE (1047)) ;
  }
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__28) COMMA_HERE) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        GGS_luint  var_cas_outputVarIndex ;
        if (var_cas_ioVarMap._isBuilt ()) {
          var_cas_ioVarMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_outputVar, var_cas_outputVarIndex COMMA_SOURCE_FILE_AT_LINE (1054)) ;
        }
        var_cas_translationVector._addAssign_operation (var_cas_outputVarIndex) ;
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__29) COMMA_HERE) ;
  GGS_uint  var_cas_allVariablesCount ;
  var_cas_allVariablesCount = var_cas_translationVector.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1060)) ;
  GGS_uint  var_cas_machineAllVariablesCount ;
  var_cas_machineAllVariablesCount = var_cas_machineVariablesMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (1061)) ;
  if (((var_cas_allVariablesCount)._operator_isNotEqual (var_cas_machineAllVariablesCount)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((GGS_string (true, "The '$"))._operator_concat (var_cas_machineIdentifier.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1063))))._operator_concat (GGS_string (true, "' machine defines ")))._operator_concat (var_cas_machineAllVariablesCount.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1063))))._operator_concat (GGS_string (true, " variables, but this operand defines ")))._operator_concat (var_cas_allVariablesCount.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1064))))._operator_concat (GGS_string (true, " variables")) COMMA_SOURCE_FILE_AT_LINE (1065)) ;
  }
  var_cas_outDefinition = GGS_C_importMachine::constructor_new (_inLexique, var_cas_indexOfImportedMachine.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1066)), var_cas_translationVector COMMA_HERE) ;
}
...
void sara_parser::
sara_parser::
pr_explicit_automaton_sara_parser_1073_6_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
                                GGS_M_variablesMap  &var_cas_variablesMap,
                                GGS_AC_machineDefinition  &var_cas_outDefinition) {
  GGS_M_stateMap  var_cas_statesMap ;
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
        var_cas_statesMap.modifier_insertKey (_inLexique, var_cas_stateName COMMA_SOURCE_FILE_AT_LINE (1087)) ;
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        if (var_cas_statesMap._isBuilt ()) {
          var_cas_statesMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_initialState, var_cas_initialStateIndex COMMA_SOURCE_FILE_AT_LINE (1099)) ;
        }
    ...
    case 2 : {
      ...
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            if (var_cas_statesMap._isBuilt ()) {
              var_cas_statesMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_terminalState, var_cas_terminalStateIndex COMMA_SOURCE_FILE_AT_LINE (1114)) ;
            }
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        if (var_cas_statesMap._isBuilt ()) {
          var_cas_statesMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_stateName, var_cas_stateIndex COMMA_SOURCE_FILE_AT_LINE (1128)) ;
        }
        var_cas_stateDefinitionMap.modifier_defineState (_inLexique, var_cas_stateName COMMA_SOURCE_FILE_AT_LINE (1129)) ;
        _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__3A) COMMA_HERE) ;
          ...
          while (syntaxRepeat) {
            switch (select_repeat_sara_parser_44 (_inLexique)) {
              case 2 : {
                ...
                if (var_cas_statesMap._isBuilt ()) {
                  var_cas_statesMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_targetStateName, var_cas_targetStateIndex COMMA_SOURCE_FILE_AT_LINE (1147)) ;
                }
  ...
  const GGS_M_stateMap _var_35705 = var_cas_statesMap ;
  const GGS_M_stateMap::element_type * operand_35705 = _var_35705.firstObject () ;
  while ((operand_35705 != NULL)) {
    macroValidPointer (operand_35705) ;
    if (((var_cas_stateDefinitionMap.reader_hasKey (_inLexique, operand_35705->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1158)) COMMA_SOURCE_FILE_AT_LINE (1158)))._operator_not ()).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "'"))._operator_concat (operand_35705->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1159))))._operator_concat (GGS_string (true, "' state is not described")) COMMA_SOURCE_FILE_AT_LINE (1160)) ;
    }
    operand_35705 = operand_35705->nextObject () ;
  }
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__7D) COMMA_HERE) ;
