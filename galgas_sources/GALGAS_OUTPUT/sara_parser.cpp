...
//                    december 14th, 2009, at 21h39'51"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
pr_component_sara_parser_88_16_ (sara_scanner & inLexique,
  ...
  GGS_uint  automatic_var_2960_0 ;
  GGS_uint  automatic_var_2960_1 ;
  GGS_M_variablesMap  automatic_var_2960_2 ;
  const GGS_M_machinesMap  temp_2923 = var_cas_ioSemanticContext.reader_machinesMap (inLexique COMMA_SOURCE_FILE_AT_LINE (101)) ;
  if (temp_2923.isBuilt ()) {
    temp_2923 (HERE)->method_searchKey (inLexique, var_cas_machineName, var_cas_machineIndex, automatic_var_2960_0, automatic_var_2960_1, automatic_var_2960_2 COMMA_SOURCE_FILE_AT_LINE (101)) ;
  }
...
pr_component_sara_parser_109_16_ (sara_scanner & inLexique,
  ...
  GGS_uint  automatic_var_3700_0 ;
  GGS_uint  automatic_var_3700_1 ;
  GGS_M_variablesMap  automatic_var_3700_2 ;
  const GGS_M_machinesMap  temp_3661 = var_cas_ioSemanticContext.reader_machinesMap (inLexique COMMA_SOURCE_FILE_AT_LINE (125)) ;
  if (temp_3661.isBuilt ()) {
    temp_3661 (HERE)->method_searchKey (inLexique, var_cas_machineName1, var_cas_machineIndex1, automatic_var_3700_0, automatic_var_3700_1, automatic_var_3700_2 COMMA_SOURCE_FILE_AT_LINE (125)) ;
  }
  GGS_uint  var_cas_machineIndex2 ;
  GGS_uint  automatic_var_3847_0 ;
  GGS_uint  automatic_var_3847_1 ;
  GGS_M_variablesMap  automatic_var_3847_2 ;
  const GGS_M_machinesMap  temp_3808 = var_cas_ioSemanticContext.reader_machinesMap (inLexique COMMA_SOURCE_FILE_AT_LINE (128)) ;
  if (temp_3808.isBuilt ()) {
    temp_3808 (HERE)->method_searchKey (inLexique, var_cas_machineName2, var_cas_machineIndex2, automatic_var_3847_0, automatic_var_3847_1, automatic_var_3847_2 COMMA_SOURCE_FILE_AT_LINE (128)) ;
  }
...
pr_component_sara_parser_136_16_ (sara_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__3B_) COMMA_HERE) ;
  GGS_uint  var_cas_machineIndex ;
  GGS_uint  automatic_var_4529_0 ;
  GGS_uint  automatic_var_4529_1 ;
  GGS_M_variablesMap  automatic_var_4529_2 ;
  const GGS_M_machinesMap  temp_4492 = var_cas_ioSemanticContext.reader_machinesMap (inLexique COMMA_SOURCE_FILE_AT_LINE (149)) ;
  if (temp_4492.isBuilt ()) {
    temp_4492 (HERE)->method_searchKey (inLexique, var_cas_machineName, var_cas_machineIndex, automatic_var_4529_0, automatic_var_4529_1, automatic_var_4529_2 COMMA_SOURCE_FILE_AT_LINE (149)) ;
  }
...
pr_component_sara_parser_239_16_ (sara_scanner & inLexique,
  ...
  { bool syntaxRepeat_1 = true ;
    while (syntaxRepeat_1) {
        ...
        var_cas_variablesMap.modifier_insertKey (inLexique, var_cas_inputVarName, var_cas_variablesMap.reader_count () COMMA_SOURCE_FILE_AT_LINE (253)) ;
    ...
    case 2 : {
      { bool syntaxRepeat_3 = true ;
        while (syntaxRepeat_3) {
            ...
            inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
            var_cas_variablesMap.modifier_insertKey (inLexique, var_cas_outputVarName, var_cas_variablesMap.reader_count () COMMA_SOURCE_FILE_AT_LINE (266)) ;
  ...
  { bool syntaxRepeat_4 = true ;
    while (syntaxRepeat_4) {
        ...
        inLexique.assignFromAttribute_identifierString (var_cas_outputVarName) ;
        inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
        var_cas_variablesMap.modifier_insertKey (inLexique, var_cas_outputVarName, var_cas_variablesMap.reader_count () COMMA_SOURCE_FILE_AT_LINE (278)) ;
  ...
  const GGS_uint  var_cas_machineIndex = var_cas_ioSemanticContext.reader_machinesMap (inLexique COMMA_SOURCE_FILE_AT_LINE (288)).reader_count () ;
  var_cas_ioSemanticContext.machinesMap.modifier_insertKey (inLexique, var_cas_machineName, var_cas_machineIndex, var_cas_inputVariablesCount, var_cas_inputAndInternalVariablesCount, var_cas_variablesMap COMMA_SOURCE_FILE_AT_LINE (289)) ;
...
pr_component_sara_parser_298_16_ (sara_scanner & inLexique,
  ...
  { bool syntaxRepeat_5 = true ;
    while (syntaxRepeat_5) {
        ...
        inLexique.assignFromAttribute_identifierString (var_cas_inputVarName) ;
        inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
        var_cas_variablesMap.modifier_insertKey (inLexique, var_cas_inputVarName, var_cas_variablesMap.reader_count () COMMA_SOURCE_FILE_AT_LINE (313)) ;
    ...
    case 2 : {
      { bool syntaxRepeat_7 = true ;
        while (syntaxRepeat_7) {
            ...
            inLexique.assignFromAttribute_identifierString (var_cas_outputVarName) ;
            inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
            var_cas_variablesMap.modifier_insertKey (inLexique, var_cas_outputVarName, var_cas_variablesMap.reader_count () COMMA_SOURCE_FILE_AT_LINE (326)) ;
  ...
  { bool syntaxRepeat_8 = true ;
    while (syntaxRepeat_8) {
        ...
        inLexique.assignFromAttribute_identifierString (var_cas_outputVarName) ;
        inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
        var_cas_variablesMap.modifier_insertKey (inLexique, var_cas_outputVarName, var_cas_variablesMap.reader_count () COMMA_SOURCE_FILE_AT_LINE (338)) ;
  ...
  const GGS_uint  var_cas_machineIndex = var_cas_ioSemanticContext.reader_machinesMap (inLexique COMMA_SOURCE_FILE_AT_LINE (354)).reader_count () ;
  var_cas_ioSemanticContext.machinesMap.modifier_insertKey (inLexique, var_cas_machineName, var_cas_machineIndex, var_cas_inputVariablesCount, var_cas_inputAndInternalVariablesCount, var_cas_variablesMap COMMA_SOURCE_FILE_AT_LINE (355)) ;
...
pr_component_sara_parser_372_16_ (sara_scanner & inLexique,
  ...
  { bool syntaxRepeat_9 = true ;
    while (syntaxRepeat_9) {
        ...
        inLexique.assignFromAttribute_identifierString (var_cas_inputVarName) ;
        inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
        var_cas_variablesMap.modifier_insertKey (inLexique, var_cas_inputVarName, var_cas_variablesMap.reader_count () COMMA_SOURCE_FILE_AT_LINE (387)) ;
    ...
    case 2 : {
      { bool syntaxRepeat_11 = true ;
        while (syntaxRepeat_11) {
            ...
            inLexique.assignFromAttribute_identifierString (var_cas_outputVarName) ;
            inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
            var_cas_variablesMap.modifier_insertKey (inLexique, var_cas_outputVarName, var_cas_variablesMap.reader_count () COMMA_SOURCE_FILE_AT_LINE (400)) ;
  ...
  { bool syntaxRepeat_12 = true ;
    while (syntaxRepeat_12) {
        ...
        inLexique.assignFromAttribute_identifierString (var_cas_outputVarName) ;
        inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
        var_cas_variablesMap.modifier_insertKey (inLexique, var_cas_outputVarName, var_cas_variablesMap.reader_count () COMMA_SOURCE_FILE_AT_LINE (412)) ;
  ...
  const GGS_uint  var_cas_machineIndex = var_cas_ioSemanticContext.reader_machinesMap (inLexique COMMA_SOURCE_FILE_AT_LINE (428)).reader_count () ;
  var_cas_ioSemanticContext.machinesMap.modifier_insertKey (inLexique, var_cas_machineName, var_cas_machineIndex, var_cas_inputVariablesCount, var_cas_inputAndInternalVariablesCount, var_cas_variablesMap COMMA_SOURCE_FILE_AT_LINE (429)) ;
...
pr_component_sara_parser_444_16_ (sara_scanner & inLexique,
  ...
  const GGS_M_machinesMap  temp_12943 = var_cas_ioSemanticContext.reader_machinesMap (inLexique COMMA_SOURCE_FILE_AT_LINE (459)) ;
  if (temp_12943.isBuilt ()) {
    temp_12943 (HERE)->method_searchKey (inLexique, var_cas_machineName, var_cas_machineIndex, var_cas_inputVariablesCountFromDefinition, var_cas_inputAndInternalVariablesCountFromDefinition, var_cas_variablesMapFromDefinition COMMA_SOURCE_FILE_AT_LINE (459)) ;
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__28_) COMMA_HERE) ;
  { bool syntaxRepeat_13 = true ;
    while (syntaxRepeat_13) {
        ...
        inLexique.assignFromAttribute_identifierString (var_cas_inputVarName) ;
        inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
        var_cas_variablesMap.modifier_insertKey (inLexique, var_cas_inputVarName, var_cas_variablesMap.reader_count () COMMA_SOURCE_FILE_AT_LINE (465)) ;
  ...
  GGS_uint  var_cas_inputVariablesCount = var_cas_variablesMap.reader_count () ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__29_) COMMA_HERE) ;
  const GGS_bool cond_13674 = (var_cas_inputVariablesCountFromDefinition).operator_isNotEqual (var_cas_inputVariablesCount) ;
  if (cond_13674.isBuiltAndTrue ()) {
    ...
    case 2 : {
      { bool syntaxRepeat_15 = true ;
        while (syntaxRepeat_15) {
            ...
            inLexique.assignFromAttribute_identifierString (var_cas_outputVarName) ;
            inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
            var_cas_variablesMap.modifier_insertKey (inLexique, var_cas_outputVarName, var_cas_variablesMap.reader_count () COMMA_SOURCE_FILE_AT_LINE (483)) ;
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__29_) COMMA_HERE) ;
  GGS_uint  var_cas_inputAndInternalVariablesCount = var_cas_variablesMap.reader_count () ;
  const GGS_bool cond_14404 = (var_cas_inputAndInternalVariablesCountFromDefinition).operator_isNotEqual (var_cas_inputAndInternalVariablesCount) ;
  if (cond_14404.isBuiltAndTrue ()) {
  ...
  { bool syntaxRepeat_16 = true ;
    while (syntaxRepeat_16) {
        ...
        inLexique.assignFromAttribute_identifierString (var_cas_outputVarName) ;
        inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
        var_cas_variablesMap.modifier_insertKey (inLexique, var_cas_outputVarName, var_cas_variablesMap.reader_count () COMMA_SOURCE_FILE_AT_LINE (500)) ;
  ...
  const GGS_bool cond_15080 = (var_cas_outputVariablesCountFromDefinition).operator_isNotEqual (var_cas_outputVariablesCount) ;
          ...
          while (syntaxRepeat_18) {
              ...
              { bool syntaxRepeat_19 = true ;
                while (syntaxRepeat_19) {
                    ...
                    inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_literal_5F_integer) COMMA_HERE) ;
                    const GGS_bool cond_15529 = (var_cas_v.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (524))).operator_strictSup (GGS_uint (1U)) ;
              ...
              const GGS_bool cond_15883 = (var_cas_inputVariablesCount).operator_isNotEqual (var_cas_inputConfigurationForScenario.reader_length ()) ;
              if (cond_15883.isBuiltAndTrue ()) {
                GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((GGS_string ("this input configuration names ")).operator_concat (var_cas_inputConfigurationForScenario.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (532)))).operator_concat (GGS_string (" input variable(s), instead of "))).operator_concat (var_cas_inputVariablesCount.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (532))) COMMA_SOURCE_FILE_AT_LINE (533)) ;
              }
...
pr_io_primary_sara_parser_610_17_ (sara_scanner & inLexique,
  ...
  const GGS_M_variablesMap  temp_18599 = var_cas_ioVarMap ;
  if (temp_18599.isBuilt ()) {
    temp_18599 (HERE)->method_searchKey (inLexique, var_cas_inputVarName, var_cas_inputVarIndex COMMA_SOURCE_FILE_AT_LINE (618)) ;
  }
...
pr_io_primary_sara_parser_659_17_ (sara_scanner & inLexique,
  ...
  const GGS_M_machinesMap  temp_20128 = var_cas_inSemanticContext.reader_machinesMap (inLexique COMMA_SOURCE_FILE_AT_LINE (670)) ;
  if (temp_20128.isBuilt ()) {
    temp_20128 (HERE)->method_searchKey (inLexique, var_cas_machineIdentifier, var_cas_indexOfImportedMachine, var_cas_machineInputVariableCount, var_cas_machineInputAndInternalVariableCount, var_cas_machineVariablesMap COMMA_SOURCE_FILE_AT_LINE (670)) ;
  }
  ...
  { bool syntaxRepeat_22 = true ;
    while (syntaxRepeat_22) {
        ...
        inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
        GGS_uint  var_cas_inputVarIndex ;
        const GGS_M_variablesMap  temp_20463 = var_cas_ioVarMap ;
        if (temp_20463.isBuilt ()) {
          temp_20463 (HERE)->method_searchKey (inLexique, var_cas_inputVar, var_cas_inputVarIndex COMMA_SOURCE_FILE_AT_LINE (678)) ;
        }
  ...
  const GGS_bool cond_20915 = (var_cas_inputVariablesCount).operator_isNotEqual (var_cas_machineInputVariableCount) ;
  if (cond_20915.isBuiltAndTrue ()) {
    ...
    case 2 : {
      { bool syntaxRepeat_24 = true ;
        while (syntaxRepeat_24) {
            ...
            const GGS_M_variablesMap  temp_21104 = var_cas_ioVarMap ;
            if (temp_21104.isBuilt ()) {
              temp_21104 (HERE)->method_searchKey (inLexique, var_cas_internalVar, var_cas_internalVarIndex COMMA_SOURCE_FILE_AT_LINE (697)) ;
            }
  ...
  const GGS_bool cond_21679 = (var_cas_inputAndInternalVariablesCount).operator_isNotEqual (var_cas_machineInputAndInternalVariableCount) ;
  if (cond_21679.isBuiltAndTrue ()) {
  ...
  { bool syntaxRepeat_25 = true ;
    while (syntaxRepeat_25) {
        ...
        const GGS_M_variablesMap  temp_21836 = var_cas_ioVarMap ;
        if (temp_21836.isBuilt ()) {
          temp_21836 (HERE)->method_searchKey (inLexique, var_cas_outputVar, var_cas_outputVarIndex COMMA_SOURCE_FILE_AT_LINE (715)) ;
        }
  ...
  const GGS_bool cond_22342 = (var_cas_allVariablesCount).operator_isNotEqual (var_cas_machineAllVariablesCount) ;
  ...
  var_cas_outExpression = GGS_C_importBoolMachine ::constructor_new (inLexique, var_cas_indexOfImportedMachine, var_cas_machineIdentifier.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (729)), var_cas_translationVector COMMA_HERE) ;
}
...
pr_modalcompadd_definition_sara_parser_788_30_ (sara_scanner & inLexique,
  ...
  { bool syntaxRepeat_28 = true ;
    while (syntaxRepeat_28) {
        ...
        var_cas_outModeMap.modifier_insertKey (inLexique, var_cas_modeName, var_cas_outModeMap.reader_count (), var_cas_def COMMA_SOURCE_FILE_AT_LINE (802)) ;
        inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__3B_) COMMA_HERE) ;
    ...
    while (syntaxRepeat_29) {
      switch (select_sara_parser_29 (inLexique)) {
        case 2 : {
          ...
          GGS_AC_machineDefinition  automatic_var_25362_0 ;
          const GGS_M_modesMap  temp_25325 = var_cas_outModeMap ;
          if (temp_25325.isBuilt ()) {
            temp_25325 (HERE)->method_searchKey (inLexique, var_cas_sourceModeName, var_cas_sourceModeIndex, automatic_var_25362_0 COMMA_SOURCE_FILE_AT_LINE (812)) ;
          }
          ...
          GGS_AC_machineDefinition  automatic_var_25532_0 ;
          const GGS_M_modesMap  temp_25495 = var_cas_outModeMap ;
          if (temp_25495.isBuilt ()) {
            temp_25495 (HERE)->method_searchKey (inLexique, var_cas_targetModeName, var_cas_targetModeIndex, automatic_var_25532_0 COMMA_SOURCE_FILE_AT_LINE (817)) ;
          }
          inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__3B_) COMMA_HERE) ;
          const GGS_bool cond_25756 = (var_cas_sourceModeIndex).operator_isEqual (var_cas_targetModeIndex) ;
          if (cond_25756.isBuiltAndTrue ()) {
            var_cas_targetModeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("unuseful include: 'modalcompadd' operator never adds transitions from terminal states to initial states of the same mode") COMMA_SOURCE_FILE_AT_LINE (820)) ;
          }else if (cond_25756.isBuiltAndFalse ()) {
...
pr_modalcompsub_definition_sara_parser_829_30_ (sara_scanner & inLexique,
  ...
  { bool syntaxRepeat_30 = true ;
    while (syntaxRepeat_30) {
        ...
        GGS_AC_machineDefinition  var_cas_def ;
        nt_definition_expression_ (inLexique, var_cas_inSemanticContext, var_cas_variablesMap, var_cas_def) ;
        var_cas_outModeMap.modifier_insertKey (inLexique, var_cas_modeName, var_cas_outModeMap.reader_count (), var_cas_def COMMA_SOURCE_FILE_AT_LINE (843)) ;
        inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__3B_) COMMA_HERE) ;
    ...
    while (syntaxRepeat_31) {
      switch (select_sara_parser_31 (inLexique)) {
        case 2 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
          GGS_uint  var_cas_sourceModeIndex ;
          GGS_AC_machineDefinition  automatic_var_26656_0 ;
          const GGS_M_modesMap  temp_26619 = var_cas_outModeMap ;
          if (temp_26619.isBuilt ()) {
            temp_26619 (HERE)->method_searchKey (inLexique, var_cas_sourceModeName, var_cas_sourceModeIndex, automatic_var_26656_0 COMMA_SOURCE_FILE_AT_LINE (853)) ;
          }
          inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_to) COMMA_HERE) ;
          GGS_lstring  var_cas_targetModeName ;
          inLexique.assignFromAttribute_identifierString (var_cas_targetModeName) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
          GGS_uint  var_cas_targetModeIndex ;
          GGS_AC_machineDefinition  automatic_var_26826_0 ;
          const GGS_M_modesMap  temp_26789 = var_cas_outModeMap ;
          if (temp_26789.isBuilt ()) {
            temp_26789 (HERE)->method_searchKey (inLexique, var_cas_targetModeName, var_cas_targetModeIndex, automatic_var_26826_0 COMMA_SOURCE_FILE_AT_LINE (858)) ;
          }
          inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__3B_) COMMA_HERE) ;
          const GGS_bool cond_27050 = (var_cas_sourceModeIndex).operator_isEqual (var_cas_targetModeIndex) ;
          if (cond_27050.isBuiltAndTrue ()) {
            var_cas_targetModeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("unuseful include: 'modalcompadd' operator never adds transitions from terminal states to initial states of the same mode") COMMA_SOURCE_FILE_AT_LINE (861)) ;
          }else if (cond_27050.isBuiltAndFalse ()) {
    ...
    case 3 : {
      ...
      { bool syntaxRepeat_33 = true ;
        while (syntaxRepeat_33) {
            ...
            inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
            var_cas_extendedVariablesMap.modifier_insertKey (inLexique, var_cas_variableName, var_cas_extendedVariablesMap.reader_count () COMMA_SOURCE_FILE_AT_LINE (888)) ;
    ...
    case 4 : {
      ...
      { bool syntaxRepeat_34 = true ;
        while (syntaxRepeat_34) {
            ...
            inLexique.assignFromAttribute_identifierString (var_cas_variableName) ;
            inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
            var_cas_extendedVariablesMap.modifier_insertKey (inLexique, var_cas_variableName, var_cas_extendedVariablesMap.reader_count () COMMA_SOURCE_FILE_AT_LINE (905)) ;
...
pr_definition_expression_factor_sara_parser_987_35_ (sara_scanner & inLexique,
  ...
  GGS_M_variablesMap  var_cas_machineVariablesMap ;
  GGS_uint  var_cas_indexOfImportedMachine ;
  const GGS_M_machinesMap  temp_31339 = var_cas_inSemanticContext.reader_machinesMap (inLexique COMMA_SOURCE_FILE_AT_LINE (998)) ;
  if (temp_31339.isBuilt ()) {
    temp_31339 (HERE)->method_searchKey (inLexique, var_cas_machineIdentifier, var_cas_indexOfImportedMachine, var_cas_machineInputVariableCount, var_cas_machineInputAndInternalVariableCount, var_cas_machineVariablesMap COMMA_SOURCE_FILE_AT_LINE (998)) ;
  }
  GGS_L_translationVector  var_cas_translationVector = GGS_L_translationVector ::constructor_emptyList () ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__28_) COMMA_HERE) ;
  { bool syntaxRepeat_35 = true ;
    while (syntaxRepeat_35) {
        ...
        inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
        GGS_uint  var_cas_inputVarIndex ;
        const GGS_M_variablesMap  temp_31674 = var_cas_ioVarMap ;
        if (temp_31674.isBuilt ()) {
          temp_31674 (HERE)->method_searchKey (inLexique, var_cas_inputVar, var_cas_inputVarIndex COMMA_SOURCE_FILE_AT_LINE (1006)) ;
        }
        var_cas_translationVector.addAssign_operation (var_cas_inputVarIndex) ;
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__29_) COMMA_HERE) ;
  GGS_uint  var_cas_inputVariablesCount = var_cas_translationVector.reader_length () ;
  const GGS_bool cond_32135 = (var_cas_inputVariablesCount).operator_isNotEqual (var_cas_machineInputVariableCount) ;
    ...
    case 2 : {
      { bool syntaxRepeat_37 = true ;
        while (syntaxRepeat_37) {
            ...
            inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
            GGS_uint  var_cas_internalVarIndex ;
            const GGS_M_variablesMap  temp_32324 = var_cas_ioVarMap ;
            if (temp_32324.isBuilt ()) {
              temp_32324 (HERE)->method_searchKey (inLexique, var_cas_internalVar, var_cas_internalVarIndex COMMA_SOURCE_FILE_AT_LINE (1025)) ;
            }
            var_cas_translationVector.addAssign_operation (var_cas_internalVarIndex) ;
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__29_) COMMA_HERE) ;
  GGS_uint  var_cas_inputAndInternalVariablesCount = var_cas_translationVector.reader_length () ;
  const GGS_bool cond_32899 = (var_cas_inputAndInternalVariablesCount).operator_isNotEqual (var_cas_machineInputAndInternalVariableCount) ;
  if (cond_32899.isBuiltAndTrue ()) {
  ...
  { bool syntaxRepeat_38 = true ;
    while (syntaxRepeat_38) {
        ...
        inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
        GGS_uint  var_cas_outputVarIndex ;
        const GGS_M_variablesMap  temp_33056 = var_cas_ioVarMap ;
        if (temp_33056.isBuilt ()) {
          temp_33056 (HERE)->method_searchKey (inLexique, var_cas_outputVar, var_cas_outputVarIndex COMMA_SOURCE_FILE_AT_LINE (1043)) ;
        }
        var_cas_translationVector.addAssign_operation (var_cas_outputVarIndex) ;
  ...
  GGS_uint  var_cas_allVariablesCount = var_cas_translationVector.reader_length () ;
  GGS_uint  var_cas_machineAllVariablesCount = var_cas_machineVariablesMap.reader_count () ;
  const GGS_bool cond_33562 = (var_cas_allVariablesCount).operator_isNotEqual (var_cas_machineAllVariablesCount) ;
  if (cond_33562.isBuiltAndTrue ()) {
...
pr_explicit_automaton_sara_parser_1062_25_ (sara_scanner & inLexique,
  ...
  { bool syntaxRepeat_39 = true ;
    while (syntaxRepeat_39) {
        ...
        inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
        var_cas_statesMap.modifier_insertKey (inLexique, var_cas_stateName, var_cas_statesMap.reader_count () COMMA_SOURCE_FILE_AT_LINE (1076)) ;
  ...
  { bool syntaxRepeat_40 = true ;
    while (syntaxRepeat_40) {
        ...
        const GGS_M_stateMap  temp_34579 = var_cas_statesMap ;
        if (temp_34579.isBuilt ()) {
          temp_34579 (HERE)->method_searchKey (inLexique, var_cas_initialState, var_cas_initialStateIndex COMMA_SOURCE_FILE_AT_LINE (1088)) ;
        }
    ...
    case 2 : {
      ...
      { bool syntaxRepeat_42 = true ;
        while (syntaxRepeat_42) {
            ...
            const GGS_M_stateMap  temp_34974 = var_cas_statesMap ;
            if (temp_34974.isBuilt ()) {
              temp_34974 (HERE)->method_searchKey (inLexique, var_cas_terminalState, var_cas_terminalStateIndex COMMA_SOURCE_FILE_AT_LINE (1103)) ;
            }
  ...
  { bool syntaxRepeat_43 = true ;
    while (syntaxRepeat_43) {
        ...
        const GGS_M_stateMap  temp_35352 = var_cas_statesMap ;
        if (temp_35352.isBuilt ()) {
          temp_35352 (HERE)->method_searchKey (inLexique, var_cas_stateName, var_cas_stateIndex COMMA_SOURCE_FILE_AT_LINE (1117)) ;
        }
        var_cas_stateDefinitionMap.modifier_defineState (inLexique, var_cas_stateName, var_cas_stateDefinitionMap.reader_count () COMMA_SOURCE_FILE_AT_LINE (1118)) ;
        inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__3A_) COMMA_HERE) ;
          ...
          while (syntaxRepeat_44) {
            switch (select_sara_parser_44 (inLexique)) {
              case 2 : {
                ...
                const GGS_M_stateMap  temp_36111 = var_cas_statesMap ;
                if (temp_36111.isBuilt ()) {
                  temp_36111 (HERE)->method_searchKey (inLexique, var_cas_targetStateName, var_cas_targetStateIndex COMMA_SOURCE_FILE_AT_LINE (1136)) ;
                }
  ...
  {
    GGS_M_stateMap::cEnumerator enumerator_36478 (var_cas_statesMap, true) ;
    const GGS_M_stateMap::cElement * operand_36478 = NULL ;
    while (((operand_36478 = enumerator_36478.nextObject ()))) {
      macroValidPointer (operand_36478) ;
      const GGS_bool cond_36616 = (var_cas_stateDefinitionMap.reader_hasKey (operand_36478->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1147)))).operator_not () ;
      if (cond_36616.isBuiltAndTrue ()) {
        GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("'")).operator_concat (operand_36478->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1148)))).operator_concat (GGS_string ("' state is not described")) COMMA_SOURCE_FILE_AT_LINE (1149)) ;
      }
    }
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__7D_) COMMA_HERE) ;
