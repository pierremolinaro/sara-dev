          ...
          while (syntaxRepeat) {
              ...
              { bool syntaxRepeat = true ;
                while (syntaxRepeat) {
                    ...
                    if (((var_cas_v.reader_uint (_inLexique SOURCE_FILE_AT_LINE (959))) > (GGS_uint (true, 1U))).isBuiltAndTrue ()) {
...
pr_io_primary_sara_parser_1094_18_ (sara_scanner & _inLexique,
  ...
  if (((var_cas_inputVariablesCount) != (var_cas_machineInputVariableCount)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((((((GGS_string (true, "The '$")) + (var_cas_machineIdentifier.reader_string (_inLexique SOURCE_FILE_AT_LINE (1121))))) + (GGS_string (true, "' machine defines ")))) + (var_cas_machineInputVariableCount.reader_string (_inLexique SOURCE_FILE_AT_LINE (1121))))) + (GGS_string (true, " input variable(s), but this operand defines ")))) + (var_cas_inputVariablesCount.reader_string (_inLexique SOURCE_FILE_AT_LINE (1122))))) + (GGS_string (true, " input variable(s)"))) SOURCE_FILE_AT_LINE (1123)) ;
  }
  _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__28) ;
  ...
  if (((var_cas_allVariablesCount) != (var_cas_machineAllVariablesCount)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((((((GGS_string (true, "The '$")) + (var_cas_machineIdentifier.reader_string (_inLexique SOURCE_FILE_AT_LINE (1159))))) + (GGS_string (true, "' machine defines ")))) + (var_cas_machineAllVariablesCount.reader_string (_inLexique SOURCE_FILE_AT_LINE (1159))))) + (GGS_string (true, " variables, but this operand defines ")))) + (var_cas_allVariablesCount.reader_string (_inLexique SOURCE_FILE_AT_LINE (1160))))) + (GGS_string (true, " variables"))) SOURCE_FILE_AT_LINE (1161)) ;
  }
  var_cas_outExpression = GGS_C_importBoolMachine::constructor_new (_inLexique, var_cas_indexOfImportedMachine.reader_uint (_inLexique SOURCE_FILE_AT_LINE (1163)), var_cas_machineIdentifier.reader_location (_inLexique SOURCE_FILE_AT_LINE (1164)), var_cas_translationVector COMMA_HERE) ;
}
    ...
    while (syntaxRepeat) {
      switch (select_repeat_sara_parser_29 (_inLexique)) {
        case 2 : {
          ...
          GGS_AC_machineDefinition  var_cas_36757 ;
          if (var_cas_outModeMap._isBuilt ()) {
            var_cas_outModeMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_sourceModeName, var_cas_sourceModeIndex, var_cas_36757 SOURCE_FILE_AT_LINE (1247)) ;
          }
          ...
          GGS_AC_machineDefinition  var_cas_36936 ;
          if (var_cas_outModeMap._isBuilt ()) {
            var_cas_outModeMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_targetModeName, var_cas_targetModeIndex, var_cas_36936 SOURCE_FILE_AT_LINE (1252)) ;
          }
          _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__3B) ;
          if (((var_cas_sourceModeIndex.reader_uint (_inLexique SOURCE_FILE_AT_LINE (1254))) == (var_cas_targetModeIndex.reader_uint (_inLexique SOURCE_FILE_AT_LINE (1254)))).isBuiltAndTrue ()) {
    ...
    while (syntaxRepeat) {
      switch (select_repeat_sara_parser_31 (_inLexique)) {
        case 2 : {
          ...
          var_cas_sourceModeName.defineAttributeFromScanner (_inLexique.identifierString, _inLexique) ;
          GGS_luint  var_cas_sourceModeIndex ;
          GGS_AC_machineDefinition  var_cas_38055 ;
          if (var_cas_outModeMap._isBuilt ()) {
            var_cas_outModeMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_sourceModeName, var_cas_sourceModeIndex, var_cas_38055 SOURCE_FILE_AT_LINE (1288)) ;
          }
          _inLexique.acceptTerminal (sara_scanner::sara_scanner_1_to) ;
          GGS_lstring  var_cas_targetModeName ;
          _inLexique.acceptTerminal (sara_scanner::sara_scanner_1_identifier) ;
          var_cas_targetModeName.defineAttributeFromScanner (_inLexique.identifierString, _inLexique) ;
          GGS_luint  var_cas_targetModeIndex ;
          GGS_AC_machineDefinition  var_cas_38234 ;
          if (var_cas_outModeMap._isBuilt ()) {
            var_cas_outModeMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_targetModeName, var_cas_targetModeIndex, var_cas_38234 SOURCE_FILE_AT_LINE (1293)) ;
          }
          _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__3B) ;
          if (((var_cas_sourceModeIndex.reader_uint (_inLexique SOURCE_FILE_AT_LINE (1295))) == (var_cas_targetModeIndex.reader_uint (_inLexique SOURCE_FILE_AT_LINE (1295)))).isBuiltAndTrue ()) {
...
pr_definition_expression_factor_sara_parser_1422_36_ (sara_scanner & _inLexique,
  ...
  if (((var_cas_inputVariablesCount) != (var_cas_machineInputVariableCount)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((((((GGS_string (true, "The '$")) + (var_cas_machineIdentifier.reader_string (_inLexique SOURCE_FILE_AT_LINE (1449))))) + (GGS_string (true, "' machine defines ")))) + (var_cas_machineInputVariableCount.reader_string (_inLexique SOURCE_FILE_AT_LINE (1449))))) + (GGS_string (true, " input variable(s), but this operand defines ")))) + (var_cas_inputVariablesCount.reader_string (_inLexique SOURCE_FILE_AT_LINE (1450))))) + (GGS_string (true, " input variable(s)"))) SOURCE_FILE_AT_LINE (1451)) ;
  }
  _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__28) ;
  ...
  if (((var_cas_allVariablesCount) != (var_cas_machineAllVariablesCount)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((((((GGS_string (true, "The '$")) + (var_cas_machineIdentifier.reader_string (_inLexique SOURCE_FILE_AT_LINE (1487))))) + (GGS_string (true, "' machine defines ")))) + (var_cas_machineAllVariablesCount.reader_string (_inLexique SOURCE_FILE_AT_LINE (1487))))) + (GGS_string (true, " variables, but this operand defines ")))) + (var_cas_allVariablesCount.reader_string (_inLexique SOURCE_FILE_AT_LINE (1488))))) + (GGS_string (true, " variables"))) SOURCE_FILE_AT_LINE (1489)) ;
  }
  var_cas_outDefinition = GGS_C_importMachine::constructor_new (_inLexique, var_cas_indexOfImportedMachine.reader_uint (_inLexique SOURCE_FILE_AT_LINE (1490)), var_cas_translationVector COMMA_HERE) ;
}
...
pr_explicit_automaton_sara_parser_1497_26_ (sara_scanner & _inLexique,
  ...
  GGS_M_stateMap::element_type * operand_47793 = var_cas_statesMap.firstObject () ;
  while ((operand_47793 != NULL)) {
    macroValidPointer (operand_47793) ;
    if (((! (var_cas_stateDefinitionMap.reader_hasKey (_inLexique, operand_47793->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1582)) SOURCE_FILE_AT_LINE (1582))))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "'")) + (operand_47793->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1583))))) + (GGS_string (true, "' state is not described"))) SOURCE_FILE_AT_LINE (1584)) ;
    }
    operand_47793 = operand_47793->nextObject () ;
  }
  _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__7D) ;
