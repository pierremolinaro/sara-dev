...
pr_start_symbol_sara_parser_496_20_ (sara_scanner & lexique_var_) {
  ...
  if (var_cas_componentsMap.isBuilt ()) {
    ::routine_performComputations (lexique_var_,  var_cas_componentsMap SOURCE_FILE_AT_LINE (504)) ;
  }
}
...
pr_component_sara_parser_509_17_ (sara_scanner & lexique_var_,
  ...
  var_cas_ioMachinesMap.methode_searchKeyGetIndex (lexique_var_, var_cas_machineName, var_cas_machineIndex, var_cas_14909, var_cas_14912, var_cas_14915 SOURCE_FILE_AT_LINE (523)) ;
...
pr_component_sara_parser_531_17_ (sara_scanner & lexique_var_,
  ...
  var_cas_ioMachinesMap.methode_searchKeyGetIndex (lexique_var_, var_cas_machineName1, var_cas_machineIndex1, var_cas_15628, var_cas_15631, var_cas_15634 SOURCE_FILE_AT_LINE (548)) ;
  GGS_luint  var_cas_machineIndex2 ;
  GGS_uint  var_cas_15768 ;
  GGS_uint  var_cas_15771 ;
  GGS_M_variablesMap  var_cas_15774 ;
  var_cas_ioMachinesMap.methode_searchKeyGetIndex (lexique_var_, var_cas_machineName2, var_cas_machineIndex2, var_cas_15768, var_cas_15771, var_cas_15774 SOURCE_FILE_AT_LINE (551)) ;
  GGS_AC_job  var_cas_job ;
...
pr_component_sara_parser_559_17_ (sara_scanner & lexique_var_,
  ...
  var_cas_ioMachinesMap.methode_searchKeyGetIndex (lexique_var_, var_cas_machineName, var_cas_machineIndex, var_cas_16429, var_cas_16432, var_cas_16435 SOURCE_FILE_AT_LINE (573)) ;
  GGS_AC_job  var_cas_job ;
...
pr_component_sara_parser_670_17_ (sara_scanner & lexique_var_,
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        var_cas_variablesMap.methode_insertKey (lexique_var_, var_cas_inputVarName SOURCE_FILE_AT_LINE (685)) ;
    ...
    case 2 : {
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            var_cas_variablesMap.methode_insertKey (lexique_var_, var_cas_outputVarName SOURCE_FILE_AT_LINE (698)) ;
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1_identifier) ;
        var_cas_outputVarName.defineAttribute (lexique_var_.identifierString, lexique_var_) ;
        var_cas_variablesMap.methode_insertKey (lexique_var_, var_cas_outputVarName SOURCE_FILE_AT_LINE (710)) ;
  ...
  GGS_luint  var_cas_machineIndex ;
  var_cas_ioMachinesMap.methode_insertKeyGetIndex (lexique_var_, var_cas_machineName, var_cas_machineIndex, var_cas_inputVariablesCount, var_cas_inputAndInternalVariablesCount, var_cas_variablesMap SOURCE_FILE_AT_LINE (721)) ;
...
pr_component_sara_parser_730_17_ (sara_scanner & lexique_var_,
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1_identifier) ;
        var_cas_inputVarName.defineAttribute (lexique_var_.identifierString, lexique_var_) ;
        var_cas_variablesMap.methode_insertKey (lexique_var_, var_cas_inputVarName SOURCE_FILE_AT_LINE (746)) ;
    ...
    case 2 : {
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1_identifier) ;
            var_cas_outputVarName.defineAttribute (lexique_var_.identifierString, lexique_var_) ;
            var_cas_variablesMap.methode_insertKey (lexique_var_, var_cas_outputVarName SOURCE_FILE_AT_LINE (759)) ;
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1_identifier) ;
        var_cas_outputVarName.defineAttribute (lexique_var_.identifierString, lexique_var_) ;
        var_cas_variablesMap.methode_insertKey (lexique_var_, var_cas_outputVarName SOURCE_FILE_AT_LINE (771)) ;
  ...
  GGS_luint  var_cas_machineIndex ;
  var_cas_ioMachinesMap.methode_insertKeyGetIndex (lexique_var_, var_cas_machineName, var_cas_machineIndex, var_cas_inputVariablesCount, var_cas_inputAndInternalVariablesCount, var_cas_variablesMap SOURCE_FILE_AT_LINE (788)) ;
  GGS_AC_job  var_cas_machine ;
...
pr_component_sara_parser_805_17_ (sara_scanner & lexique_var_,
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1_identifier) ;
        var_cas_inputVarName.defineAttribute (lexique_var_.identifierString, lexique_var_) ;
        var_cas_variablesMap.methode_insertKey (lexique_var_, var_cas_inputVarName SOURCE_FILE_AT_LINE (821)) ;
    ...
    case 2 : {
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1_identifier) ;
            var_cas_outputVarName.defineAttribute (lexique_var_.identifierString, lexique_var_) ;
            var_cas_variablesMap.methode_insertKey (lexique_var_, var_cas_outputVarName SOURCE_FILE_AT_LINE (834)) ;
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1_identifier) ;
        var_cas_outputVarName.defineAttribute (lexique_var_.identifierString, lexique_var_) ;
        var_cas_variablesMap.methode_insertKey (lexique_var_, var_cas_outputVarName SOURCE_FILE_AT_LINE (846)) ;
  ...
  GGS_luint  var_cas_machineIndex ;
  var_cas_ioMachinesMap.methode_insertKeyGetIndex (lexique_var_, var_cas_machineName, var_cas_machineIndex, var_cas_inputVariablesCount, var_cas_inputAndInternalVariablesCount, var_cas_variablesMap SOURCE_FILE_AT_LINE (863)) ;
  GGS_AC_job  var_cas_machine ;
...
pr_component_sara_parser_878_17_ (sara_scanner & lexique_var_,
  ...
  var_cas_ioMachinesMap.methode_searchKeyGetIndex (lexique_var_, var_cas_machineName, var_cas_machineIndex, var_cas_inputVariablesCountFromDefinition, var_cas_inputAndInternalVariablesCountFromDefinition, var_cas_variablesMapFromDefinition SOURCE_FILE_AT_LINE (894)) ;
  lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1__28) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        GGS_lstring  var_cas_inputVarName ;
        lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1_identifier) ;
        var_cas_inputVarName.defineAttribute (lexique_var_.identifierString, lexique_var_) ;
        var_cas_variablesMap.methode_insertKey (lexique_var_, var_cas_inputVarName SOURCE_FILE_AT_LINE (900)) ;
    ...
    case 2 : {
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1_identifier) ;
            var_cas_outputVarName.defineAttribute (lexique_var_.identifierString, lexique_var_) ;
            var_cas_variablesMap.methode_insertKey (lexique_var_, var_cas_outputVarName SOURCE_FILE_AT_LINE (918)) ;
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1_identifier) ;
        var_cas_outputVarName.defineAttribute (lexique_var_.identifierString, lexique_var_) ;
        var_cas_variablesMap.methode_insertKey (lexique_var_, var_cas_outputVarName SOURCE_FILE_AT_LINE (935)) ;
  ...
  if (((var_cas_outputVariablesCountFromDefinition) != (var_cas_outputVariablesCount)).isBuiltAndTrue ()) {
      GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "This declaration names ")) + (var_cas_outputVariablesCount.reader_string ()))) + (GGS_string (true, " variables, but machine definition names ")))) + (var_cas_outputVariablesCountFromDefinition.reader_string ()))) + (GGS_string (true, " variables"))) SOURCE_FILE_AT_LINE (945)) ;
  }
        ...
        { bool syntaxRepeat = true ;
          while (syntaxRepeat) {
              ...
              { bool syntaxRepeat = true ;
                while (syntaxRepeat) {
                    ...
                    if (((var_cas_v.reader_value ()) > (GGS_uint (true, 1UL))).isBuiltAndTrue ()) {
                        var_cas_v.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this value is not a  binary digit") SOURCE_FILE_AT_LINE (960)) ;
                    }
              ...
              if (((var_cas_inputVariablesCount) != (var_cas_inputConfigurationForScenario.reader_length ())).isBuiltAndTrue ()) {
                  GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((((GGS_string (true, "this input configuration names ")) + (var_cas_inputConfigurationForScenario.reader_length ().reader_string ()))) + (GGS_string (true, " input variable(s), instead of ")))) + (var_cas_inputVariablesCount.reader_string ())) SOURCE_FILE_AT_LINE (967)) ;
              }
...
pr_io_primary_sara_parser_1045_18_ (sara_scanner & lexique_var_,
  ...
  var_cas_ioVarMap.methode_searchKeyGetIndex (lexique_var_, var_cas_inputVarName, var_cas_inputVarIndex SOURCE_FILE_AT_LINE (1053)) ;
...
pr_io_primary_sara_parser_1094_18_ (sara_scanner & lexique_var_,
  ...
  var_cas_ioMachinesMap.methode_searchKeyGetIndex (lexique_var_, var_cas_machineIdentifier, var_cas_indexOfImportedMachine, var_cas_machineInputVariableCount, var_cas_machineInputAndInternalVariableCount, var_cas_machineVariablesMap SOURCE_FILE_AT_LINE (1105)) ;
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        GGS_luint  var_cas_inputVarIndex ;
        var_cas_ioVarMap.methode_searchKeyGetIndex (lexique_var_, var_cas_inputVar, var_cas_inputVarIndex SOURCE_FILE_AT_LINE (1113)) ;
  ...
  if (((var_cas_inputVariablesCount) != (var_cas_machineInputVariableCount)).isBuiltAndTrue ()) {
      GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((((((((((GGS_string (true, "The '$")) + (var_cas_machineIdentifier.reader_value ()))) + (GGS_string (true, "' machine defines ")))) + (var_cas_machineInputVariableCount.reader_string ()))) + (GGS_string (true, " input variable(s), but this operand defines ")))) + (var_cas_inputVariablesCount.reader_string ()))) + (GGS_string (true, " input variable(s)"))) SOURCE_FILE_AT_LINE (1122)) ;
  }
  lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1__28) ;
    ...
    case 2 : {
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            var_cas_ioVarMap.methode_searchKeyGetIndex (lexique_var_, var_cas_internalVar, var_cas_internalVarIndex SOURCE_FILE_AT_LINE (1132)) ;
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        var_cas_ioVarMap.methode_searchKeyGetIndex (lexique_var_, var_cas_outputVar, var_cas_outputVarIndex SOURCE_FILE_AT_LINE (1150)) ;
...
pr_modalcompadd_definition_sara_parser_1223_31_ (sara_scanner & lexique_var_,
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        var_cas_outModeMap.methode_insertKey (lexique_var_, var_cas_modeName, var_cas_def SOURCE_FILE_AT_LINE (1237)) ;
        lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1__3B) ;
    ...
    while (syntaxRepeat) {
      switch (select_repeat_sara_parser_29 (lexique_var_)) {
        case 2 : {
          ...
          var_cas_outModeMap.methode_searchKeyGetIndex (lexique_var_, var_cas_sourceModeName, var_cas_sourceModeIndex, var_cas_36678 SOURCE_FILE_AT_LINE (1247)) ;
          ...
          var_cas_outModeMap.methode_searchKeyGetIndex (lexique_var_, var_cas_targetModeName, var_cas_targetModeIndex, var_cas_36859 SOURCE_FILE_AT_LINE (1252)) ;
          lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1__3B) ;
          if (((var_cas_sourceModeIndex.reader_value ()) == (var_cas_targetModeIndex.reader_value ())).isBuiltAndTrue ()) {
              var_cas_targetModeIndex.reader_location ().signalGGSSemanticWarning (lexique_var_, GGS_string (true, "unuseful include: 'modalcompadd' operator never adds transitions from terminal states to initial states of the same mode") SOURCE_FILE_AT_LINE (1255)) ;
          }else{
...
pr_modalcompsub_definition_sara_parser_1264_31_ (sara_scanner & lexique_var_,
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        GGS_AC_machineDefinition  var_cas_def ;
        nt_definition_expression_ (lexique_var_, var_cas_ioMachinesMap, var_cas_variablesMap, var_cas_def) ;
        var_cas_outModeMap.methode_insertKey (lexique_var_, var_cas_modeName, var_cas_def SOURCE_FILE_AT_LINE (1278)) ;
        lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1__3B) ;
    ...
    while (syntaxRepeat) {
      switch (select_repeat_sara_parser_31 (lexique_var_)) {
        case 2 : {
          ...
          var_cas_outModeMap.methode_searchKeyGetIndex (lexique_var_, var_cas_sourceModeName, var_cas_sourceModeIndex, var_cas_37975 SOURCE_FILE_AT_LINE (1288)) ;
          lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1_to) ;
          GGS_lstring  var_cas_targetModeName ;
          lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1_identifier) ;
          var_cas_targetModeName.defineAttribute (lexique_var_.identifierString, lexique_var_) ;
          ...
          var_cas_outModeMap.methode_searchKeyGetIndex (lexique_var_, var_cas_targetModeName, var_cas_targetModeIndex, var_cas_38156 SOURCE_FILE_AT_LINE (1293)) ;
          lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1__3B) ;
          if (((var_cas_sourceModeIndex.reader_value ()) == (var_cas_targetModeIndex.reader_value ())).isBuiltAndTrue ()) {
              var_cas_targetModeIndex.reader_location ().signalGGSSemanticWarning (lexique_var_, GGS_string (true, "unuseful include: 'modalcompadd' operator never adds transitions from terminal states to initial states of the same mode") SOURCE_FILE_AT_LINE (1296)) ;
          }else{
    ...
    case 3 : {
      ...
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            var_cas_extendedVariablesMap.methode_insertKey (lexique_var_, var_cas_variableName SOURCE_FILE_AT_LINE (1323)) ;
    ...
    case 4 : {
      ...
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1_identifier) ;
            var_cas_variableName.defineAttribute (lexique_var_.identifierString, lexique_var_) ;
            var_cas_extendedVariablesMap.methode_insertKey (lexique_var_, var_cas_variableName SOURCE_FILE_AT_LINE (1340)) ;
...
pr_definition_expression_factor_sara_parser_1422_36_ (sara_scanner & lexique_var_,
  ...
  GGS_M_variablesMap  var_cas_machineVariablesMap ;
  GGS_luint  var_cas_indexOfImportedMachine ;
  var_cas_ioMachinesMap.methode_searchKeyGetIndex (lexique_var_, var_cas_machineIdentifier, var_cas_indexOfImportedMachine, var_cas_machineInputVariableCount, var_cas_machineInputAndInternalVariableCount, var_cas_machineVariablesMap SOURCE_FILE_AT_LINE (1433)) ;
  GGS_L_translationVector  var_cas_translationVector ;
  var_cas_translationVector = GGS_L_translationVector::constructor_empty (HERE) ;
  lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1__28) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        var_cas_inputVar.defineAttribute (lexique_var_.identifierString, lexique_var_) ;
        GGS_luint  var_cas_inputVarIndex ;
        var_cas_ioVarMap.methode_searchKeyGetIndex (lexique_var_, var_cas_inputVar, var_cas_inputVarIndex SOURCE_FILE_AT_LINE (1441)) ;
        var_cas_translationVector.addAssign_operation (var_cas_inputVarIndex) ;
  ...
  var_cas_inputVariablesCount = var_cas_translationVector.reader_length () ;
  if (((var_cas_inputVariablesCount) != (var_cas_machineInputVariableCount)).isBuiltAndTrue ()) {
      GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((((((((((GGS_string (true, "The '$")) + (var_cas_machineIdentifier.reader_value ()))) + (GGS_string (true, "' machine defines ")))) + (var_cas_machineInputVariableCount.reader_string ()))) + (GGS_string (true, " input variable(s), but this operand defines ")))) + (var_cas_inputVariablesCount.reader_string ()))) + (GGS_string (true, " input variable(s)"))) SOURCE_FILE_AT_LINE (1450)) ;
  }
  lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1__28) ;
    ...
    case 2 : {
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            var_cas_internalVar.defineAttribute (lexique_var_.identifierString, lexique_var_) ;
            GGS_luint  var_cas_internalVarIndex ;
            var_cas_ioVarMap.methode_searchKeyGetIndex (lexique_var_, var_cas_internalVar, var_cas_internalVarIndex SOURCE_FILE_AT_LINE (1460)) ;
            var_cas_translationVector.addAssign_operation (var_cas_internalVarIndex) ;
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        var_cas_outputVar.defineAttribute (lexique_var_.identifierString, lexique_var_) ;
        GGS_luint  var_cas_outputVarIndex ;
        var_cas_ioVarMap.methode_searchKeyGetIndex (lexique_var_, var_cas_outputVar, var_cas_outputVarIndex SOURCE_FILE_AT_LINE (1478)) ;
        var_cas_translationVector.addAssign_operation (var_cas_outputVarIndex) ;
...
pr_explicit_automaton_sara_parser_1497_26_ (sara_scanner & lexique_var_,
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        var_cas_statesMap.methode_insertKey (lexique_var_, var_cas_stateName SOURCE_FILE_AT_LINE (1511)) ;
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        var_cas_statesMap.methode_searchKeyGetIndex (lexique_var_, var_cas_initialState, var_cas_initialStateIndex SOURCE_FILE_AT_LINE (1523)) ;
    ...
    case 2 : {
      ...
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            var_cas_statesMap.methode_searchKeyGetIndex (lexique_var_, var_cas_terminalState, var_cas_terminalStateIndex SOURCE_FILE_AT_LINE (1538)) ;
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        var_cas_statesMap.methode_searchKeyGetIndex (lexique_var_, var_cas_stateName, var_cas_stateIndex SOURCE_FILE_AT_LINE (1552)) ;
        var_cas_stateDefinitionMap.methode_defineState (lexique_var_, var_cas_stateName SOURCE_FILE_AT_LINE (1553)) ;
        lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1__3A) ;
          ...
          while (syntaxRepeat) {
            switch (select_repeat_sara_parser_44 (lexique_var_)) {
              case 2 : {
                ...
                var_cas_statesMap.methode_searchKeyGetIndex (lexique_var_, var_cas_targetStateName, var_cas_targetStateIndex SOURCE_FILE_AT_LINE (1571)) ;
  ...
  while ((operand_47705 != NULL)) {
    ...
    if (((! (var_cas_stateDefinitionMap.reader_hasKey (operand_47705->mKey.reader_value ())))).isBuiltAndTrue ()) {
        GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "'")) + (operand_47705->mKey.reader_value ()))) + (GGS_string (true, "' state is not described"))) SOURCE_FILE_AT_LINE (1583)) ;
    }
