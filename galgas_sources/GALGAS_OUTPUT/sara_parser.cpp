...
void sara_parser::
pr_io_expression_sara_parser_409_21_ (sara_scanner & lexique_var_,
...
void sara_parser::
pr_io_and_expression_sara_parser_438_25_ (sara_scanner & lexique_var_,
                                GGS_M_variablesMap  &var_cas_ioVarMap,
                                GGS_AC_expression  &var_cas_outExpression) {
...
void sara_parser::
pr_io_primary_sara_parser_461_18_ (sara_scanner & lexique_var_,
                                GGS_M_variablesMap  &var_cas_ioVarMap,
                                GGS_AC_expression  &var_cas_outExpression) {
  GGS_lstring  var_cas_inputVarName ;
  lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1_identifier) ;
...
void sara_parser::
pr_io_primary_sara_parser_472_18_ (sara_scanner & lexique_var_,
                                GGS_M_variablesMap  &var_cas_ioVarMap,
                                GGS_AC_expression  &var_cas_outExpression) {
...
void sara_parser::
pr_io_primary_sara_parser_482_18_ (sara_scanner & lexique_var_,
                                GGS_M_variablesMap  &/* var_cas_ioVarMap */,
                                GGS_AC_expression  &var_cas_outExpression) {
...
void sara_parser::
pr_io_primary_sara_parser_490_18_ (sara_scanner & lexique_var_,
                                GGS_M_variablesMap  &/* var_cas_ioVarMap */,
                                GGS_AC_expression  &var_cas_outExpression) {
...
void sara_parser::
pr_definition_expression_sara_parser_500_29_ (sara_scanner & lexique_var_,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
                                GGS_M_variablesMap  &var_cas_variablesMap,
...
void sara_parser::
pr_definition_expression_term_sara_parser_534_34_ (sara_scanner & lexique_var_,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
                                GGS_M_variablesMap  &var_cas_variablesMap,
                                GGS_AC_machineDefinition  &var_cas_outDefinition) {
...
void sara_parser::
pr_definition_expression_factor_sara_parser_564_36_ (sara_scanner & lexique_var_,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
                                GGS_M_variablesMap  &var_cas_variablesMap,
                                GGS_AC_machineDefinition  &var_cas_outDefinition) {
...
void sara_parser::
pr_definition_expression_factor_sara_parser_617_36_ (sara_scanner & lexique_var_,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
                                GGS_M_variablesMap  &var_cas_ioVarMap,
                                GGS_AC_machineDefinition  &var_cas_outDefinition) {
...
void sara_parser::
pr_explicit_automaton_sara_parser_667_26_ (sara_scanner & lexique_var_,
                                GGS_M_variablesMap  &var_cas_variablesMap,
                                GGS_AC_machineDefinition  &var_cas_outDefinition) {
  GGS_M_stateMap  var_cas_statesMap ;
  var_cas_statesMap = GGS_M_stateMap::constructor_empty () ;
  ...
  GGS_M_stateMap::element_type * operand_24900 = var_cas_statesMap.getFirstItem () ;
  while (operand_24900 != NULL) {
    macroValidPointer (operand_24900) ;
    if (((! var_cas_stateDefinitionMap.reader_hasKey (operand_24900->mKey))).isBuiltAndTrue ()) {
        GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "'")) + (operand_24900->mKey.reader_value ()))) + (GGS_string (true, "' state is not described")))) ;
    }
    operand_24900 = operand_24900->getNextItem () ;
  }
  lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1__7D) ;
