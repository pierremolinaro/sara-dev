...
void sara_parser::
pr_definition_expression_factor_sara_parser_1415_36_ (sara_scanner & lexique_var_,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
                                GGS_M_variablesMap  &var_cas_ioVarMap,
                                GGS_AC_machineDefinition  &var_cas_outDefinition) {
  GGS_lstring  var_cas_machineIdentifier ;
...
void sara_parser::
pr_explicit_automaton_sara_parser_1490_26_ (sara_scanner & lexique_var_,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
                                GGS_M_variablesMap  &var_cas_variablesMap,
                                GGS_AC_machineDefinition  &var_cas_outDefinition) {
  GGS_M_stateMap  var_cas_statesMap ;
  ...
  GGS_M_stateMap::element_type * operand_48032 = var_cas_statesMap.firstObject () ;
  while ((operand_48032 != NULL)) {
    macroValidPointer (operand_48032) ;
    if (((! var_cas_stateDefinitionMap.reader_hasKey (operand_48032->mKey))).isBuiltAndTrue ()) {
        GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "'")) + (operand_48032->mKey.reader_value ()))) + (GGS_string (true, "' state is not described")))) ;
    }
    operand_48032 = operand_48032->nextObject () ;
  }
  lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1__7D) ;
