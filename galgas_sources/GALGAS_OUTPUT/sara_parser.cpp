...
//                    november 14th, 2009, at 17h40'48"                      *
//                                                                           *
//---------------------------------------------------------------------------*
    ...
    while (syntaxRepeat_17) {
        ...
        { bool syntaxRepeat_18 = true ;
          while (syntaxRepeat_18) {
              ...
              const GGS_bool cond_15544 = (var_cas_inputVariablesCount).operator_isNotEqual (var_cas_inputConfigurationForScenario.reader_length ()) ;
...
pr_explicit_automaton_sara_parser_1062_25_ (sara_scanner & inLexique,
  ...
  }
  {
    ...
    while (((operand_36190 = enumerator_36190.nextObject ()))) {
      ...
      const GGS_bool cond_36328 = (var_cas_stateDefinitionMap.reader_hasKey (operand_36190->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1147)))).operator_not () ;
