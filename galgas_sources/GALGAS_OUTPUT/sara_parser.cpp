...
void sara_parser::
pr_start_symbol_sara_parser_432_20_ (sara_scanner & lexique_var_) {
...
void sara_parser::
pr_component_sara_parser_464_17_ (sara_scanner & lexique_var_,
                                GGS_M_machinesMap  &/* var_cas_ioMachinesMap */,
                                GGS_L_jobList  &var_cas_ioJobList) {
...
void sara_parser::
pr_component_sara_parser_474_17_ (sara_scanner & lexique_var_,
                                GGS_M_machinesMap  &/* var_cas_ioMachinesMap */,
                                GGS_L_jobList  &var_cas_ioJobList) {
...
void sara_parser::
pr_component_sara_parser_495_17_ (sara_scanner & lexique_var_,
                                GGS_M_machinesMap  &/* var_cas_ioMachinesMap */,
                                GGS_L_jobList  &var_cas_ioJobList) {
...
void sara_parser::
pr_component_sara_parser_521_17_ (sara_scanner & lexique_var_,
                                GGS_M_machinesMap  &/* var_cas_ioMachinesMap */,
                                GGS_L_jobList  &var_cas_ioJobList) {
...
void sara_parser::
pr_component_sara_parser_533_17_ (sara_scanner & lexique_var_,
                                GGS_M_machinesMap  &/* var_cas_ioMachinesMap */,
                                GGS_L_jobList  &var_cas_ioJobList) {
...
void sara_parser::
pr_component_sara_parser_543_17_ (sara_scanner & lexique_var_,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
                                GGS_L_jobList  &var_cas_ioJobList) {
  GGS_M_variablesMap  var_cas_variablesMap ;
  var_cas_variablesMap = GGS_M_variablesMap::constructor_empty () ;
...
void sara_parser::
pr_io_expression_sara_parser_705_21_ (sara_scanner & lexique_var_,
...
void sara_parser::
pr_io_and_expression_sara_parser_734_25_ (sara_scanner & lexique_var_,
                                GGS_M_variablesMap  &var_cas_ioVarMap,
                                GGS_AC_expression  &var_cas_outExpression) {
...
void sara_parser::
pr_io_primary_sara_parser_748_18_ (sara_scanner & lexique_var_,
                                GGS_M_variablesMap  &var_cas_ioVarMap,
                                GGS_AC_expression  &var_cas_outExpression) {
  lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1__28) ;
...
void sara_parser::
pr_io_primary_sara_parser_768_18_ (sara_scanner & lexique_var_,
                                GGS_M_variablesMap  &var_cas_ioVarMap,
                                GGS_AC_expression  &var_cas_outExpression) {
...
void sara_parser::
pr_io_primary_sara_parser_778_18_ (sara_scanner & lexique_var_,
                                GGS_M_variablesMap  &/* var_cas_ioVarMap */,
                                GGS_AC_expression  &var_cas_outExpression) {
...
void sara_parser::
pr_io_primary_sara_parser_786_18_ (sara_scanner & lexique_var_,
                                GGS_M_variablesMap  &/* var_cas_ioVarMap */,
                                GGS_AC_expression  &var_cas_outExpression) {
...
void sara_parser::
pr_definition_expression_sara_parser_796_29_ (sara_scanner & lexique_var_,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
                                GGS_M_variablesMap  &var_cas_variablesMap,
...
void sara_parser::
pr_definition_expression_term_sara_parser_830_34_ (sara_scanner & lexique_var_,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
                                GGS_M_variablesMap  &var_cas_variablesMap,
                                GGS_AC_machineDefinition  &var_cas_outDefinition) {
...
void sara_parser::
pr_definition_expression_factor_sara_parser_862_36_ (sara_scanner & lexique_var_,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
                                GGS_M_variablesMap  &var_cas_variablesMap,
                                GGS_AC_machineDefinition  &var_cas_outDefinition) {
  switch (select_sara_parser_16 (lexique_var_)) {
    ...
    case 8 : {
      ...
      var_cas_inclusionList = GGS_ListForModes::constructor_empty () ;
      lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1__7B) ;
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
          ...
          switch (select_repeat_sara_parser_19 (lexique_var_)) {
            case 2 : {
              ...
              if (((var_cas_sourceModeIndex.reader_value ()) == (var_cas_targetModeIndex.reader_value ())).isBuiltAndTrue ()) {
                ...
                var_cas_inclusionList.addAssign_operation (var_cas_sourceModeIndex, var_cas_targetModeIndex) ;
              }
              } break ;
            default :
              syntaxRepeat = false ;
    ...
    case 9 : {
      ...
      var_cas_exclusionList = GGS_ListForModes::constructor_empty () ;
      lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1__7B) ;
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            GGS_lstring  var_cas_modeName ;
        ...
        while (syntaxRepeat) {
          switch (select_repeat_sara_parser_21 (lexique_var_)) {
            case 2 : {
              ...
              lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1__3B) ;
              if (((var_cas_sourceModeIndex.reader_value ()) == (var_cas_targetModeIndex.reader_value ())).isBuiltAndTrue ()) {
                  var_cas_targetModeIndex.reader_location ().signalGGSSemanticWarning (lexique_var_, GGS_string (true, "unuseful exclude: 'modalcompsub' operator never adds transitions from terminal states to initial states of the same mode")) ;
              }else{
...
pr_explicit_automaton_sara_parser_1080_26_ (sara_scanner & lexique_var_,
  ...
  switch (select_sara_parser_28 (lexique_var_)) {
    case 1 : {
      } break ;
    case 2 : {
  ...
  GGS_M_stateMap::element_type * operand_37938 = var_cas_statesMap.firstObject () ;
  while (operand_37938 != NULL) {
    macroValidPointer (operand_37938) ;
    if (((! var_cas_stateDefinitionMap.reader_hasKey (operand_37938->mKey))).isBuiltAndTrue ()) {
        GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "'")) + (operand_37938->mKey.reader_value ()))) + (GGS_string (true, "' state is not described")))) ;
    }
    operand_37938 = operand_37938->nextObject () ;
  }
  lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1__7D) ;
