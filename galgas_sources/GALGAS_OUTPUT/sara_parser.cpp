...
//                    december 27th, 2005, at 21h31'55"                      *
//                                                                           *
...
pr_component_sara_parser_509_17_ (sara_scanner & lexique_var_,
  ...
  GGS_uint  var_cas_14986 ;
  GGS_uint  var_cas_14989 ;
  GGS_M_variablesMap  var_cas_14992 ;
  var_cas_ioMachinesMap.methode_searchKeyGetIndex (lexique_var_, var_cas_machineName, var_cas_machineIndex, var_cas_14986, var_cas_14989, var_cas_14992) ;
...
pr_component_sara_parser_531_17_ (sara_scanner & lexique_var_,
  ...
  GGS_uint  var_cas_15705 ;
  GGS_uint  var_cas_15708 ;
  GGS_M_variablesMap  var_cas_15711 ;
  var_cas_ioMachinesMap.methode_searchKeyGetIndex (lexique_var_, var_cas_machineName1, var_cas_machineIndex1, var_cas_15705, var_cas_15708, var_cas_15711) ;
  GGS_luint  var_cas_machineIndex2 ;
  GGS_uint  var_cas_15845 ;
  GGS_uint  var_cas_15848 ;
  GGS_M_variablesMap  var_cas_15851 ;
  var_cas_ioMachinesMap.methode_searchKeyGetIndex (lexique_var_, var_cas_machineName2, var_cas_machineIndex2, var_cas_15845, var_cas_15848, var_cas_15851) ;
  GGS_AC_job  var_cas_job ;
...
pr_component_sara_parser_559_17_ (sara_scanner & lexique_var_,
  ...
  lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1__3B) ;
  GGS_luint  var_cas_machineIndex ;
  GGS_uint  var_cas_16506 ;
  GGS_uint  var_cas_16509 ;
  GGS_M_variablesMap  var_cas_16512 ;
  var_cas_ioMachinesMap.methode_searchKeyGetIndex (lexique_var_, var_cas_machineName, var_cas_machineIndex, var_cas_16506, var_cas_16509, var_cas_16512) ;
  GGS_AC_job  var_cas_job ;
    ...
    while (syntaxRepeat) {
      switch (select_repeat_sara_parser_29 (lexique_var_)) {
        case 2 : {
          ...
          GGS_AC_machineDefinition  var_cas_36755 ;
          var_cas_outModeMap.methode_searchKeyGetIndex (lexique_var_, var_cas_sourceModeName, var_cas_sourceModeIndex, var_cas_36755) ;
          ...
          var_cas_outModeMap.methode_searchKeyGetIndex (lexique_var_, var_cas_targetModeName, var_cas_targetModeIndex, var_cas_36936) ;
          lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1__3B) ;
    ...
    while (syntaxRepeat) {
      switch (select_repeat_sara_parser_31 (lexique_var_)) {
        case 2 : {
          ...
          var_cas_sourceModeName.defineAttribute (lexique_var_.identifierString, lexique_var_) ;
          GGS_luint  var_cas_sourceModeIndex ;
          GGS_AC_machineDefinition  var_cas_38052 ;
          var_cas_outModeMap.methode_searchKeyGetIndex (lexique_var_, var_cas_sourceModeName, var_cas_sourceModeIndex, var_cas_38052) ;
          lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1_to) ;
          GGS_lstring  var_cas_targetModeName ;
          lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1_identifier) ;
          var_cas_targetModeName.defineAttribute (lexique_var_.identifierString, lexique_var_) ;
          GGS_luint  var_cas_targetModeIndex ;
          GGS_AC_machineDefinition  var_cas_38233 ;
          var_cas_outModeMap.methode_searchKeyGetIndex (lexique_var_, var_cas_targetModeName, var_cas_targetModeIndex, var_cas_38233) ;
          lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1__3B) ;
          if (((var_cas_sourceModeIndex.reader_value ()) == (var_cas_targetModeIndex.reader_value ())).isBuiltAndTrue ()) {
              var_cas_targetModeIndex.reader_location ().signalGGSSemanticWarning (lexique_var_, GGS_string (true, "unuseful include: 'modalcompadd' operator never adds transitions from terminal states to initial states of the same mode")) ;
          }else{
...
pr_explicit_automaton_sara_parser_1497_26_ (sara_scanner & lexique_var_,
  ...
  GGS_M_stateMap::element_type * operand_47782 = var_cas_statesMap.firstObject () ;
  while ((operand_47782 != NULL)) {
    macroValidPointer (operand_47782) ;
    if (((! var_cas_stateDefinitionMap.reader_hasKey (operand_47782->mKey.reader_value ()))).isBuiltAndTrue ()) {
        GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "'")) + (operand_47782->mKey.reader_value ()))) + (GGS_string (true, "' state is not described")))) ;
    }
    operand_47782 = operand_47782->nextObject () ;
  }
  lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1__7D) ;
