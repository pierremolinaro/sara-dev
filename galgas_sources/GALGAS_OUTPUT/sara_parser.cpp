...
void sara_parser::
sara_parser::
pr_component_sara_parser_139_17_ (sara_scanner & _inLexique,
  ...
  if (var_cas_ioMachinesMap._isBuilt ()) {
    var_cas_ioMachinesMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_machineName, var_cas_machineIndex, automatic_var_0, automatic_var_1, automatic_var_2 SOURCE_FILE_AT_LINE (153)) ;
  }
...
void sara_parser::
sara_parser::
pr_component_sara_parser_161_17_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
                                GGS_L_jobList  &var_cas_ioJobList) {
  GGS_M_variablesMap  var_cas_variablesMap ;
  var_cas_variablesMap = GGS_M_variablesMap::constructor_emptyMap (_inLexique COMMA_HERE) ;
  ...
  if (var_cas_ioMachinesMap._isBuilt ()) {
    var_cas_ioMachinesMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_machineName1, var_cas_machineIndex1, automatic_var_3, automatic_var_4, automatic_var_5 SOURCE_FILE_AT_LINE (178)) ;
  }
  ...
  if (var_cas_ioMachinesMap._isBuilt ()) {
    var_cas_ioMachinesMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_machineName2, var_cas_machineIndex2, automatic_var_6, automatic_var_7, automatic_var_8 SOURCE_FILE_AT_LINE (181)) ;
  }
  GGS_AC_job  var_cas_job ;
...
void sara_parser::
sara_parser::
pr_component_sara_parser_189_17_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
                                GGS_L_jobList  &var_cas_ioJobList) {
  GGS_M_variablesMap  var_cas_variablesMap ;
  var_cas_variablesMap = GGS_M_variablesMap::constructor_emptyMap (_inLexique COMMA_HERE) ;
  ...
  if (var_cas_ioMachinesMap._isBuilt ()) {
    var_cas_ioMachinesMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_machineName, var_cas_machineIndex, automatic_var_9, automatic_var_10, automatic_var_11 SOURCE_FILE_AT_LINE (203)) ;
  }
  GGS_AC_job  var_cas_job ;
...
void sara_parser::
sara_parser::
pr_component_sara_parser_211_17_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &/* var_cas_ioMachinesMap */,
                                GGS_L_jobList  &var_cas_ioJobList) {
...
void sara_parser::
sara_parser::
pr_component_sara_parser_223_17_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &/* var_cas_ioMachinesMap */,
                                GGS_L_jobList  &var_cas_ioJobList) {
...
void sara_parser::
sara_parser::
pr_component_sara_parser_235_17_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &/* var_cas_ioMachinesMap */,
                                GGS_L_jobList  &var_cas_ioJobList) {
...
void sara_parser::
sara_parser::
pr_component_sara_parser_247_17_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &/* var_cas_ioMachinesMap */,
                                GGS_L_jobList  &var_cas_ioJobList) {
...
void sara_parser::
sara_parser::
pr_component_sara_parser_260_17_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &/* var_cas_ioMachinesMap */,
                                GGS_L_jobList  &var_cas_ioJobList) {
...
void sara_parser::
sara_parser::
pr_component_sara_parser_274_17_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &/* var_cas_ioMachinesMap */,
                                GGS_L_jobList  &var_cas_ioJobList) {
...
void sara_parser::
sara_parser::
pr_component_sara_parser_288_17_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &/* var_cas_ioMachinesMap */,
                                GGS_L_jobList  &var_cas_ioJobList) {
...
void sara_parser::
sara_parser::
pr_component_sara_parser_300_17_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
                                GGS_L_jobList  &var_cas_ioJobList) {
  GGS_M_variablesMap  var_cas_variablesMap ;
  var_cas_variablesMap = GGS_M_variablesMap::constructor_emptyMap (_inLexique COMMA_HERE) ;
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        var_cas_variablesMap.modifier_insertKey (_inLexique, var_cas_inputVarName SOURCE_FILE_AT_LINE (315)) ;
  ...
  var_cas_inputVariablesCount = var_cas_variablesMap.reader_count (_inLexique SOURCE_FILE_AT_LINE (319)) ;
    ...
    case 2 : {
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            var_cas_variablesMap.modifier_insertKey (_inLexique, var_cas_outputVarName SOURCE_FILE_AT_LINE (328)) ;
  ...
  var_cas_inputAndInternalVariablesCount = var_cas_variablesMap.reader_count (_inLexique SOURCE_FILE_AT_LINE (334)) ;
  _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__28) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        GGS_lstring  var_cas_outputVarName ;
        _inLexique.acceptTerminal (sara_scanner::sara_scanner_1_identifier) ;
        var_cas_outputVarName.defineAttributeFromScanner (_inLexique.identifierString, _inLexique) ;
        var_cas_variablesMap.modifier_insertKey (_inLexique, var_cas_outputVarName SOURCE_FILE_AT_LINE (340)) ;
  ...
  GGS_luint  var_cas_machineIndex ;
  var_cas_ioMachinesMap.modifier_insertKeyGetIndex (_inLexique, var_cas_machineName, var_cas_machineIndex, var_cas_inputVariablesCount, var_cas_inputAndInternalVariablesCount, var_cas_variablesMap SOURCE_FILE_AT_LINE (351)) ;
...
void sara_parser::
sara_parser::
pr_component_sara_parser_360_17_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
                                GGS_L_jobList  &var_cas_ioJobList) {
  GGS_M_variablesMap  var_cas_variablesMap ;
  var_cas_variablesMap = GGS_M_variablesMap::constructor_emptyMap (_inLexique COMMA_HERE) ;
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        _inLexique.acceptTerminal (sara_scanner::sara_scanner_1_identifier) ;
        var_cas_inputVarName.defineAttributeFromScanner (_inLexique.identifierString, _inLexique) ;
        var_cas_variablesMap.modifier_insertKey (_inLexique, var_cas_inputVarName SOURCE_FILE_AT_LINE (376)) ;
  ...
  GGS_uint  var_cas_inputVariablesCount ;
  var_cas_inputVariablesCount = var_cas_variablesMap.reader_count (_inLexique SOURCE_FILE_AT_LINE (380)) ;
  _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__29) ;
  _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__28) ;
    ...
    case 2 : {
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            _inLexique.acceptTerminal (sara_scanner::sara_scanner_1_identifier) ;
            var_cas_outputVarName.defineAttributeFromScanner (_inLexique.identifierString, _inLexique) ;
            var_cas_variablesMap.modifier_insertKey (_inLexique, var_cas_outputVarName SOURCE_FILE_AT_LINE (389)) ;
  ...
  _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__29) ;
  GGS_uint  var_cas_inputAndInternalVariablesCount ;
  var_cas_inputAndInternalVariablesCount = var_cas_variablesMap.reader_count (_inLexique SOURCE_FILE_AT_LINE (395)) ;
  _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__28) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        GGS_lstring  var_cas_outputVarName ;
        _inLexique.acceptTerminal (sara_scanner::sara_scanner_1_identifier) ;
        var_cas_outputVarName.defineAttributeFromScanner (_inLexique.identifierString, _inLexique) ;
        var_cas_variablesMap.modifier_insertKey (_inLexique, var_cas_outputVarName SOURCE_FILE_AT_LINE (401)) ;
  ...
  GGS_luint  var_cas_machineIndex ;
  var_cas_ioMachinesMap.modifier_insertKeyGetIndex (_inLexique, var_cas_machineName, var_cas_machineIndex, var_cas_inputVariablesCount, var_cas_inputAndInternalVariablesCount, var_cas_variablesMap SOURCE_FILE_AT_LINE (418)) ;
  GGS_AC_job  var_cas_machine ;
...
void sara_parser::
sara_parser::
pr_component_sara_parser_435_17_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
                                GGS_L_jobList  &var_cas_ioJobList) {
  GGS_M_variablesMap  var_cas_variablesMap ;
  var_cas_variablesMap = GGS_M_variablesMap::constructor_emptyMap (_inLexique COMMA_HERE) ;
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        _inLexique.acceptTerminal (sara_scanner::sara_scanner_1_identifier) ;
        var_cas_inputVarName.defineAttributeFromScanner (_inLexique.identifierString, _inLexique) ;
        var_cas_variablesMap.modifier_insertKey (_inLexique, var_cas_inputVarName SOURCE_FILE_AT_LINE (451)) ;
  ...
  GGS_uint  var_cas_inputVariablesCount ;
  var_cas_inputVariablesCount = var_cas_variablesMap.reader_count (_inLexique SOURCE_FILE_AT_LINE (455)) ;
  _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__29) ;
  _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__28) ;
    ...
    case 2 : {
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            _inLexique.acceptTerminal (sara_scanner::sara_scanner_1_identifier) ;
            var_cas_outputVarName.defineAttributeFromScanner (_inLexique.identifierString, _inLexique) ;
            var_cas_variablesMap.modifier_insertKey (_inLexique, var_cas_outputVarName SOURCE_FILE_AT_LINE (464)) ;
  ...
  _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__29) ;
  GGS_uint  var_cas_inputAndInternalVariablesCount ;
  var_cas_inputAndInternalVariablesCount = var_cas_variablesMap.reader_count (_inLexique SOURCE_FILE_AT_LINE (470)) ;
  _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__28) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        GGS_lstring  var_cas_outputVarName ;
        _inLexique.acceptTerminal (sara_scanner::sara_scanner_1_identifier) ;
        var_cas_outputVarName.defineAttributeFromScanner (_inLexique.identifierString, _inLexique) ;
        var_cas_variablesMap.modifier_insertKey (_inLexique, var_cas_outputVarName SOURCE_FILE_AT_LINE (476)) ;
  ...
  GGS_luint  var_cas_machineIndex ;
  var_cas_ioMachinesMap.modifier_insertKeyGetIndex (_inLexique, var_cas_machineName, var_cas_machineIndex, var_cas_inputVariablesCount, var_cas_inputAndInternalVariablesCount, var_cas_variablesMap SOURCE_FILE_AT_LINE (493)) ;
  GGS_AC_job  var_cas_machine ;
...
void sara_parser::
sara_parser::
pr_component_sara_parser_508_17_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
                                GGS_L_jobList  &var_cas_ioJobList) {
  ...
  if (var_cas_ioMachinesMap._isBuilt ()) {
    var_cas_ioMachinesMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_machineName, var_cas_machineIndex, var_cas_inputVariablesCountFromDefinition, var_cas_inputAndInternalVariablesCountFromDefinition, var_cas_variablesMapFromDefinition SOURCE_FILE_AT_LINE (524)) ;
  }
  _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__28) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        _inLexique.acceptTerminal (sara_scanner::sara_scanner_1_identifier) ;
        var_cas_inputVarName.defineAttributeFromScanner (_inLexique.identifierString, _inLexique) ;
        var_cas_variablesMap.modifier_insertKey (_inLexique, var_cas_inputVarName SOURCE_FILE_AT_LINE (530)) ;
  ...
  GGS_uint  var_cas_inputVariablesCount ;
  var_cas_inputVariablesCount = var_cas_variablesMap.reader_count (_inLexique SOURCE_FILE_AT_LINE (534)) ;
  _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__29) ;
  if (((var_cas_inputVariablesCountFromDefinition) != (var_cas_inputVariablesCount)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "This declaration names ")) + (var_cas_inputVariablesCount.reader_string (_inLexique SOURCE_FILE_AT_LINE (538))))) + (GGS_string (true, " input variable(s), but machine definition names ")))) + (var_cas_inputVariablesCountFromDefinition.reader_string (_inLexique SOURCE_FILE_AT_LINE (539))))) + (GGS_string (true, " input variable(s)"))) SOURCE_FILE_AT_LINE (540)) ;
  }
  _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__28) ;
    ...
    case 2 : {
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            _inLexique.acceptTerminal (sara_scanner::sara_scanner_1_identifier) ;
            var_cas_outputVarName.defineAttributeFromScanner (_inLexique.identifierString, _inLexique) ;
            var_cas_variablesMap.modifier_insertKey (_inLexique, var_cas_outputVarName SOURCE_FILE_AT_LINE (548)) ;
  ...
  _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__29) ;
  GGS_uint  var_cas_inputAndInternalVariablesCount ;
  var_cas_inputAndInternalVariablesCount = var_cas_variablesMap.reader_count (_inLexique SOURCE_FILE_AT_LINE (555)) ;
  if (((var_cas_inputAndInternalVariablesCountFromDefinition) != (var_cas_inputAndInternalVariablesCount)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "This declaration names ")) + (var_cas_inputAndInternalVariablesCount.reader_string (_inLexique SOURCE_FILE_AT_LINE (557))))) + (GGS_string (true, " input and internal variable(s), but machine definition names ")))) + (var_cas_inputAndInternalVariablesCountFromDefinition.reader_string (_inLexique SOURCE_FILE_AT_LINE (558))))) + (GGS_string (true, " input and internal variable(s)"))) SOURCE_FILE_AT_LINE (559)) ;
  }
  _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__28) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        _inLexique.acceptTerminal (sara_scanner::sara_scanner_1_identifier) ;
        var_cas_outputVarName.defineAttributeFromScanner (_inLexique.identifierString, _inLexique) ;
        var_cas_variablesMap.modifier_insertKey (_inLexique, var_cas_outputVarName SOURCE_FILE_AT_LINE (565)) ;
  ...
  var_cas_outputVariablesCount = var_cas_variablesMap.reader_count (_inLexique SOURCE_FILE_AT_LINE (571)) ;
  GGS_uint  var_cas_outputVariablesCountFromDefinition ;
  var_cas_outputVariablesCountFromDefinition = var_cas_variablesMapFromDefinition.reader_count (_inLexique SOURCE_FILE_AT_LINE (572)) ;
  if (((var_cas_outputVariablesCountFromDefinition) != (var_cas_outputVariablesCount)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "This declaration names ")) + (var_cas_outputVariablesCount.reader_string (_inLexique SOURCE_FILE_AT_LINE (574))))) + (GGS_string (true, " variables, but machine definition names ")))) + (var_cas_outputVariablesCountFromDefinition.reader_string (_inLexique SOURCE_FILE_AT_LINE (575))))) + (GGS_string (true, " variables"))) SOURCE_FILE_AT_LINE (576)) ;
  }
          ...
          while (syntaxRepeat) {
              ...
              { bool syntaxRepeat = true ;
                while (syntaxRepeat) {
                    ...
                    if (((var_cas_v.reader_uint (_inLexique SOURCE_FILE_AT_LINE (589))) > (GGS_uint (true, 1U))).isBuiltAndTrue ()) {
                      var_cas_v.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this value is not a  binary digit") SOURCE_FILE_AT_LINE (591)) ;
                    }
              ...
              if (((var_cas_inputVariablesCount) != (var_cas_inputConfigurationForScenario.reader_length (_inLexique SOURCE_FILE_AT_LINE (596)))).isBuiltAndTrue ()) {
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((GGS_string (true, "this input configuration names ")) + (var_cas_inputConfigurationForScenario.reader_length (_inLexique SOURCE_FILE_AT_LINE (597)).reader_string (_inLexique SOURCE_FILE_AT_LINE (597))))) + (GGS_string (true, " input variable(s), instead of ")))) + (var_cas_inputVariablesCount.reader_string (_inLexique SOURCE_FILE_AT_LINE (597)))) SOURCE_FILE_AT_LINE (598)) ;
              }
...
void sara_parser::
sara_parser::
pr_io_bool_expression_sara_parser_614_26_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
...
void sara_parser::
sara_parser::
pr_io_and_expression_sara_parser_646_25_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
                                GGS_M_variablesMap  &var_cas_ioVarMap,
                                GGS_AC_boolExpression  &var_cas_outExpression) {
...
void sara_parser::
sara_parser::
pr_io_primary_sara_parser_663_18_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
                                GGS_M_variablesMap  &var_cas_ioVarMap,
                                GGS_AC_boolExpression  &var_cas_outExpression) {
  _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__28) ;
...
void sara_parser::
sara_parser::
pr_io_primary_sara_parser_675_18_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &/* var_cas_ioMachinesMap */,
                                GGS_M_variablesMap  &var_cas_ioVarMap,
                                GGS_AC_boolExpression  &var_cas_outExpression) {
  GGS_lstring  var_cas_inputVarName ;
  ...
  if (var_cas_ioVarMap._isBuilt ()) {
    var_cas_ioVarMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_inputVarName, var_cas_inputVarIndex SOURCE_FILE_AT_LINE (683)) ;
  }
...
void sara_parser::
sara_parser::
pr_io_primary_sara_parser_689_18_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
                                GGS_M_variablesMap  &var_cas_ioVarMap,
                                GGS_AC_boolExpression  &var_cas_outExpression) {
...
void sara_parser::
sara_parser::
pr_io_primary_sara_parser_702_18_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &/* var_cas_ioMachinesMap */,
                                GGS_M_variablesMap  &/* var_cas_ioVarMap */,
                                GGS_AC_boolExpression  &var_cas_outExpression) {
...
void sara_parser::
sara_parser::
pr_io_primary_sara_parser_713_18_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &/* var_cas_ioMachinesMap */,
                                GGS_M_variablesMap  &/* var_cas_ioVarMap */,
                                GGS_AC_boolExpression  &var_cas_outExpression) {
...
void sara_parser::
sara_parser::
pr_io_primary_sara_parser_724_18_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
                                GGS_M_variablesMap  &var_cas_ioVarMap,
                                GGS_AC_boolExpression  &var_cas_outExpression) {
  ...
  if (var_cas_ioMachinesMap._isBuilt ()) {
    var_cas_ioMachinesMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_machineIdentifier, var_cas_indexOfImportedMachine, var_cas_machineInputVariableCount, var_cas_machineInputAndInternalVariableCount, var_cas_machineVariablesMap SOURCE_FILE_AT_LINE (735)) ;
  }
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        GGS_luint  var_cas_inputVarIndex ;
        if (var_cas_ioVarMap._isBuilt ()) {
          var_cas_ioVarMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_inputVar, var_cas_inputVarIndex SOURCE_FILE_AT_LINE (743)) ;
        }
  ...
  _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__29) ;
  GGS_uint  var_cas_inputVariablesCount ;
  var_cas_inputVariablesCount = var_cas_translationVector.reader_length (_inLexique SOURCE_FILE_AT_LINE (749)) ;
  if (((var_cas_inputVariablesCount) != (var_cas_machineInputVariableCount)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((((((GGS_string (true, "The '$")) + (var_cas_machineIdentifier))) + (GGS_string (true, "' machine defines ")))) + (var_cas_machineInputVariableCount.reader_string (_inLexique SOURCE_FILE_AT_LINE (751))))) + (GGS_string (true, " input variable(s), but this operand defines ")))) + (var_cas_inputVariablesCount.reader_string (_inLexique SOURCE_FILE_AT_LINE (752))))) + (GGS_string (true, " input variable(s)"))) SOURCE_FILE_AT_LINE (753)) ;
  }
  _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__28) ;
    ...
    case 2 : {
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            if (var_cas_ioVarMap._isBuilt ()) {
              var_cas_ioVarMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_internalVar, var_cas_internalVarIndex SOURCE_FILE_AT_LINE (762)) ;
            }
  ...
  _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__29) ;
  GGS_uint  var_cas_inputAndInternalVariablesCount ;
  var_cas_inputAndInternalVariablesCount = var_cas_translationVector.reader_length (_inLexique SOURCE_FILE_AT_LINE (769)) ;
  if (((var_cas_inputAndInternalVariablesCount) != (var_cas_machineInputAndInternalVariableCount)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((((((GGS_string (true, "The '$")) + (var_cas_machineIdentifier.reader_string (_inLexique SOURCE_FILE_AT_LINE (771))))) + (GGS_string (true, "' machine defines ")))) + (var_cas_machineInputAndInternalVariableCount.reader_string (_inLexique SOURCE_FILE_AT_LINE (771))))) + (GGS_string (true, " input and internal variable(s), but this operand defines ")))) + (var_cas_inputAndInternalVariablesCount.reader_string (_inLexique SOURCE_FILE_AT_LINE (772))))) + (GGS_string (true, " input and internal variable(s)"))) SOURCE_FILE_AT_LINE (773)) ;
  }
  _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__28) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        if (var_cas_ioVarMap._isBuilt ()) {
          var_cas_ioVarMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_outputVar, var_cas_outputVarIndex SOURCE_FILE_AT_LINE (780)) ;
        }
  ...
  var_cas_allVariablesCount = var_cas_translationVector.reader_length (_inLexique SOURCE_FILE_AT_LINE (786)) ;
  GGS_uint  var_cas_machineAllVariablesCount ;
  var_cas_machineAllVariablesCount = var_cas_machineVariablesMap.reader_count (_inLexique SOURCE_FILE_AT_LINE (787)) ;
  if (((var_cas_allVariablesCount) != (var_cas_machineAllVariablesCount)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((((((GGS_string (true, "The '$")) + (var_cas_machineIdentifier.reader_string (_inLexique SOURCE_FILE_AT_LINE (789))))) + (GGS_string (true, "' machine defines ")))) + (var_cas_machineAllVariablesCount.reader_string (_inLexique SOURCE_FILE_AT_LINE (789))))) + (GGS_string (true, " variables, but this operand defines ")))) + (var_cas_allVariablesCount.reader_string (_inLexique SOURCE_FILE_AT_LINE (790))))) + (GGS_string (true, " variables"))) SOURCE_FILE_AT_LINE (791)) ;
  }
  var_cas_outExpression = GGS_C_importBoolMachine::constructor_new (_inLexique, var_cas_indexOfImportedMachine.reader_uint (_inLexique SOURCE_FILE_AT_LINE (793)), var_cas_machineIdentifier.reader_location (_inLexique SOURCE_FILE_AT_LINE (794)), var_cas_translationVector COMMA_HERE) ;
}
...
void sara_parser::
sara_parser::
pr_definition_expression_sara_parser_803_29_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
                                GGS_M_variablesMap  &var_cas_variablesMap,
...
void sara_parser::
sara_parser::
pr_definition_expression_term_sara_parser_821_34_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
                                GGS_M_variablesMap  &var_cas_variablesMap,
                                GGS_AC_machineDefinition  &var_cas_outDefinition) {
...
void sara_parser::
sara_parser::
pr_modalcompadd_definition_sara_parser_853_31_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
                                GGS_M_variablesMap  &var_cas_variablesMap,
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        var_cas_outModeMap.modifier_insertKey (_inLexique, var_cas_modeName, var_cas_def SOURCE_FILE_AT_LINE (867)) ;
        _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__3B) ;
      ...
      switch (select_repeat_sara_parser_29 (_inLexique)) {
        case 2 : {
          ...
          if (var_cas_outModeMap._isBuilt ()) {
            var_cas_outModeMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_sourceModeName, var_cas_sourceModeIndex, automatic_var_12 SOURCE_FILE_AT_LINE (877)) ;
          }
          ...
          if (var_cas_outModeMap._isBuilt ()) {
            var_cas_outModeMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_targetModeName, var_cas_targetModeIndex, automatic_var_13 SOURCE_FILE_AT_LINE (882)) ;
          }
          _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__3B) ;
          if (((var_cas_sourceModeIndex.reader_uint (_inLexique SOURCE_FILE_AT_LINE (884))) == (var_cas_targetModeIndex.reader_uint (_inLexique SOURCE_FILE_AT_LINE (884)))).isBuiltAndTrue ()) {
            var_cas_targetModeIndex.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "unuseful include: 'modalcompadd' operator never adds transitions from terminal states to initial states of the same mode") SOURCE_FILE_AT_LINE (885)) ;
          }else{
...
void sara_parser::
sara_parser::
pr_modalcompsub_definition_sara_parser_894_31_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
                                GGS_M_variablesMap  &var_cas_variablesMap,
                                GGS_M_modesMap  &var_cas_outModeMap,
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        GGS_AC_machineDefinition  var_cas_def ;
        nt_definition_expression_ (_inLexique, var_cas_ioMachinesMap, var_cas_variablesMap, var_cas_def) ;
        var_cas_outModeMap.modifier_insertKey (_inLexique, var_cas_modeName, var_cas_def SOURCE_FILE_AT_LINE (908)) ;
        _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__3B) ;
    ...
    while (syntaxRepeat) {
      switch (select_repeat_sara_parser_31 (_inLexique)) {
        case 2 : {
          ...
          if (var_cas_outModeMap._isBuilt ()) {
            var_cas_outModeMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_sourceModeName, var_cas_sourceModeIndex, automatic_var_14 SOURCE_FILE_AT_LINE (918)) ;
          }
          _inLexique.acceptTerminal (sara_scanner::sara_scanner_1_to) ;
          GGS_lstring  var_cas_targetModeName ;
          _inLexique.acceptTerminal (sara_scanner::sara_scanner_1_identifier) ;
          ...
          if (var_cas_outModeMap._isBuilt ()) {
            var_cas_outModeMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_targetModeName, var_cas_targetModeIndex, automatic_var_15 SOURCE_FILE_AT_LINE (923)) ;
          }
          _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__3B) ;
          if (((var_cas_sourceModeIndex.reader_uint (_inLexique SOURCE_FILE_AT_LINE (925))) == (var_cas_targetModeIndex.reader_uint (_inLexique SOURCE_FILE_AT_LINE (925)))).isBuiltAndTrue ()) {
            var_cas_targetModeIndex.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "unuseful include: 'modalcompadd' operator never adds transitions from terminal states to initial states of the same mode") SOURCE_FILE_AT_LINE (926)) ;
          }else{
...
void sara_parser::
sara_parser::
pr_definition_expression_factor_sara_parser_935_36_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
                                GGS_M_variablesMap  &var_cas_variablesMap,
                                GGS_AC_machineDefinition  &var_cas_outDefinition) {
  switch (select_sara_parser_32 (_inLexique)) {
    ...
    case 3 : {
      ...
      var_cas_previousVariableCount = var_cas_extendedVariablesMap.reader_count (_inLexique SOURCE_FILE_AT_LINE (948)) ;
      ...
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            var_cas_extendedVariablesMap.modifier_insertKey (_inLexique, var_cas_variableName SOURCE_FILE_AT_LINE (953)) ;
      ...
      var_cas_actualVariableCount = var_cas_extendedVariablesMap.reader_count (_inLexique SOURCE_FILE_AT_LINE (957)) ;
      _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__28) ;
      GGS_AC_machineDefinition  var_cas_def ;
    ...
    case 4 : {
      ...
      var_cas_extendedVariablesMap = var_cas_variablesMap ;
      GGS_uint  var_cas_previousVariableCount ;
      var_cas_previousVariableCount = var_cas_extendedVariablesMap.reader_count (_inLexique SOURCE_FILE_AT_LINE (965)) ;
      ...
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            _inLexique.acceptTerminal (sara_scanner::sara_scanner_1_identifier) ;
            var_cas_variableName.defineAttributeFromScanner (_inLexique.identifierString, _inLexique) ;
            var_cas_extendedVariablesMap.modifier_insertKey (_inLexique, var_cas_variableName SOURCE_FILE_AT_LINE (970)) ;
      ...
      GGS_uint  var_cas_actualVariableCount ;
      var_cas_actualVariableCount = var_cas_extendedVariablesMap.reader_count (_inLexique SOURCE_FILE_AT_LINE (974)) ;
      _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__28) ;
      GGS_AC_machineDefinition  var_cas_def ;
      nt_definition_expression_ (_inLexique, var_cas_ioMachinesMap, var_cas_extendedVariablesMap, var_cas_def) ;
      _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__29) ;
...
void sara_parser::
sara_parser::
pr_definition_expression_factor_sara_parser_1052_36_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
                                GGS_M_variablesMap  &var_cas_ioVarMap,
                                GGS_AC_machineDefinition  &var_cas_outDefinition) {
  GGS_lstring  var_cas_machineIdentifier ;
  ...
  GGS_luint  var_cas_indexOfImportedMachine ;
  if (var_cas_ioMachinesMap._isBuilt ()) {
    var_cas_ioMachinesMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_machineIdentifier, var_cas_indexOfImportedMachine, var_cas_machineInputVariableCount, var_cas_machineInputAndInternalVariableCount, var_cas_machineVariablesMap SOURCE_FILE_AT_LINE (1063)) ;
  }
  GGS_L_translationVector  var_cas_translationVector ;
  var_cas_translationVector = GGS_L_translationVector::constructor_emptyList (_inLexique COMMA_HERE) ;
  _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__28) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        GGS_luint  var_cas_inputVarIndex ;
        if (var_cas_ioVarMap._isBuilt ()) {
          var_cas_ioVarMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_inputVar, var_cas_inputVarIndex SOURCE_FILE_AT_LINE (1071)) ;
        }
        var_cas_translationVector._addAssign_operation (var_cas_inputVarIndex) ;
  ...
  _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__29) ;
  GGS_uint  var_cas_inputVariablesCount ;
  var_cas_inputVariablesCount = var_cas_translationVector.reader_length (_inLexique SOURCE_FILE_AT_LINE (1077)) ;
  if (((var_cas_inputVariablesCount) != (var_cas_machineInputVariableCount)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((((((GGS_string (true, "The '$")) + (var_cas_machineIdentifier.reader_string (_inLexique SOURCE_FILE_AT_LINE (1079))))) + (GGS_string (true, "' machine defines ")))) + (var_cas_machineInputVariableCount.reader_string (_inLexique SOURCE_FILE_AT_LINE (1079))))) + (GGS_string (true, " input variable(s), but this operand defines ")))) + (var_cas_inputVariablesCount.reader_string (_inLexique SOURCE_FILE_AT_LINE (1080))))) + (GGS_string (true, " input variable(s)"))) SOURCE_FILE_AT_LINE (1081)) ;
  }
  _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__28) ;
    ...
    case 2 : {
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            GGS_luint  var_cas_internalVarIndex ;
            if (var_cas_ioVarMap._isBuilt ()) {
              var_cas_ioVarMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_internalVar, var_cas_internalVarIndex SOURCE_FILE_AT_LINE (1090)) ;
            }
            var_cas_translationVector._addAssign_operation (var_cas_internalVarIndex) ;
  ...
  _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__29) ;
  GGS_uint  var_cas_inputAndInternalVariablesCount ;
  var_cas_inputAndInternalVariablesCount = var_cas_translationVector.reader_length (_inLexique SOURCE_FILE_AT_LINE (1097)) ;
  if (((var_cas_inputAndInternalVariablesCount) != (var_cas_machineInputAndInternalVariableCount)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((((((GGS_string (true, "The '$")) + (var_cas_machineIdentifier.reader_string (_inLexique SOURCE_FILE_AT_LINE (1099))))) + (GGS_string (true, "' machine defines ")))) + (var_cas_machineInputAndInternalVariableCount.reader_string (_inLexique SOURCE_FILE_AT_LINE (1099))))) + (GGS_string (true, " input and internal variable(s), but this operand defines ")))) + (var_cas_inputAndInternalVariablesCount.reader_string (_inLexique SOURCE_FILE_AT_LINE (1100))))) + (GGS_string (true, " input and internal variable(s)"))) SOURCE_FILE_AT_LINE (1101)) ;
  }
  _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__28) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        GGS_luint  var_cas_outputVarIndex ;
        if (var_cas_ioVarMap._isBuilt ()) {
          var_cas_ioVarMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_outputVar, var_cas_outputVarIndex SOURCE_FILE_AT_LINE (1108)) ;
        }
        var_cas_translationVector._addAssign_operation (var_cas_outputVarIndex) ;
  ...
  _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__29) ;
  GGS_uint  var_cas_allVariablesCount ;
  var_cas_allVariablesCount = var_cas_translationVector.reader_length (_inLexique SOURCE_FILE_AT_LINE (1114)) ;
  GGS_uint  var_cas_machineAllVariablesCount ;
  var_cas_machineAllVariablesCount = var_cas_machineVariablesMap.reader_count (_inLexique SOURCE_FILE_AT_LINE (1115)) ;
  if (((var_cas_allVariablesCount) != (var_cas_machineAllVariablesCount)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((((((GGS_string (true, "The '$")) + (var_cas_machineIdentifier.reader_string (_inLexique SOURCE_FILE_AT_LINE (1117))))) + (GGS_string (true, "' machine defines ")))) + (var_cas_machineAllVariablesCount.reader_string (_inLexique SOURCE_FILE_AT_LINE (1117))))) + (GGS_string (true, " variables, but this operand defines ")))) + (var_cas_allVariablesCount.reader_string (_inLexique SOURCE_FILE_AT_LINE (1118))))) + (GGS_string (true, " variables"))) SOURCE_FILE_AT_LINE (1119)) ;
  }
  var_cas_outDefinition = GGS_C_importMachine::constructor_new (_inLexique, var_cas_indexOfImportedMachine.reader_uint (_inLexique SOURCE_FILE_AT_LINE (1120)), var_cas_translationVector COMMA_HERE) ;
}
...
void sara_parser::
sara_parser::
pr_explicit_automaton_sara_parser_1127_26_ (sara_scanner & _inLexique,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
                                GGS_M_variablesMap  &var_cas_variablesMap,
                                GGS_AC_machineDefinition  &var_cas_outDefinition) {
  GGS_M_stateMap  var_cas_statesMap ;
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        var_cas_statesMap.modifier_insertKey (_inLexique, var_cas_stateName SOURCE_FILE_AT_LINE (1141)) ;
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        if (var_cas_statesMap._isBuilt ()) {
          var_cas_statesMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_initialState, var_cas_initialStateIndex SOURCE_FILE_AT_LINE (1153)) ;
        }
    ...
    case 2 : {
      ...
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            if (var_cas_statesMap._isBuilt ()) {
              var_cas_statesMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_terminalState, var_cas_terminalStateIndex SOURCE_FILE_AT_LINE (1168)) ;
            }
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        if (var_cas_statesMap._isBuilt ()) {
          var_cas_statesMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_stateName, var_cas_stateIndex SOURCE_FILE_AT_LINE (1182)) ;
        }
        var_cas_stateDefinitionMap.modifier_defineState (_inLexique, var_cas_stateName SOURCE_FILE_AT_LINE (1183)) ;
        _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__3A) ;
          ...
          while (syntaxRepeat) {
            switch (select_repeat_sara_parser_44 (_inLexique)) {
              case 2 : {
                ...
                if (var_cas_statesMap._isBuilt ()) {
                  var_cas_statesMap (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_targetStateName, var_cas_targetStateIndex SOURCE_FILE_AT_LINE (1201)) ;
                }
  ...
  GGS_M_stateMap::element_type * operand_37290 = var_cas_statesMap.firstObject () ;
  while ((operand_37290 != NULL)) {
    macroValidPointer (operand_37290) ;
    if (((! (var_cas_stateDefinitionMap.reader_hasKey (_inLexique, operand_37290->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1212)) SOURCE_FILE_AT_LINE (1212))))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "'")) + (operand_37290->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1213))))) + (GGS_string (true, "' state is not described"))) SOURCE_FILE_AT_LINE (1214)) ;
    }
    operand_37290 = operand_37290->nextObject () ;
  }
  _inLexique.acceptTerminal (sara_scanner::sara_scanner_1__7D) ;
