...
void sara_parser::
pr_start_symbol_sara_parser_203_20_ (sara_scanner & lexique_var_) {
...
void sara_parser::
pr_component_sara_parser_215_17_ (sara_scanner & lexique_var_,
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        var_cas_initialStatesDefinitionList.addAssign_operation (var_cas_initialStateIndex) ;
  ...
  GGS_M_stateMap::element_type * operand_9675 = var_cas_statesMap.getFirstItem () ;
  while (operand_9675 != NULL) {
    macroValidPointer (operand_9675) ;
    if (((! var_cas_stateDefinitionMap.reader_hasKey (operand_9675->mKey))).isBuiltAndTrue ()) {
        GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "'")) + (operand_9675->mKey.reader_value ()))) + (GGS_string (true, "' state is not described")))) ;
    }
    operand_9675 = operand_9675->getNextItem () ;
  }
  lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1__7D) ;
...
void sara_parser::
pr_input_expression_sara_parser_326_24_ (sara_scanner & lexique_var_,
...
void sara_parser::
pr_input_and_expression_sara_parser_342_28_ (sara_scanner & lexique_var_,
                                GGS_M_inputOutputVarMap  &var_cas_ioInputVarMap,
                                GGS_AC_expression  &var_cas_outExpression) {
...
void sara_parser::
pr_input_primary_sara_parser_358_21_ (sara_scanner & lexique_var_,
                                GGS_M_inputOutputVarMap  &var_cas_ioInputVarMap,
                                GGS_AC_expression  &var_cas_outExpression) {
...
void sara_parser::
pr_input_primary_sara_parser_369_21_ (sara_scanner & lexique_var_,
                                GGS_M_inputOutputVarMap  &var_cas_ioInputVarMap,
                                GGS_AC_expression  &var_cas_outExpression) {
  GGS_lstring  var_cas_inputVarName ;
  lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1_identifier) ;
...
void sara_parser::
pr_input_primary_sara_parser_382_21_ (sara_scanner & lexique_var_,
                                GGS_M_inputOutputVarMap  &var_cas_ioInputVarMap,
                                GGS_AC_expression  &var_cas_outExpression) {
...
void sara_parser::
pr_input_primary_sara_parser_394_21_ (sara_scanner & lexique_var_,
                                GGS_M_inputOutputVarMap  &/* var_cas_ioInputVarMap */,
                                GGS_AC_expression  &var_cas_outExpression) {
...
void sara_parser::
pr_input_primary_sara_parser_404_21_ (sara_scanner & lexique_var_,
                                GGS_M_inputOutputVarMap  &/* var_cas_ioInputVarMap */,
                                GGS_AC_expression  &var_cas_outExpression) {
