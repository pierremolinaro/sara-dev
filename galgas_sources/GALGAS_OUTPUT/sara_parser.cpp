...
pr_component_sara_parser_87_16_ (sara_scanner & inLexique,
  ...
  const GGS_M_machinesMap  temp_2896 = var_cas_ioSemanticContext.reader_machinesMap (inLexique COMMA_SOURCE_FILE_AT_LINE (100)) ;
  if (temp_2896.isBuilt ()) {
    temp_2896 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_machineName, var_cas_machineIndex, automatic_var_0, automatic_var_1, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (100)) ;
  }
...
pr_component_sara_parser_108_16_ (sara_scanner & inLexique,
  ...
  const GGS_M_machinesMap  temp_3643 = var_cas_ioSemanticContext.reader_machinesMap (inLexique COMMA_SOURCE_FILE_AT_LINE (124)) ;
  if (temp_3643.isBuilt ()) {
    temp_3643 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_machineName1, var_cas_machineIndex1, automatic_var_3, automatic_var_4, automatic_var_5 COMMA_SOURCE_FILE_AT_LINE (124)) ;
  }
  GGS_luint  var_cas_machineIndex2 ;
  GGS_uint  automatic_var_6 ;
  GGS_uint  automatic_var_7 ;
  GGS_M_variablesMap  automatic_var_8 ;
  const GGS_M_machinesMap  temp_3799 = var_cas_ioSemanticContext.reader_machinesMap (inLexique COMMA_SOURCE_FILE_AT_LINE (127)) ;
  if (temp_3799.isBuilt ()) {
    temp_3799 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_machineName2, var_cas_machineIndex2, automatic_var_6, automatic_var_7, automatic_var_8 COMMA_SOURCE_FILE_AT_LINE (127)) ;
  }
  GGS_AC_job  var_cas_job ;
...
pr_component_sara_parser_135_16_ (sara_scanner & inLexique,
  ...
  const GGS_M_machinesMap  temp_4492 = var_cas_ioSemanticContext.reader_machinesMap (inLexique COMMA_SOURCE_FILE_AT_LINE (148)) ;
  if (temp_4492.isBuilt ()) {
    temp_4492 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_machineName, var_cas_machineIndex, automatic_var_9, automatic_var_10, automatic_var_11 COMMA_SOURCE_FILE_AT_LINE (148)) ;
  }
  GGS_AC_job  var_cas_job ;
...
pr_component_sara_parser_443_16_ (sara_scanner & inLexique,
  ...
  const GGS_M_machinesMap  temp_12634 = var_cas_ioSemanticContext.reader_machinesMap (inLexique COMMA_SOURCE_FILE_AT_LINE (458)) ;
  if (temp_12634.isBuilt ()) {
    temp_12634 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_machineName, var_cas_machineIndex, var_cas_inputVariablesCountFromDefinition, var_cas_inputAndInternalVariablesCountFromDefinition, var_cas_variablesMapFromDefinition COMMA_SOURCE_FILE_AT_LINE (458)) ;
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__28_) COMMA_HERE) ;
...
pr_io_primary_sara_parser_609_17_ (sara_scanner & inLexique,
  ...
  const GGS_M_variablesMap  temp_18233 = var_cas_ioVarMap ;
  if (temp_18233.isBuilt ()) {
    temp_18233 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_inputVarName, var_cas_inputVarIndex COMMA_SOURCE_FILE_AT_LINE (617)) ;
  }
...
pr_io_primary_sara_parser_658_17_ (sara_scanner & inLexique,
  ...
  const GGS_M_machinesMap  temp_19772 = var_cas_inSemanticContext.reader_machinesMap (inLexique COMMA_SOURCE_FILE_AT_LINE (669)) ;
  if (temp_19772.isBuilt ()) {
    temp_19772 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_machineIdentifier, var_cas_indexOfImportedMachine, var_cas_machineInputVariableCount, var_cas_machineInputAndInternalVariableCount, var_cas_machineVariablesMap COMMA_SOURCE_FILE_AT_LINE (669)) ;
  }
  ...
  { bool syntaxRepeat_22 = true ;
    while (syntaxRepeat_22) {
        ...
        inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
        GGS_luint  var_cas_inputVarIndex ;
        const GGS_M_variablesMap  temp_20116 = var_cas_ioVarMap ;
        if (temp_20116.isBuilt ()) {
          temp_20116 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_inputVar, var_cas_inputVarIndex COMMA_SOURCE_FILE_AT_LINE (677)) ;
        }
    ...
    case 2 : {
      { bool syntaxRepeat_24 = true ;
        while (syntaxRepeat_24) {
            ...
            const GGS_M_variablesMap  temp_20766 = var_cas_ioVarMap ;
            if (temp_20766.isBuilt ()) {
              temp_20766 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_internalVar, var_cas_internalVarIndex COMMA_SOURCE_FILE_AT_LINE (696)) ;
            }
  ...
  { bool syntaxRepeat_25 = true ;
    while (syntaxRepeat_25) {
        ...
        const GGS_M_variablesMap  temp_21507 = var_cas_ioVarMap ;
        if (temp_21507.isBuilt ()) {
          temp_21507 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_outputVar, var_cas_outputVarIndex COMMA_SOURCE_FILE_AT_LINE (714)) ;
        }
    ...
    while (syntaxRepeat_29) {
      switch (select_repeat_sara_parser_29 (inLexique)) {
        case 2 : {
          ...
          const GGS_M_modesMap  temp_24992 = var_cas_outModeMap ;
          if (temp_24992.isBuilt ()) {
            temp_24992 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_sourceModeName, var_cas_sourceModeIndex, automatic_var_12 COMMA_SOURCE_FILE_AT_LINE (811)) ;
          }
          ...
          const GGS_M_modesMap  temp_25171 = var_cas_outModeMap ;
          if (temp_25171.isBuilt ()) {
            temp_25171 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_targetModeName, var_cas_targetModeIndex, automatic_var_13 COMMA_SOURCE_FILE_AT_LINE (816)) ;
          }
          inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__3B_) COMMA_HERE) ;
    ...
    while (syntaxRepeat_31) {
      switch (select_repeat_sara_parser_31 (inLexique)) {
        case 2 : {
          ...
          const GGS_M_modesMap  temp_26299 = var_cas_outModeMap ;
          if (temp_26299.isBuilt ()) {
            temp_26299 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_sourceModeName, var_cas_sourceModeIndex, automatic_var_14 COMMA_SOURCE_FILE_AT_LINE (852)) ;
          }
          inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_to) COMMA_HERE) ;
          GGS_lstring  var_cas_targetModeName ;
          inLexique.assignFromAttribute_identifierString (var_cas_targetModeName) ;
          ...
          const GGS_M_modesMap  temp_26478 = var_cas_outModeMap ;
          if (temp_26478.isBuilt ()) {
            temp_26478 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_targetModeName, var_cas_targetModeIndex, automatic_var_15 COMMA_SOURCE_FILE_AT_LINE (857)) ;
          }
          inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__3B_) COMMA_HERE) ;
...
pr_definition_expression_factor_sara_parser_986_35_ (sara_scanner & inLexique,
  ...
  GGS_M_variablesMap  var_cas_machineVariablesMap ;
  GGS_luint  var_cas_indexOfImportedMachine ;
  const GGS_M_machinesMap  temp_30992 = var_cas_inSemanticContext.reader_machinesMap (inLexique COMMA_SOURCE_FILE_AT_LINE (997)) ;
  if (temp_30992.isBuilt ()) {
    temp_30992 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_machineIdentifier, var_cas_indexOfImportedMachine, var_cas_machineInputVariableCount, var_cas_machineInputAndInternalVariableCount, var_cas_machineVariablesMap COMMA_SOURCE_FILE_AT_LINE (997)) ;
  }
  GGS_L_translationVector  var_cas_translationVector ;
  var_cas_translationVector = GGS_L_translationVector ::constructor_emptyList () ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__28_) COMMA_HERE) ;
  { bool syntaxRepeat_35 = true ;
    while (syntaxRepeat_35) {
        ...
        inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
        GGS_luint  var_cas_inputVarIndex ;
        const GGS_M_variablesMap  temp_31336 = var_cas_ioVarMap ;
        if (temp_31336.isBuilt ()) {
          temp_31336 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_inputVar, var_cas_inputVarIndex COMMA_SOURCE_FILE_AT_LINE (1005)) ;
        }
        var_cas_translationVector._addAssign_operation (var_cas_inputVarIndex) ;
    ...
    case 2 : {
      { bool syntaxRepeat_37 = true ;
        while (syntaxRepeat_37) {
            ...
            inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
            GGS_luint  var_cas_internalVarIndex ;
            const GGS_M_variablesMap  temp_31995 = var_cas_ioVarMap ;
            if (temp_31995.isBuilt ()) {
              temp_31995 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_internalVar, var_cas_internalVarIndex COMMA_SOURCE_FILE_AT_LINE (1024)) ;
            }
            var_cas_translationVector._addAssign_operation (var_cas_internalVarIndex) ;
  ...
  { bool syntaxRepeat_38 = true ;
    while (syntaxRepeat_38) {
        ...
        inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
        GGS_luint  var_cas_outputVarIndex ;
        const GGS_M_variablesMap  temp_32736 = var_cas_ioVarMap ;
        if (temp_32736.isBuilt ()) {
          temp_32736 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_outputVar, var_cas_outputVarIndex COMMA_SOURCE_FILE_AT_LINE (1042)) ;
        }
        var_cas_translationVector._addAssign_operation (var_cas_outputVarIndex) ;
...
pr_explicit_automaton_sara_parser_1061_25_ (sara_scanner & inLexique,
  ...
  { bool syntaxRepeat_40 = true ;
    while (syntaxRepeat_40) {
        ...
        const GGS_M_stateMap  temp_34256 = var_cas_statesMap ;
        if (temp_34256.isBuilt ()) {
          temp_34256 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_initialState, var_cas_initialStateIndex COMMA_SOURCE_FILE_AT_LINE (1087)) ;
        }
    ...
    case 2 : {
      ...
      { bool syntaxRepeat_42 = true ;
        while (syntaxRepeat_42) {
            ...
            const GGS_M_stateMap  temp_34660 = var_cas_statesMap ;
            if (temp_34660.isBuilt ()) {
              temp_34660 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_terminalState, var_cas_terminalStateIndex COMMA_SOURCE_FILE_AT_LINE (1102)) ;
            }
  ...
  { bool syntaxRepeat_43 = true ;
    while (syntaxRepeat_43) {
        ...
        const GGS_M_stateMap  temp_35047 = var_cas_statesMap ;
        if (temp_35047.isBuilt ()) {
          temp_35047 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_stateName, var_cas_stateIndex COMMA_SOURCE_FILE_AT_LINE (1116)) ;
        }
          ...
          while (syntaxRepeat_44) {
            switch (select_repeat_sara_parser_44 (inLexique)) {
              case 2 : {
                ...
                const GGS_M_stateMap  temp_35787 = var_cas_statesMap ;
                if (temp_35787.isBuilt ()) {
                  temp_35787 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_targetStateName, var_cas_targetStateIndex COMMA_SOURCE_FILE_AT_LINE (1135)) ;
                }
