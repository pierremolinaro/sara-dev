...
void sara_parser::
pr_definition_expression_factor_sara_parser_1001_36_ (sara_scanner & lexique_var_,
                                GGS_M_machinesMap  &var_cas_ioMachinesMap,
                                GGS_M_variablesMap  &var_cas_ioVarMap,
                                GGS_AC_machineDefinition  &var_cas_outDefinition) {
...
void sara_parser::
pr_explicit_automaton_sara_parser_1076_26_ (sara_scanner & lexique_var_,
                                GGS_M_variablesMap  &var_cas_variablesMap,
                                GGS_AC_machineDefinition  &var_cas_outDefinition) {
  GGS_M_stateMap  var_cas_statesMap ;
  var_cas_statesMap = GGS_M_stateMap::constructor_empty () ;
  ...
  GGS_M_stateMap::element_type * operand_35587 = var_cas_statesMap.getFirstItem () ;
  while (operand_35587 != NULL) {
    macroValidPointer (operand_35587) ;
    if (((! var_cas_stateDefinitionMap.reader_hasKey (operand_35587->mKey))).isBuiltAndTrue ()) {
        GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "'")) + (operand_35587->mKey.reader_value ()))) + (GGS_string (true, "' state is not described")))) ;
    }
    operand_35587 = operand_35587->getNextItem () ;
  }
  lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1__7D) ;
