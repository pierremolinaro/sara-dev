...
void sara_parser::
pr_start_symbol_sara_parser_289_20_ (sara_scanner & lexique_var_) {
...
void sara_parser::
pr_component_sara_parser_301_17_ (sara_scanner & lexique_var_,
...
void sara_parser::
pr_io_expression_sara_parser_342_21_ (sara_scanner & lexique_var_,
...
void sara_parser::
pr_io_and_expression_sara_parser_373_25_ (sara_scanner & lexique_var_,
                                GGS_M_variablesMap  &var_cas_ioInputVarMap,
                                GGS_AC_expression  &var_cas_outExpression) {
...
void sara_parser::
pr_io_primary_sara_parser_389_18_ (sara_scanner & lexique_var_,
                                GGS_M_variablesMap  &var_cas_ioInputVarMap,
                                GGS_AC_expression  &var_cas_outExpression) {
  lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1__28) ;
...
void sara_parser::
pr_io_primary_sara_parser_400_18_ (sara_scanner & lexique_var_,
                                GGS_M_variablesMap  &var_cas_ioInputVarMap,
                                GGS_AC_expression  &var_cas_outExpression) {
  GGS_lstring  var_cas_inputVarName ;
  lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1_identifier) ;
...
void sara_parser::
pr_io_primary_sara_parser_413_18_ (sara_scanner & lexique_var_,
                                GGS_M_variablesMap  &var_cas_ioInputVarMap,
                                GGS_AC_expression  &var_cas_outExpression) {
...
void sara_parser::
pr_io_primary_sara_parser_425_18_ (sara_scanner & lexique_var_,
                                GGS_M_variablesMap  &/* var_cas_ioInputVarMap */,
                                GGS_AC_expression  &var_cas_outExpression) {
...
void sara_parser::
pr_io_primary_sara_parser_435_18_ (sara_scanner & lexique_var_,
                                GGS_M_variablesMap  &/* var_cas_ioInputVarMap */,
                                GGS_AC_expression  &var_cas_outExpression) {
...
void sara_parser::
pr_definition_expression_sara_parser_447_29_ (sara_scanner & lexique_var_,
                                GGS_M_variablesMap  &var_cas_variablesMap,
...
void sara_parser::
pr_definition_expression_term_sara_parser_482_34_ (sara_scanner & lexique_var_,
                                GGS_M_variablesMap  &var_cas_variablesMap,
                                GGS_AC_machineDefinition  &var_cas_outDefinition) {
...
void sara_parser::
pr_definition_expression_factor_sara_parser_499_36_ (sara_scanner & lexique_var_,
                                GGS_M_variablesMap  &var_cas_variablesMap,
                                GGS_AC_machineDefinition  &var_cas_outDefinition) {
  switch (select_sara_parser_7 (lexique_var_)) {
    ...
    case 3 : {
      ...
      nt_definition_expression_ (lexique_var_, var_cas_extendedVariablesMap, var_cas_def) ;
      lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1__29) ;
...
void sara_parser::
pr_explicit_automaton_sara_parser_544_26_ (sara_scanner & lexique_var_,
                                GGS_M_variablesMap  &var_cas_variablesMap,
                                GGS_AC_machineDefinition  &var_cas_outDefinition) {
  GGS_M_stateMap  var_cas_statesMap ;
  var_cas_statesMap = GGS_M_stateMap::constructor_empty () ;
  ...
  GGS_M_stateMap::element_type * operand_18585 = var_cas_statesMap.getFirstItem () ;
  while (operand_18585 != NULL) {
    macroValidPointer (operand_18585) ;
    if (((! var_cas_stateDefinitionMap.reader_hasKey (operand_18585->mKey))).isBuiltAndTrue ()) {
        GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "'")) + (operand_18585->mKey.reader_value ()))) + (GGS_string (true, "' state is not described")))) ;
    }
    operand_18585 = operand_18585->getNextItem () ;
  }
  lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1__7D) ;
  var_cas_outDefinition = GGS_C_explicitAutomatonDefinition::constructor_new (var_cas_statesMap, var_cas_initialStatesDefinitionList, var_cas_stateDefinitionList, GGS_location (lexique_var_)) ;
}
