...
pr_component_sara_parser_509_17_ (sara_scanner & lexique_var_,
  ...
  GGS_uint  var_cas_14923 ;
  GGS_uint  var_cas_14926 ;
  GGS_M_variablesMap  var_cas_14929 ;
  var_cas_ioMachinesMap.methode_searchKeyGetIndex (lexique_var_, var_cas_machineName, var_cas_machineIndex, var_cas_14923, var_cas_14926, var_cas_14929) ;
...
pr_component_sara_parser_531_17_ (sara_scanner & lexique_var_,
  ...
  GGS_uint  var_cas_15642 ;
  GGS_uint  var_cas_15645 ;
  GGS_M_variablesMap  var_cas_15648 ;
  var_cas_ioMachinesMap.methode_searchKeyGetIndex (lexique_var_, var_cas_machineName1, var_cas_machineIndex1, var_cas_15642, var_cas_15645, var_cas_15648) ;
  GGS_luint  var_cas_machineIndex2 ;
  GGS_uint  var_cas_15782 ;
  GGS_uint  var_cas_15785 ;
  GGS_M_variablesMap  var_cas_15788 ;
  var_cas_ioMachinesMap.methode_searchKeyGetIndex (lexique_var_, var_cas_machineName2, var_cas_machineIndex2, var_cas_15782, var_cas_15785, var_cas_15788) ;
  GGS_AC_job  var_cas_job ;
...
pr_component_sara_parser_559_17_ (sara_scanner & lexique_var_,
  ...
  lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1__3B) ;
  GGS_luint  var_cas_machineIndex ;
  GGS_uint  var_cas_16443 ;
  GGS_uint  var_cas_16446 ;
  GGS_M_variablesMap  var_cas_16449 ;
  var_cas_ioMachinesMap.methode_searchKeyGetIndex (lexique_var_, var_cas_machineName, var_cas_machineIndex, var_cas_16443, var_cas_16446, var_cas_16449) ;
  GGS_AC_job  var_cas_job ;
    ...
    while (syntaxRepeat) {
      switch (select_repeat_sara_parser_29 (lexique_var_)) {
        case 2 : {
          ...
          GGS_AC_machineDefinition  var_cas_36692 ;
          var_cas_outModeMap.methode_searchKeyGetIndex (lexique_var_, var_cas_sourceModeName, var_cas_sourceModeIndex, var_cas_36692) ;
          ...
          GGS_AC_machineDefinition  var_cas_36873 ;
          var_cas_outModeMap.methode_searchKeyGetIndex (lexique_var_, var_cas_targetModeName, var_cas_targetModeIndex, var_cas_36873) ;
          lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1__3B) ;
    ...
    while (syntaxRepeat) {
      switch (select_repeat_sara_parser_31 (lexique_var_)) {
        case 2 : {
          ...
          var_cas_sourceModeName.defineAttribute (lexique_var_.identifierString, lexique_var_) ;
          GGS_luint  var_cas_sourceModeIndex ;
          GGS_AC_machineDefinition  var_cas_37989 ;
          var_cas_outModeMap.methode_searchKeyGetIndex (lexique_var_, var_cas_sourceModeName, var_cas_sourceModeIndex, var_cas_37989) ;
          lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1_to) ;
          GGS_lstring  var_cas_targetModeName ;
          lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1_identifier) ;
          var_cas_targetModeName.defineAttribute (lexique_var_.identifierString, lexique_var_) ;
          GGS_luint  var_cas_targetModeIndex ;
          GGS_AC_machineDefinition  var_cas_38170 ;
          var_cas_outModeMap.methode_searchKeyGetIndex (lexique_var_, var_cas_targetModeName, var_cas_targetModeIndex, var_cas_38170) ;
          lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1__3B) ;
          if (((var_cas_sourceModeIndex.reader_value ()) == (var_cas_targetModeIndex.reader_value ())).isBuiltAndTrue ()) {
              var_cas_targetModeIndex.reader_location ().signalGGSSemanticWarning (lexique_var_, GGS_string (true, "unuseful include: 'modalcompadd' operator never adds transitions from terminal states to initial states of the same mode")) ;
          }else{
...
pr_explicit_automaton_sara_parser_1497_26_ (sara_scanner & lexique_var_,
  ...
  GGS_M_stateMap::element_type * operand_47719 = var_cas_statesMap.firstObject () ;
  while ((operand_47719 != NULL)) {
    macroValidPointer (operand_47719) ;
    if (((! var_cas_stateDefinitionMap.reader_hasKey (operand_47719->mKey.reader_value ()))).isBuiltAndTrue ()) {
        GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "'")) + (operand_47719->mKey.reader_value ()))) + (GGS_string (true, "' state is not described")))) ;
    }
    operand_47719 = operand_47719->nextObject () ;
  }
  lexique_var_.acceptTerminal (sara_scanner::sara_scanner_1__7D) ;
