...
pr_explicit_automaton_sara_parser_1073_4_ (sara_scanner & _inLexique,
  ...
  const GGS_M_stateMap _var_35704 = var_cas_statesMap ;
  const GGS_M_stateMap::element_type * operand_35704 = _var_35704.firstObject () ;
  while ((operand_35704 != NULL)) {
    ...
    operand_35704 = operand_35704->nextObject () ;
  }
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__7D) COMMA_HERE) ;
