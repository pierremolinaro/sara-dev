...
pr_component_sara_parser_87_16_ (sara_scanner & inLexique,
  ...
  inLexique._assignFromAttribute_identifierString (var_cas_machineName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_machineIdf) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__3B) COMMA_HERE) ;
  GGS_luint  var_cas_machineIndex ;
  GGS_uint  automatic_var_0 ;
  GGS_uint  automatic_var_1 ;
  GGS_M_variablesMap  automatic_var_2 ;
  const GGS_M_machinesMap  _temp_2896 = var_cas_ioSemanticContext.reader_machinesMap (inLexique COMMA_SOURCE_FILE_AT_LINE (100)) ;
  if (_temp_2896.isBuilt ()) {
    _temp_2896 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_machineName, var_cas_machineIndex, automatic_var_0, automatic_var_1, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (100)) ;
  }
...
pr_component_sara_parser_108_16_ (sara_scanner & inLexique,
  ...
  inLexique._assignFromAttribute_identifierString (var_cas_machineName1) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_machineIdf) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__2C) COMMA_HERE) ;
  GGS_lstring  var_cas_machineName2 ;
  inLexique._assignFromAttribute_identifierString (var_cas_machineName2) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_machineIdf) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__3B) COMMA_HERE) ;
  ...
  const GGS_M_machinesMap  _temp_3643 = var_cas_ioSemanticContext.reader_machinesMap (inLexique COMMA_SOURCE_FILE_AT_LINE (124)) ;
  if (_temp_3643.isBuilt ()) {
    _temp_3643 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_machineName1, var_cas_machineIndex1, automatic_var_3, automatic_var_4, automatic_var_5 COMMA_SOURCE_FILE_AT_LINE (124)) ;
  }
  GGS_luint  var_cas_machineIndex2 ;
  GGS_uint  automatic_var_6 ;
  GGS_uint  automatic_var_7 ;
  GGS_M_variablesMap  automatic_var_8 ;
  const GGS_M_machinesMap  _temp_3799 = var_cas_ioSemanticContext.reader_machinesMap (inLexique COMMA_SOURCE_FILE_AT_LINE (127)) ;
  if (_temp_3799.isBuilt ()) {
    _temp_3799 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_machineName2, var_cas_machineIndex2, automatic_var_6, automatic_var_7, automatic_var_8 COMMA_SOURCE_FILE_AT_LINE (127)) ;
  }
  GGS_AC_job  var_cas_job ;
...
pr_component_sara_parser_135_16_ (sara_scanner & inLexique,
  ...
  const GGS_M_machinesMap  _temp_4492 = var_cas_ioSemanticContext.reader_machinesMap (inLexique COMMA_SOURCE_FILE_AT_LINE (148)) ;
  if (_temp_4492.isBuilt ()) {
    _temp_4492 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_machineName, var_cas_machineIndex, automatic_var_9, automatic_var_10, automatic_var_11 COMMA_SOURCE_FILE_AT_LINE (148)) ;
  }
  GGS_AC_job  var_cas_job ;
...
pr_component_sara_parser_156_16_ (sara_scanner & inLexique,
                                GGS_semanticContext &var_cas_ioSemanticContext) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_use_5Fand) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__3B) COMMA_HERE) ;
  GGS_AC_job  var_cas_job ;
...
pr_component_sara_parser_167_16_ (sara_scanner & inLexique,
                                GGS_semanticContext &var_cas_ioSemanticContext) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_use_5Fite) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__3B) COMMA_HERE) ;
  GGS_AC_job  var_cas_job ;
...
pr_component_sara_parser_178_16_ (sara_scanner & inLexique,
                                GGS_semanticContext &var_cas_ioSemanticContext) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_use_5Fand_5Fite) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__3B) COMMA_HERE) ;
  GGS_AC_job  var_cas_job ;
...
pr_component_sara_parser_189_16_ (sara_scanner & inLexique,
                                GGS_semanticContext &var_cas_ioSemanticContext) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_and_5Fcache) COMMA_HERE) ;
  GGS_luint  var_cas_size ;
  inLexique._assignFromAttribute_ulongValue (var_cas_size) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_literal_5Finteger) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__3B) COMMA_HERE) ;
  GGS_AC_job  var_cas_job ;
...
pr_component_sara_parser_201_16_ (sara_scanner & inLexique,
                                GGS_semanticContext &var_cas_ioSemanticContext) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_ite_5Fcache) COMMA_HERE) ;
  GGS_luint  var_cas_size ;
  inLexique._assignFromAttribute_ulongValue (var_cas_size) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_literal_5Finteger) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__3B) COMMA_HERE) ;
...
pr_component_sara_parser_238_16_ (sara_scanner & inLexique,
  ...
  inLexique._assignFromAttribute_identifierString (var_cas_machineName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_machineIdf) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__28) COMMA_HERE) ;
  { bool syntaxRepeat_1 = true ;
    while (syntaxRepeat_1) {
        GGS_lstring  var_cas_inputVarName ;
        inLexique._assignFromAttribute_identifierString (var_cas_inputVarName) ;
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__29) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__28) COMMA_HERE) ;
    ...
    case 2 : {
      { bool syntaxRepeat_3 = true ;
        while (syntaxRepeat_3) {
            ...
            inLexique._assignFromAttribute_identifierString (var_cas_outputVarName) ;
            inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__29) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__3A_3D) COMMA_HERE) ;
...
pr_component_sara_parser_443_16_ (sara_scanner & inLexique,
  ...
  const GGS_M_machinesMap  _temp_12634 = var_cas_ioSemanticContext.reader_machinesMap (inLexique COMMA_SOURCE_FILE_AT_LINE (458)) ;
  if (_temp_12634.isBuilt ()) {
    _temp_12634 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_machineName, var_cas_machineIndex, var_cas_inputVariablesCountFromDefinition, var_cas_inputAndInternalVariablesCountFromDefinition, var_cas_variablesMapFromDefinition COMMA_SOURCE_FILE_AT_LINE (458)) ;
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__28) COMMA_HERE) ;
  ...
  if (((var_cas_inputVariablesCountFromDefinition)._operator_isNotEqual (var_cas_inputVariablesCount)).isBuiltAndTrue ()) {
    GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("This declaration names "))._operator_concat (var_cas_inputVariablesCount.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (472))))._operator_concat (GGS_string (" input variable(s), but machine definition names ")))._operator_concat (var_cas_inputVariablesCountFromDefinition.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (473))))._operator_concat (GGS_string (" input variable(s)")) COMMA_SOURCE_FILE_AT_LINE (474)) ;
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__28) COMMA_HERE) ;
  ...
  if (((var_cas_inputAndInternalVariablesCountFromDefinition)._operator_isNotEqual (var_cas_inputAndInternalVariablesCount)).isBuiltAndTrue ()) {
    GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("This declaration names "))._operator_concat (var_cas_inputAndInternalVariablesCount.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (491))))._operator_concat (GGS_string (" input and internal variable(s), but machine definition names ")))._operator_concat (var_cas_inputAndInternalVariablesCountFromDefinition.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (492))))._operator_concat (GGS_string (" input and internal variable(s)")) COMMA_SOURCE_FILE_AT_LINE (493)) ;
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__28) COMMA_HERE) ;
  ...
  if (((var_cas_outputVariablesCountFromDefinition)._operator_isNotEqual (var_cas_outputVariablesCount)).isBuiltAndTrue ()) {
    GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("This declaration names "))._operator_concat (var_cas_outputVariablesCount.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (508))))._operator_concat (GGS_string (" variables, but machine definition names ")))._operator_concat (var_cas_outputVariablesCountFromDefinition.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (509))))._operator_concat (GGS_string (" variables")) COMMA_SOURCE_FILE_AT_LINE (510)) ;
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__7B) COMMA_HERE) ;
  ...
  { bool syntaxRepeat_17 = true ;
    while (syntaxRepeat_17) {
        ...
        inLexique._assignFromAttribute_identifierString (var_cas_scenarioTitle) ;
        inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_literal_5Fstring) COMMA_HERE) ;
        ...
        { bool syntaxRepeat_18 = true ;
          while (syntaxRepeat_18) {
              inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__3A) COMMA_HERE) ;
              ...
              { bool syntaxRepeat_19 = true ;
                while (syntaxRepeat_19) {
                    GGS_luint  var_cas_v ;
                    inLexique._assignFromAttribute_ulongValue (var_cas_v) ;
                    inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_literal_5Finteger) COMMA_HERE) ;
                    if (((var_cas_v.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (523)))._operator_strictSup (GGS_uint (1U))).isBuiltAndTrue ()) {
              ...
              if (((var_cas_inputVariablesCount)._operator_isNotEqual (var_cas_inputConfigurationForScenario.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (530)))).isBuiltAndTrue ()) {
                GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((GGS_string ("this input configuration names "))._operator_concat (var_cas_inputConfigurationForScenario.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (531)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (531))))._operator_concat (GGS_string (" input variable(s), instead of ")))._operator_concat (var_cas_inputVariablesCount.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (531))) COMMA_SOURCE_FILE_AT_LINE (532)) ;
              }
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__7D) COMMA_HERE) ;
  GGS_AC_job  var_cas_machine ;
  ...
  { bool syntaxRepeat_20 = true ;
    while (syntaxRepeat_20) {
      switch (select_repeat_sara_parser_20 (inLexique)) {
        case 2 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__7C) COMMA_HERE) ;
        ...
        case 3 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__5E) COMMA_HERE) ;
          GGS_AC_boolExpression  var_cas_rightExpression ;
          nt_io_and_expression_ (inLexique, var_cas_inSemanticContext, var_cas_ioVarMap, var_cas_rightExpression) ;
        ...
        case 4 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__2D_3E) COMMA_HERE) ;
          GGS_AC_boolExpression  var_cas_rightExpression ;
          nt_io_and_expression_ (inLexique, var_cas_inSemanticContext, var_cas_ioVarMap, var_cas_rightExpression) ;
        ...
        case 5 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__3D) COMMA_HERE) ;
          GGS_AC_boolExpression  var_cas_rightExpression ;
          nt_io_and_expression_ (inLexique, var_cas_inSemanticContext, var_cas_ioVarMap, var_cas_rightExpression) ;
  ...
  { bool syntaxRepeat_21 = true ;
    while (syntaxRepeat_21) {
      switch (select_repeat_sara_parser_21 (inLexique)) {
        case 2 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__26) COMMA_HERE) ;
          GGS_AC_boolExpression  var_cas_rightExpression ;
...
pr_io_primary_sara_parser_609_17_ (sara_scanner & inLexique,
  ...
  const GGS_M_variablesMap  _temp_18233 = var_cas_ioVarMap ;
  if (_temp_18233.isBuilt ()) {
    _temp_18233 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_inputVarName, var_cas_inputVarIndex COMMA_SOURCE_FILE_AT_LINE (617)) ;
  }
...
pr_io_primary_sara_parser_623_17_ (sara_scanner & inLexique,
                                ...
                                GGS_M_variablesMap  &var_cas_ioVarMap,
                                GGS_AC_boolExpression  &var_cas_outExpression) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__7E) COMMA_HERE) ;
...
pr_io_primary_sara_parser_658_17_ (sara_scanner & inLexique,
  ...
  inLexique._assignFromAttribute_identifierString (var_cas_machineIdentifier) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_machineIdf) COMMA_HERE) ;
  ...
  const GGS_M_machinesMap  _temp_19772 = var_cas_inSemanticContext.reader_machinesMap (inLexique COMMA_SOURCE_FILE_AT_LINE (669)) ;
  if (_temp_19772.isBuilt ()) {
    _temp_19772 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_machineIdentifier, var_cas_indexOfImportedMachine, var_cas_machineInputVariableCount, var_cas_machineInputAndInternalVariableCount, var_cas_machineVariablesMap COMMA_SOURCE_FILE_AT_LINE (669)) ;
  }
  ...
  { bool syntaxRepeat_22 = true ;
    while (syntaxRepeat_22) {
        ...
        inLexique._assignFromAttribute_identifierString (var_cas_inputVar) ;
        inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
        GGS_luint  var_cas_inputVarIndex ;
        const GGS_M_variablesMap  _temp_20116 = var_cas_ioVarMap ;
        if (_temp_20116.isBuilt ()) {
          _temp_20116 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_inputVar, var_cas_inputVarIndex COMMA_SOURCE_FILE_AT_LINE (677)) ;
        }
  ...
  if (((var_cas_inputVariablesCount)._operator_isNotEqual (var_cas_machineInputVariableCount)).isBuiltAndTrue ()) {
    GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((GGS_string ("The '$"))._operator_concat (var_cas_machineIdentifier))._operator_concat (GGS_string ("' machine defines ")))._operator_concat (var_cas_machineInputVariableCount.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (685))))._operator_concat (GGS_string (" input variable(s), but this operand defines ")))._operator_concat (var_cas_inputVariablesCount.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (686))))._operator_concat (GGS_string (" input variable(s)")) COMMA_SOURCE_FILE_AT_LINE (687)) ;
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__28) COMMA_HERE) ;
    ...
    case 2 : {
      { bool syntaxRepeat_24 = true ;
        while (syntaxRepeat_24) {
            ...
            inLexique._assignFromAttribute_identifierString (var_cas_internalVar) ;
            inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
            GGS_luint  var_cas_internalVarIndex ;
            const GGS_M_variablesMap  _temp_20766 = var_cas_ioVarMap ;
            if (_temp_20766.isBuilt ()) {
              _temp_20766 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_internalVar, var_cas_internalVarIndex COMMA_SOURCE_FILE_AT_LINE (696)) ;
            }
  ...
  if (((var_cas_inputAndInternalVariablesCount)._operator_isNotEqual (var_cas_machineInputAndInternalVariableCount)).isBuiltAndTrue ()) {
    GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((GGS_string ("The '$"))._operator_concat (var_cas_machineIdentifier.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (705))))._operator_concat (GGS_string ("' machine defines ")))._operator_concat (var_cas_machineInputAndInternalVariableCount.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (705))))._operator_concat (GGS_string (" input and internal variable(s), but this operand defines ")))._operator_concat (var_cas_inputAndInternalVariablesCount.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (706))))._operator_concat (GGS_string (" input and internal variable(s)")) COMMA_SOURCE_FILE_AT_LINE (707)) ;
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__28) COMMA_HERE) ;
  { bool syntaxRepeat_25 = true ;
    while (syntaxRepeat_25) {
        GGS_lstring  var_cas_outputVar ;
        inLexique._assignFromAttribute_identifierString (var_cas_outputVar) ;
        inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
        GGS_luint  var_cas_outputVarIndex ;
        const GGS_M_variablesMap  _temp_21507 = var_cas_ioVarMap ;
        if (_temp_21507.isBuilt ()) {
          _temp_21507 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_outputVar, var_cas_outputVarIndex COMMA_SOURCE_FILE_AT_LINE (714)) ;
        }
  ...
  if (((var_cas_allVariablesCount)._operator_isNotEqual (var_cas_machineAllVariablesCount)).isBuiltAndTrue ()) {
    GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((GGS_string ("The '$"))._operator_concat (var_cas_machineIdentifier.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (723))))._operator_concat (GGS_string ("' machine defines ")))._operator_concat (var_cas_machineAllVariablesCount.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (723))))._operator_concat (GGS_string (" variables, but this operand defines ")))._operator_concat (var_cas_allVariablesCount.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (724))))._operator_concat (GGS_string (" variables")) COMMA_SOURCE_FILE_AT_LINE (725)) ;
  }
  ...
  { bool syntaxRepeat_26 = true ;
    while (syntaxRepeat_26) {
      switch (select_repeat_sara_parser_26 (inLexique)) {
        case 2 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__2B) COMMA_HERE) ;
  ...
  { bool syntaxRepeat_27 = true ;
    while (syntaxRepeat_27) {
      switch (select_repeat_sara_parser_27 (inLexique)) {
        case 2 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__2A) COMMA_HERE) ;
        ...
        case 3 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__2A_2A) COMMA_HERE) ;
          GGS_location  var_cas_errorLocation ;
          var_cas_errorLocation = GGS_location (inLexique) ;
          GGS_AC_machineDefinition  var_cas_leftOperand ;
          var_cas_leftOperand = var_cas_outDefinition ;
        ...
        case 4 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__7C_7C) COMMA_HERE) ;
          GGS_AC_machineDefinition  var_cas_leftOperand ;
          var_cas_leftOperand = var_cas_outDefinition ;
          GGS_AC_machineDefinition  var_cas_rightOperand ;
          nt_definition_expression_factor_ (inLexique, var_cas_inSemanticContext, var_cas_variablesMap, var_cas_rightOperand) ;
...
pr_modalcompadd_definition_sara_parser_787_30_ (sara_scanner & inLexique,
  ...
  { bool syntaxRepeat_28 = true ;
    while (syntaxRepeat_28) {
        ...
        inLexique._assignFromAttribute_identifierString (var_cas_modeName) ;
        inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
        inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__3A) COMMA_HERE) ;
    ...
    while (syntaxRepeat_29) {
      switch (select_repeat_sara_parser_29 (inLexique)) {
        case 2 : {
          ...
          inLexique._assignFromAttribute_identifierString (var_cas_sourceModeName) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
          GGS_luint  var_cas_sourceModeIndex ;
          GGS_AC_machineDefinition  automatic_var_12 ;
          const GGS_M_modesMap  _temp_24992 = var_cas_outModeMap ;
          if (_temp_24992.isBuilt ()) {
            _temp_24992 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_sourceModeName, var_cas_sourceModeIndex, automatic_var_12 COMMA_SOURCE_FILE_AT_LINE (811)) ;
          }
          inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_to) COMMA_HERE) ;
          GGS_lstring  var_cas_targetModeName ;
          inLexique._assignFromAttribute_identifierString (var_cas_targetModeName) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
          GGS_luint  var_cas_targetModeIndex ;
          GGS_AC_machineDefinition  automatic_var_13 ;
          const GGS_M_modesMap  _temp_25171 = var_cas_outModeMap ;
          if (_temp_25171.isBuilt ()) {
            _temp_25171 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_targetModeName, var_cas_targetModeIndex, automatic_var_13 COMMA_SOURCE_FILE_AT_LINE (816)) ;
          }
          inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__3B) COMMA_HERE) ;
          if (((var_cas_sourceModeIndex.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (818)))._operator_isEqual (var_cas_targetModeIndex.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (818)))).isBuiltAndTrue ()) {
    ...
    while (syntaxRepeat_31) {
      switch (select_repeat_sara_parser_31 (inLexique)) {
        case 2 : {
          ...
          const GGS_M_modesMap  _temp_26299 = var_cas_outModeMap ;
          if (_temp_26299.isBuilt ()) {
            _temp_26299 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_sourceModeName, var_cas_sourceModeIndex, automatic_var_14 COMMA_SOURCE_FILE_AT_LINE (852)) ;
          }
          inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_to) COMMA_HERE) ;
          GGS_lstring  var_cas_targetModeName ;
          inLexique._assignFromAttribute_identifierString (var_cas_targetModeName) ;
          ...
          const GGS_M_modesMap  _temp_26478 = var_cas_outModeMap ;
          if (_temp_26478.isBuilt ()) {
            _temp_26478 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_targetModeName, var_cas_targetModeIndex, automatic_var_15 COMMA_SOURCE_FILE_AT_LINE (857)) ;
          }
          inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__3B) COMMA_HERE) ;
          if (((var_cas_sourceModeIndex.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (859)))._operator_isEqual (var_cas_targetModeIndex.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (859)))).isBuiltAndTrue ()) {
...
pr_definition_expression_factor_sara_parser_869_35_ (sara_scanner & inLexique,
  ...
  switch (select_sara_parser_32 (inLexique)) {
    ...
    case 3 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__3F) COMMA_HERE) ;
      { bool syntaxRepeat_33 = true ;
        while (syntaxRepeat_33) {
            GGS_lstring  var_cas_variableName ;
            inLexique._assignFromAttribute_identifierString (var_cas_variableName) ;
            inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
    ...
    case 4 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__21) COMMA_HERE) ;
    ...
    case 6 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__40) COMMA_HERE) ;
      GGS_AC_machineDefinition  var_cas_def ;
...
pr_definition_expression_factor_sara_parser_986_35_ (sara_scanner & inLexique,
  ...
  GGS_M_variablesMap  var_cas_machineVariablesMap ;
  GGS_luint  var_cas_indexOfImportedMachine ;
  const GGS_M_machinesMap  _temp_30992 = var_cas_inSemanticContext.reader_machinesMap (inLexique COMMA_SOURCE_FILE_AT_LINE (997)) ;
  if (_temp_30992.isBuilt ()) {
    _temp_30992 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_machineIdentifier, var_cas_indexOfImportedMachine, var_cas_machineInputVariableCount, var_cas_machineInputAndInternalVariableCount, var_cas_machineVariablesMap COMMA_SOURCE_FILE_AT_LINE (997)) ;
  }
  GGS_L_translationVector  var_cas_translationVector ;
  var_cas_translationVector = GGS_L_translationVector ::constructor_emptyList () ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__28) COMMA_HERE) ;
  { bool syntaxRepeat_35 = true ;
    while (syntaxRepeat_35) {
        ...
        inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
        GGS_luint  var_cas_inputVarIndex ;
        const GGS_M_variablesMap  _temp_31336 = var_cas_ioVarMap ;
        if (_temp_31336.isBuilt ()) {
          _temp_31336 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_inputVar, var_cas_inputVarIndex COMMA_SOURCE_FILE_AT_LINE (1005)) ;
        }
        var_cas_translationVector._addAssign_operation (var_cas_inputVarIndex) ;
  ...
  if (((var_cas_inputVariablesCount)._operator_isNotEqual (var_cas_machineInputVariableCount)).isBuiltAndTrue ()) {
    GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((GGS_string ("The '$"))._operator_concat (var_cas_machineIdentifier.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1013))))._operator_concat (GGS_string ("' machine defines ")))._operator_concat (var_cas_machineInputVariableCount.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1013))))._operator_concat (GGS_string (" input variable(s), but this operand defines ")))._operator_concat (var_cas_inputVariablesCount.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1014))))._operator_concat (GGS_string (" input variable(s)")) COMMA_SOURCE_FILE_AT_LINE (1015)) ;
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__28) COMMA_HERE) ;
    ...
    case 2 : {
      { bool syntaxRepeat_37 = true ;
        while (syntaxRepeat_37) {
            ...
            inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
            GGS_luint  var_cas_internalVarIndex ;
            const GGS_M_variablesMap  _temp_31995 = var_cas_ioVarMap ;
            if (_temp_31995.isBuilt ()) {
              _temp_31995 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_internalVar, var_cas_internalVarIndex COMMA_SOURCE_FILE_AT_LINE (1024)) ;
            }
            var_cas_translationVector._addAssign_operation (var_cas_internalVarIndex) ;
  ...
  if (((var_cas_inputAndInternalVariablesCount)._operator_isNotEqual (var_cas_machineInputAndInternalVariableCount)).isBuiltAndTrue ()) {
    GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((GGS_string ("The '$"))._operator_concat (var_cas_machineIdentifier.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1033))))._operator_concat (GGS_string ("' machine defines ")))._operator_concat (var_cas_machineInputAndInternalVariableCount.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1033))))._operator_concat (GGS_string (" input and internal variable(s), but this operand defines ")))._operator_concat (var_cas_inputAndInternalVariablesCount.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1034))))._operator_concat (GGS_string (" input and internal variable(s)")) COMMA_SOURCE_FILE_AT_LINE (1035)) ;
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__28) COMMA_HERE) ;
  { bool syntaxRepeat_38 = true ;
    while (syntaxRepeat_38) {
        ...
        inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
        GGS_luint  var_cas_outputVarIndex ;
        const GGS_M_variablesMap  _temp_32736 = var_cas_ioVarMap ;
        if (_temp_32736.isBuilt ()) {
          _temp_32736 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_outputVar, var_cas_outputVarIndex COMMA_SOURCE_FILE_AT_LINE (1042)) ;
        }
        var_cas_translationVector._addAssign_operation (var_cas_outputVarIndex) ;
  ...
  if (((var_cas_allVariablesCount)._operator_isNotEqual (var_cas_machineAllVariablesCount)).isBuiltAndTrue ()) {
    GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((GGS_string ("The '$"))._operator_concat (var_cas_machineIdentifier.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1051))))._operator_concat (GGS_string ("' machine defines ")))._operator_concat (var_cas_machineAllVariablesCount.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1051))))._operator_concat (GGS_string (" variables, but this operand defines ")))._operator_concat (var_cas_allVariablesCount.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1052))))._operator_concat (GGS_string (" variables")) COMMA_SOURCE_FILE_AT_LINE (1053)) ;
  }
...
pr_explicit_automaton_sara_parser_1061_25_ (sara_scanner & inLexique,
  ...
  { bool syntaxRepeat_39 = true ;
    while (syntaxRepeat_39) {
        ...
        inLexique._assignFromAttribute_identifierString (var_cas_stateName) ;
        inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
  ...
  { bool syntaxRepeat_40 = true ;
    while (syntaxRepeat_40) {
        ...
        inLexique._assignFromAttribute_identifierString (var_cas_initialState) ;
        inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
        GGS_luint  var_cas_initialStateIndex ;
        const GGS_M_stateMap  _temp_34256 = var_cas_statesMap ;
        if (_temp_34256.isBuilt ()) {
          _temp_34256 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_initialState, var_cas_initialStateIndex COMMA_SOURCE_FILE_AT_LINE (1087)) ;
        }
    ...
    case 2 : {
      ...
      { bool syntaxRepeat_42 = true ;
        while (syntaxRepeat_42) {
            ...
            inLexique._assignFromAttribute_identifierString (var_cas_terminalState) ;
            inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
            GGS_luint  var_cas_terminalStateIndex ;
            const GGS_M_stateMap  _temp_34660 = var_cas_statesMap ;
            if (_temp_34660.isBuilt ()) {
              _temp_34660 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_terminalState, var_cas_terminalStateIndex COMMA_SOURCE_FILE_AT_LINE (1102)) ;
            }
  ...
  { bool syntaxRepeat_43 = true ;
    while (syntaxRepeat_43) {
        ...
        const GGS_M_stateMap  _temp_35047 = var_cas_statesMap ;
        if (_temp_35047.isBuilt ()) {
          _temp_35047 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_stateName, var_cas_stateIndex COMMA_SOURCE_FILE_AT_LINE (1116)) ;
        }
          ...
          while (syntaxRepeat_44) {
            switch (select_repeat_sara_parser_44 (inLexique)) {
              case 2 : {
                ...
                inLexique._assignFromAttribute_identifierString (var_cas_targetStateName) ;
                inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1_identifier) COMMA_HERE) ;
                GGS_luint  var_cas_targetStateIndex ;
                const GGS_M_stateMap  _temp_35787 = var_cas_statesMap ;
                if (_temp_35787.isBuilt ()) {
                  _temp_35787 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_targetStateName, var_cas_targetStateIndex COMMA_SOURCE_FILE_AT_LINE (1135)) ;
                }
  ...
  {
    GGS_M_stateMap::cEnumerator enumerator_36154 (var_cas_statesMap, true) ;
    const GGS_M_stateMap::cElement * operand_36154 = NULL ;
    while (((operand_36154 = enumerator_36154.nextObject ()))) {
      macroValidPointer (operand_36154) ;
      if (((var_cas_stateDefinitionMap.reader_hasKey (inLexique, operand_36154->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1146)) COMMA_SOURCE_FILE_AT_LINE (1146)))._operator_not ()).isBuiltAndTrue ()) {
        GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("'"))._operator_concat (operand_36154->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1147))))._operator_concat (GGS_string ("' state is not described")) COMMA_SOURCE_FILE_AT_LINE (1148)) ;
      }
    }
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__7D) COMMA_HERE) ;
