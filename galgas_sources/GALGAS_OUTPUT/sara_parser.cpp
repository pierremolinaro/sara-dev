...
void sara_parser::rule_sara_5F_parser_io_5F_primary_i22_ (C_Lexique_sara_5F_scanner & inLexique,
  ...
  if (var_cas_ioVarMap.isBuilt ()) {
    var_cas_ioVarMap (HERE)->method_searchKey (inLexique, var_cas_inputVarName, var_cas_inputVarIndex COMMA_SOURCE_FILE_AT_LINE (708)) ;
  }
...
void sara_parser::rule_sara_5F_parser_io_5F_primary_i26_ (C_Lexique_sara_5F_scanner & inLexique,
  ...
  { bool syntaxRepeat_22 = true ;
    while (syntaxRepeat_22) {
        ...
        GGS_uint  var_cas_inputVarIndex ;
        if (var_cas_ioVarMap.isBuilt ()) {
          var_cas_ioVarMap (HERE)->method_searchKey (inLexique, var_cas_inputVar, var_cas_inputVarIndex COMMA_SOURCE_FILE_AT_LINE (768)) ;
        }
    ...
    case 2 : {
      { bool syntaxRepeat_24 = true ;
        while (syntaxRepeat_24) {
            ...
            if (var_cas_ioVarMap.isBuilt ()) {
              var_cas_ioVarMap (HERE)->method_searchKey (inLexique, var_cas_internalVar, var_cas_internalVarIndex COMMA_SOURCE_FILE_AT_LINE (787)) ;
            }
  ...
  { bool syntaxRepeat_25 = true ;
    while (syntaxRepeat_25) {
        ...
        if (var_cas_ioVarMap.isBuilt ()) {
          var_cas_ioVarMap (HERE)->method_searchKey (inLexique, var_cas_outputVar, var_cas_outputVarIndex COMMA_SOURCE_FILE_AT_LINE (805)) ;
        }
      ...
      switch (select_sara_5F_parser_29 (inLexique)) {
        case 2 : {
          ...
          if (var_cas_outModeMap.isBuilt ()) {
            var_cas_outModeMap (HERE)->method_searchKey (inLexique, var_cas_sourceModeName, var_cas_sourceModeIndex, automatic_var_28133_0 COMMA_SOURCE_FILE_AT_LINE (902)) ;
          }
          ...
          if (var_cas_outModeMap.isBuilt ()) {
            var_cas_outModeMap (HERE)->method_searchKey (inLexique, var_cas_targetModeName, var_cas_targetModeIndex, automatic_var_28303_0 COMMA_SOURCE_FILE_AT_LINE (907)) ;
          }
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_sara_5F_scanner::kToken__3B_) COMMA_HERE) ;
    ...
    while (syntaxRepeat_31) {
      switch (select_sara_5F_parser_31 (inLexique)) {
        case 2 : {
          ...
          if (var_cas_outModeMap.isBuilt ()) {
            var_cas_outModeMap (HERE)->method_searchKey (inLexique, var_cas_sourceModeName, var_cas_sourceModeIndex, automatic_var_29427_0 COMMA_SOURCE_FILE_AT_LINE (943)) ;
          }
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_sara_5F_scanner::kToken_to) COMMA_HERE) ;
          GGS_lstring  var_cas_targetModeName ;
          inLexique.assignFromAttribute_identifierString (var_cas_targetModeName) ;
          ...
          if (var_cas_outModeMap.isBuilt ()) {
            var_cas_outModeMap (HERE)->method_searchKey (inLexique, var_cas_targetModeName, var_cas_targetModeIndex, automatic_var_29597_0 COMMA_SOURCE_FILE_AT_LINE (948)) ;
          }
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_sara_5F_scanner::kToken__3B_) COMMA_HERE) ;
...
void sara_parser::rule_sara_5F_parser_definition_5F_expression_5F_factor_i32_ (C_Lexique_sara_5F_scanner & inLexique,
  ...
  { bool syntaxRepeat_35 = true ;
    while (syntaxRepeat_35) {
        ...
        GGS_uint  var_cas_inputVarIndex ;
        if (var_cas_ioVarMap.isBuilt ()) {
          var_cas_ioVarMap (HERE)->method_searchKey (inLexique, var_cas_inputVar, var_cas_inputVarIndex COMMA_SOURCE_FILE_AT_LINE (1096)) ;
        }
        var_cas_translationVector.addAssign_operation (var_cas_inputVarIndex) ;
    ...
    case 2 : {
      { bool syntaxRepeat_37 = true ;
        while (syntaxRepeat_37) {
            ...
            GGS_uint  var_cas_internalVarIndex ;
            if (var_cas_ioVarMap.isBuilt ()) {
              var_cas_ioVarMap (HERE)->method_searchKey (inLexique, var_cas_internalVar, var_cas_internalVarIndex COMMA_SOURCE_FILE_AT_LINE (1115)) ;
            }
            var_cas_translationVector.addAssign_operation (var_cas_internalVarIndex) ;
  ...
  { bool syntaxRepeat_38 = true ;
    while (syntaxRepeat_38) {
        ...
        GGS_uint  var_cas_outputVarIndex ;
        if (var_cas_ioVarMap.isBuilt ()) {
          var_cas_ioVarMap (HERE)->method_searchKey (inLexique, var_cas_outputVar, var_cas_outputVarIndex COMMA_SOURCE_FILE_AT_LINE (1133)) ;
        }
        var_cas_translationVector.addAssign_operation (var_cas_outputVarIndex) ;
...
void sara_parser::rule_sara_5F_parser_explicit_5F_automaton_i33_ (C_Lexique_sara_5F_scanner & inLexique,
  ...
  { bool syntaxRepeat_40 = true ;
    while (syntaxRepeat_40) {
        ...
        if (var_cas_statesMap.isBuilt ()) {
          var_cas_statesMap (HERE)->method_searchKey (inLexique, var_cas_initialState, var_cas_initialStateIndex COMMA_SOURCE_FILE_AT_LINE (1178)) ;
        }
    ...
    case 2 : {
      ...
      { bool syntaxRepeat_42 = true ;
        while (syntaxRepeat_42) {
            ...
            if (var_cas_statesMap.isBuilt ()) {
              var_cas_statesMap (HERE)->method_searchKey (inLexique, var_cas_terminalState, var_cas_terminalStateIndex COMMA_SOURCE_FILE_AT_LINE (1193)) ;
            }
  ...
  { bool syntaxRepeat_43 = true ;
    while (syntaxRepeat_43) {
        ...
        if (var_cas_statesMap.isBuilt ()) {
          var_cas_statesMap (HERE)->method_searchKey (inLexique, var_cas_stateName, var_cas_stateIndex COMMA_SOURCE_FILE_AT_LINE (1207)) ;
        }
          ...
          while (syntaxRepeat_44) {
            switch (select_sara_5F_parser_44 (inLexique)) {
              case 2 : {
                ...
                if (var_cas_statesMap.isBuilt ()) {
                  var_cas_statesMap (HERE)->method_searchKey (inLexique, var_cas_targetStateName, var_cas_targetStateIndex COMMA_SOURCE_FILE_AT_LINE (1226)) ;
                }
  ...
  }
  {
    ...
    while (((operand_39249 = enumerator_39249.nextObject ()))) {
      ...
      const GGS_bool cond_39380 = (var_cas_stateDefinitionMap.reader_hasKey (operand_39249->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1237)))).operator_not () ;
      if (cond_39380.isBuiltAndTrue ()) {
        GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("'")).operator_concat (operand_39249->mKey)).operator_concat (GGS_string ("' state is not described")) COMMA_SOURCE_FILE_AT_LINE (1239)) ;
      }
    }
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_sara_5F_scanner::kToken__7D_) COMMA_HERE) ;
