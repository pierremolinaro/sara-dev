...
pr_explicit_automaton_sara_parser_1127_6_ (sara_scanner & _inLexique,
  ...
  GGS_M_stateMap::element_type * operand_37367 = var_cas_statesMap.firstObject () ;
  while ((operand_37367 != NULL)) {
    macroValidPointer (operand_37367) ;
    if (((! (var_cas_stateDefinitionMap.reader_hasKey (_inLexique, operand_37367->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1212)) SOURCE_FILE_AT_LINE (1212))))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "'")) + (operand_37367->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (1213))))) + (GGS_string (true, "' state is not described"))) SOURCE_FILE_AT_LINE (1214)) ;
    }
    operand_37367 = operand_37367->nextObject () ;
  }
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (sara_scanner::sara_scanner_1__7D) COMMA_HERE) ;
