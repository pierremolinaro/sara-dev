...
static void
sara_main_prologue (C_Compiler & /* _inLexique */,
...
static void
sara_main_epilogue (C_Compiler & /* _inLexique */,
                     const TC_UniqueArray <C_String> & /* inSourceFilesArray */) {
}
  ...
  //--- Enable 64 bit alloc debug ? Only if compiled in 64 bit and in debug mode
    ...
    try{
      verboseOptionOn = options.boolOptionValueFromKeys ("generic_galgas_cli_options",
                                                         "verbose_output",
                                                         false) ;
      sara_main_prologue (* _commonLexique, sourceFilesArray) ;
        ...
        try {
          ...
          if (fileExtension.compare ("sara") == 0) {
            ...
            if (_depExtension._isBuilt () && _depPath._isBuilt ()) {
              sara_grammar::_performSourceFileParsing_ (_inLexique,
    ...
    //--- Epilogue
      sara_main_epilogue (* _commonLexique, sourceFilesArray) ;
