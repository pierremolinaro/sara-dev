...
grammar_sara_main::
grammar_sara_main (C_galgas_io * inParametersPtr
                  COMMA_LOCATION_ARGS) :
_mScannerPtr (NULL) {
  macroMyNew (_mScannerPtr, sara_scanner (inParametersPtr COMMA_THERE)) ;
}
    ...
    try{
      ...
      for (sint32 i=0 ; i<sourceFilesArray.count () ; i++) {
        ...
        if (fileExtension.compare ("sara") == 0) {
          ...
          macroMyNew (compiler, grammar_sara_main (galgasIOptr COMMA_HERE)) ;
          compiler->_prologue () ;
