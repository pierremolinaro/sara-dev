...
//---------------------------------------------------------------------------*
  ...
  static const char gGGSsourceFile [] = "sara_main.ggs" ;
...
grammar_sara_main::
grammar_sara_main (const C_galgas_io_parameters & inIOparameters COMMA_LOCATION_ARGS) :
_mScannerPtr (NULL), mTerminalIO (inIOparameters) {
  macroMyNew (_mScannerPtr, sara_scanner (& mTerminalIO COMMA_THERE)) ;
}
...
grammar_sara_main::
~grammar_sara_main (void) {
  macroDetachPointer (_mScannerPtr, sara_scanner) ;
}
...
int mainForLIBPM  (const int argc, const char * argv []) {
  ...
  //--- Input/output parameters
    ...
    const char * helpMessages [] = {"a sara text source file", NULL} ;
    ...
    try{
      ...
      for (sint32 i=0 ; i<sourceFilesArray.count () ; i++) {
        ...
        if (fileExtension.compare ("sara") == 0) {
          grammar_sara_main * compiler = NULL ;
          macroMyNew (compiler, grammar_sara_main (IOparameters COMMA_HERE)) ;
          compiler->_prologue () ;
          compiler->doCompilation (sourceFilesArray (i COMMA_HERE), verboseOptionOn, r) ;
          compiler->_epilogue () ;
          macroMyDelete (compiler, grammar_sara_main) ;
        }else{
