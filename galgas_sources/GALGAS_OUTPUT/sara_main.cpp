...
void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
                                  ...
                                  COMMA_UNUSED_LOCATION_ARGS) {
  cGrammar_sara_5F_grammar::_performSourceFileParsing_ (inCompiler, constinArgument_inSourceFile  COMMA_SOURCE_FILE ("sara_main.gProgram", 14)) ;
}
