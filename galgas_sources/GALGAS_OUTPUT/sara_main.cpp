...
#ifndef DO_NOT_GENERATE_CHECKINGS
  static const char * kVersionString = "version " "version 1.4.0" " [debug]" ;
#else
  static const char * kVersionString = "version " "version 1.4.0" ;
#endif
...
void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  cGrammar_sara_5F_grammar::_performSourceFileParsing_ (inCompiler, constinArgument_inSourceFile COMMA_SOURCE_FILE_AT_LINE (14)) ;
