...
class C_options_for_sara_main : public C_cli_options_group {
//--- Constructor
...
sara_main::
sara_main (const C_galgas_io_parameters & inIOparameters) :
...
//--- Input/output parameters
  ...
  IOparameters.mCompilerVersion = "version 0.0.1" ;
  ...
  sara_main compiler (IOparameters) ;
  try{
