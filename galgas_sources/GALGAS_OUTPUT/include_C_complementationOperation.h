...
class GGG_C_complementationOperation : public GGG_AC_machineDefinition {
  private : typedef GGG_AC_machineDefinition inherited ;
  public : GGG_C_complementationOperation (const GGS_AC_machineDefinition &  COMMA_LOCATION_ARGS) ;
} ;
