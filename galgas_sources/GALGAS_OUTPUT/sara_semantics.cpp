...
GGS_M_variablesMap GGS_M_variablesMap::constructor_mapWithKeyAndValue (C_Compiler & inLexique,
                                             const GGS_lstring & inKey,
                                             const GGS_uint & inValue0
                                             COMMA_LOCATION_ARGS) {
  GGS_M_variablesMap result = constructor_emptyMap (inLexique COMMA_THERE) ;
...
//--- 'mapWithKeyAndValue' constructor
GGS_M_stateMap GGS_M_stateMap::constructor_mapWithKeyAndValue (C_Compiler & inLexique,
                                             const GGS_lstring & inKey,
                                             const GGS_uint & inValue0
                                             COMMA_LOCATION_ARGS) {
  GGS_M_stateMap result = constructor_emptyMap (inLexique COMMA_THERE) ;
  result.insertElement (inLexique,
                        0,
                        NULL,
                        inKey,
...
//--- 'mapWithKeyAndValue' constructor
GGS_M_modesMap GGS_M_modesMap::constructor_mapWithKeyAndValue (C_Compiler & inLexique,
                                             const GGS_lstring & inKey,
                                             const GGS_uint & inValue0,
                                             const GGS_AC_machineDefinition & inValue1
                                             COMMA_LOCATION_ARGS) {
  GGS_M_modesMap result = constructor_emptyMap (inLexique COMMA_THERE) ;
  result.insertElement (inLexique,
                        0,
                        NULL,
                        inKey,
...
//--- 'mapWithKeyAndValue' constructor
GGS_M_machinesMap GGS_M_machinesMap::constructor_mapWithKeyAndValue (C_Compiler & inLexique,
                                             const GGS_lstring & inKey,
                                             const GGS_uint & inValue0,
                                             const GGS_uint & inValue1,
                                             const GGS_uint & inValue2,
                                             const GGS_M_variablesMap & inValue3
                                             COMMA_LOCATION_ARGS) {
  GGS_M_machinesMap result = constructor_emptyMap (inLexique COMMA_THERE) ;
  result.insertElement (inLexique,
                        0,
                        NULL,
                        inKey,
