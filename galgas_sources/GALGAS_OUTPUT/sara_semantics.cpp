...
cCollectionElement_L_5F_translationVector * GALGAS_L_5F_translationVector::makeElement (const GALGAS_uint & in_mTargetSlot
                                                                                        COMMA_LOCATION_ARGS) {
  cCollectionElement_L_5F_translationVector * result = NULL ;
  macroMyNew (result, cCollectionElement_L_5F_translationVector (in_mTargetSlot COMMA_THERE)) ;
  return result ;
}
...
cCollectionElement_L_5F_transitionDefinition * GALGAS_L_5F_transitionDefinition::makeElement (const GALGAS_AC_5F_boolExpression & in_mActionExpression,
                                                                                              const GALGAS_location & in_mEndOfExpression,
                                                                                              const GALGAS_uint & in_mTargetStateIndex
                                                                                              COMMA_LOCATION_ARGS) {
  cCollectionElement_L_5F_transitionDefinition * result = NULL ;
  macroMyNew (result, cCollectionElement_L_5F_transitionDefinition (in_mActionExpression,
                                                                                              in_mEndOfExpression,
...
cCollectionElement_L_5F_stateDefinition * GALGAS_L_5F_stateDefinition::makeElement (const GALGAS_uint & in_mStateIndex,
                                                                                    const GALGAS_AC_5F_boolExpression & in_mStateExpression,
                                                                                    const GALGAS_location & in_mEndOfStateExpression,
                                                                                    const GALGAS_L_5F_transitionDefinition & in_mTransitionsList
                                                                                    COMMA_LOCATION_ARGS) {
  cCollectionElement_L_5F_stateDefinition * result = NULL ;
  macroMyNew (result, cCollectionElement_L_5F_stateDefinition (in_mStateIndex,
                                                                                    in_mStateExpression,
...
cCollectionElement_L_5F_statesDefinitionList * GALGAS_L_5F_statesDefinitionList::makeElement (const GALGAS_uint & in_mStateIndex,
                                                                                              const GALGAS_location & in_mStateLocation
                                                                                              COMMA_LOCATION_ARGS) {
  cCollectionElement_L_5F_statesDefinitionList * result = NULL ;
  macroMyNew (result, cCollectionElement_L_5F_statesDefinitionList (in_mStateIndex,
...
cCollectionElement_ListForModes * GALGAS_ListForModes::makeElement (const GALGAS_uint & in_mSourceMode,
                                                                    const GALGAS_uint & in_mTargetMode
                                                                    COMMA_LOCATION_ARGS) {
  cCollectionElement_ListForModes * result = NULL ;
  macroMyNew (result, cCollectionElement_ListForModes (in_mSourceMode,
...
cCollectionElement_L_5F_inputConfigurationForScenario * GALGAS_L_5F_inputConfigurationForScenario::makeElement (const GALGAS_luint & in_mInputValue
                                                                                                                COMMA_LOCATION_ARGS) {
  cCollectionElement_L_5F_inputConfigurationForScenario * result = NULL ;
  macroMyNew (result, cCollectionElement_L_5F_inputConfigurationForScenario (in_mInputValue COMMA_THERE)) ;
  return result ;
}
...
cCollectionElement_L_5F_inputScenario * GALGAS_L_5F_inputScenario::makeElement (const GALGAS_L_5F_inputConfigurationForScenario & in_mInputConfiguration
                                                                                COMMA_LOCATION_ARGS) {
  cCollectionElement_L_5F_inputScenario * result = NULL ;
  macroMyNew (result, cCollectionElement_L_5F_inputScenario (in_mInputConfiguration COMMA_THERE)) ;
  return result ;
}
...
cCollectionElement_L_5F_scenarioList * GALGAS_L_5F_scenarioList::makeElement (const GALGAS_lstring & in_mScenarioTitle,
                                                                              const GALGAS_L_5F_inputScenario & in_mInputScenario
                                                                              COMMA_LOCATION_ARGS) {
  cCollectionElement_L_5F_scenarioList * result = NULL ;
  macroMyNew (result, cCollectionElement_L_5F_scenarioList (in_mScenarioTitle,
...
cCollectionElement_L_5F_jobList * GALGAS_L_5F_jobList::makeElement (const GALGAS_AC_5F_job & in_mComponent
                                                                    COMMA_LOCATION_ARGS) {
  cCollectionElement_L_5F_jobList * result = NULL ;
  macroMyNew (result, cCollectionElement_L_5F_jobList (in_mComponent COMMA_THERE)) ;
  return result ;
}
