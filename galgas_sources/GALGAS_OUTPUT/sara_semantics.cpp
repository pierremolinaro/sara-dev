...
void GGS_M_variablesMap::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex) {
  const char * kErrorMessage [] = {"the '",
                                   "",
...
void GGS_M_stateMap::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex) {
  const char * kErrorMessage [] = {"the '",
                                   "",
...
void GGS_M_stateMap::methode_defineStateGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex) {
  const char * kErrorMessage [] = {"the '",
                                   "",
...
void GGS_M_modesMap::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                const GGS_AC_machineDefinition & inParameter0) {
  const char * kErrorMessage [] = {"the '",
...
bool cPtr_C_forallDefinition::isBuilt (void) const {
  return mPreviousVariableCount.isBuilt () &&
       mTotalVariableCount.isBuilt () &&
       mOperand.isBuilt () ;
}
...
cPtr_C_complementationOperation::cPtr_C_complementationOperation (const GGS_AC_machineDefinition & argument_0)
:mOperand (argument_0) {
}

//---------------------------------------------------------------------------*

bool cPtr_C_complementationOperation::isBuilt (void) const {
  return mOperand.isBuilt () ;
}
...
//---------------------------------------------------------------------------*
  ...
  cPtr_C_complementationOperation * GGS_C_complementationOperation::
    ...
    macroMyNew (ptr_, cPtr_C_complementationOperation (argument_0)) ;
    return ptr_ ;
  }
#endif
...
bool cPtr_C_machineCheckIdentical::isBuilt (void) const {
  return mMachineIndex1.isBuilt () &&
       mMachineIndex2.isBuilt () ;
}
