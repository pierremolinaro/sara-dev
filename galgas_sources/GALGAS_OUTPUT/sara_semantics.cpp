...
GGS_string GGS_M_variablesMap::reader_description (void) const {
  C_String s ;
...
void GGS_M_stateMap::
methode_defineState (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey COMMA_LOCATION_ARGS) {
  insertElement (lexique_var_,
...
GGS_string GGS_M_stateMap::reader_description (void) const {
  C_String s ;
  s << "<map @M_stateMap " ;
  if (isBuilt ()) {
    s << count () << " object" << ((count () > 1) ? "s " : " ") ;
...
appendForListDescription (C_String & ioString) const {
  ioString << "[" ;
  ioString << mTargetSlot.reader_description () ;
  ioString << "]" ;
}
...
GGS_string GGS_L_translationVector::reader_description (void) const {
  C_String s ;
...
void cPtr_C_importBoolMachine::appendForDescription (C_String & ioString) const {
  ioString << "->@C_importBoolMachine:" ;
mIndexOfImportedMachine.reader_description () ;
mErrorLocation.reader_description () ;
mTranslationVector.reader_description () ;
}
...
void cPtr_C_andExpression::appendForDescription (C_String & ioString) const {
...
void cPtr_C_orExpression::appendForDescription (C_String & ioString) const {
...
void cPtr_C_xorExpression::appendForDescription (C_String & ioString) const {
...
void cPtr_C_impliesExpression::appendForDescription (C_String & ioString) const {
...
void cPtr_C_equalExpression::appendForDescription (C_String & ioString) const {
...
void cPtr_C_notExpression::appendForDescription (C_String & ioString) const {
...
void cPtr_C_VariableExpression::appendForDescription (C_String & ioString) const {
  ioString << "->@C_VariableExpression:" ;
mInputVarIndex.reader_description () ;
}
...
void cPtr_C_trueExpression::appendForDescription (C_String & ioString) const {
...
void cPtr_C_falseExpression::appendForDescription (C_String & ioString) const {
...
appendForListDescription (C_String & ioString) const {
  ioString << "[" ;
  ioString << mActionExpression.reader_description () ;
  ioString << mEndOfExpression.reader_description () ;
  ioString << mTargetStateIndex.reader_description () ;
  ioString << "]" ;
}
...
GGS_string GGS_L_transitionDefinition::reader_description (void) const {
  C_String s ;
...
appendForListDescription (C_String & ioString) const {
  ioString << "[" ;
  ioString << mStateIndex.reader_description () ;
  ioString << mStateExpression.reader_description () ;
  ioString << mEndOfStateExpression.reader_description () ;
  ioString << mTransitionsList.reader_description () ;
  ioString << "]" ;
}
...
GGS_string GGS_L_stateDefinition::reader_description (void) const {
  C_String s ;
...
appendForListDescription (C_String & ioString) const {
  ioString << "[" ;
  ioString << mStateIndex.reader_description () ;
  ioString << mStateLocation.reader_description () ;
  ioString << "]" ;
}
...
GGS_string GGS_L_statesDefinitionList::reader_description (void) const {
  C_String s ;
...
appendForMapDescription (C_String & ioString) const {
  ioString << "["
           << mKey.reader_description () ;
  ioString << "->" ;
  ioString << mInfo.mModeDefinition.reader_description () ;
  ioString << "]" ;
}
...
GGS_string GGS_M_modesMap::reader_description (void) const {
  C_String s ;
  s << "<map @M_modesMap " ;
  if (isBuilt ()) {
    s << count () << " object" << ((count () > 1) ? "s " : " ") ;
...
appendForListDescription (C_String & ioString) const {
  ioString << "[" ;
  ioString << mSourceMode.reader_description () ;
  ioString << mTargetMode.reader_description () ;
  ioString << "]" ;
}
...
GGS_string GGS_ListForModes::reader_description (void) const {
  C_String s ;
  s << "<list @ListForModes" ;
  if (isBuilt ()) {
    s << mListLength << " object" << ((mListLength > 1) ? "s " : " ") ;
...
void cPtr_C_substractiveModalCompositionComponent::appendForDescription (C_String & ioString) const {
  ioString << "->@C_substractiveModalCompositionComponent:" ;
mModeMap.reader_description () ;
mExclusionList.reader_description () ;
}
...
void cPtr_C_additiveModalCompositionComponent::appendForDescription (C_String & ioString) const {
  ioString << "->@C_additiveModalCompositionComponent:" ;
mModeMap.reader_description () ;
mInclusionList.reader_description () ;
}
...
void cPtr_C_trans::appendForDescription (C_String & ioString) const {
  ioString << "->@C_trans:" ;
mSourceStateExpression.reader_description () ;
mTargetStateExpression.reader_description () ;
}
...
void cPtr_C_importMachine::appendForDescription (C_String & ioString) const {
...
void cPtr_C_explicitAutomatonDefinition::appendForDescription (C_String & ioString) const {
  ioString << "->@C_explicitAutomatonDefinition:" ;
mStatesMap.reader_description () ;
mInitialStatesDefinitionList.reader_description () ;
mTerminalStatesDefinitionList.reader_description () ;
mStateDefinitionList.reader_description () ;
mEndOfDefinition.reader_description () ;
}
...
void cPtr_C_boolToSeqExpression::appendForDescription (C_String & ioString) const {
...
void cPtr_C_existsDefinition::appendForDescription (C_String & ioString) const {
  ioString << "->@C_existsDefinition:" ;
mPreviousVariableCount.reader_description () ;
mTotalVariableCount.reader_description () ;
...
void cPtr_C_forallDefinition::appendForDescription (C_String & ioString) const {
...
void cPtr_C_parallelComposition::appendForDescription (C_String & ioString) const {
  ioString << "->@C_parallelComposition:" ;
mLeftOperand.reader_description () ;
mRightOperand.reader_description () ;
}
...
void cPtr_C_orComposition::appendForDescription (C_String & ioString) const {
...
void cPtr_C_strongModalComposition::appendForDescription (C_String & ioString) const {
...
void cPtr_C_weakModalComposition::appendForDescription (C_String & ioString) const {
...
void cPtr_C_fullSaturationOperation::appendForDescription (C_String & ioString) const {
...
void cPtr_C_complementationOperation::appendForDescription (C_String & ioString) const {
...
void cPtr_C_suppressTerminalStatesOperation::appendForDescription (C_String & ioString) const {
...
void cPtr_C_suppressInitialStatesOperation::appendForDescription (C_String & ioString) const {
...
void cPtr_C_machineCheck::appendForDescription (C_String & ioString) const {
  ioString << "->@C_machineCheck:" ;
mMachineIndex.reader_description () ;
mCheckMachineIsBoolean.reader_description () ;
}
...
void cPtr_C_machineCheckIdentical::appendForDescription (C_String & ioString) const {
  ioString << "->@C_machineCheckIdentical:" ;
mMachineIndex1.reader_description () ;
mMachineIndex2.reader_description () ;
}
...
void cPtr_C_machineComponent::appendForDescription (C_String & ioString) const {
  ioString << "->@C_machineComponent:" ;
mMachineName.reader_description () ;
mMachineIndex.reader_description () ;
mInputVariableCount.reader_description () ;
mInputAndInternalVariableCount.reader_description () ;
mVariablesMap.reader_description () ;
mDefinition.reader_description () ;
}
...
void cPtr_C_machineDefinedByAdditiveModalComp::appendForDescription (C_String & ioString) const {
...
void cPtr_C_machineDefinedBySubstractiveModalComp::appendForDescription (C_String & ioString) const {
...
appendForListDescription (C_String & ioString) const {
  ioString << "[" ;
  ioString << mInputValue.reader_description () ;
  ioString << "]" ;
}
...
GGS_string GGS_L_inputConfigurationForScenario::reader_description (void) const {
  C_String s ;
...
appendForListDescription (C_String & ioString) const {
  ioString << "[" ;
  ioString << mInputConfiguration.reader_description () ;
  ioString << "]" ;
}
...
GGS_string GGS_L_inputScenario::reader_description (void) const {
  C_String s ;
...
appendForListDescription (C_String & ioString) const {
  ioString << "[" ;
  ioString << mScenarioTitle.reader_description () ;
  ioString << mInputScenario.reader_description () ;
  ioString << "]" ;
}
...
GGS_string GGS_L_scenarioList::reader_description (void) const {
  C_String s ;
...
void cPtr_C_scenarioComponent::appendForDescription (C_String & ioString) const {
  ioString << "->@C_scenarioComponent:" ;
mMachineIndex.reader_description () ;
mInputVariableCount.reader_description () ;
mInputAndInternalVariableCount.reader_description () ;
mVariablesMap.reader_description () ;
mScenarioList.reader_description () ;
}
...
void cPtr_typeResize_AND_cache::appendForDescription (C_String & ioString) const {
  ioString << "->@typeResize_AND_cache:" ;
mNewSize.reader_description () ;
}
...
void cPtr_typeResize_ITE_cache::appendForDescription (C_String & ioString) const {
...
void cPtr_typeResizeMap::appendForDescription (C_String & ioString) const {
...
void cPtr_typeDisplayBDDstats::appendForDescription (C_String & ioString) const {
...
appendForListDescription (C_String & ioString) const {
  ioString << "[" ;
  ioString << mComponent.reader_description () ;
  ioString << "]" ;
}
...
GGS_string GGS_L_jobList::reader_description (void) const {
  C_String s ;
  s << "<list @L_jobList" ;
  if (isBuilt ()) {
    s << mListLength << " object" << ((mListLength > 1) ? "s " : " ") ;
...
appendForMapDescription (C_String & ioString) const {
  ioString << "["
           << mKey.reader_description () ;
  ioString << "->" ;
  ioString << mInfo.mInputVariableCount.reader_description () ;
  ioString << mInfo.mInputAndInternalVariableCount.reader_description () ;
  ioString << mInfo.mVariablesMap.reader_description () ;
  ioString << "]" ;
}
...
GGS_string GGS_M_machinesMap::reader_description (void) const {
  C_String s ;
  s << "<map @M_machinesMap " ;
  if (isBuilt ()) {
    s << count () << " object" << ((count () > 1) ? "s " : " ") ;
