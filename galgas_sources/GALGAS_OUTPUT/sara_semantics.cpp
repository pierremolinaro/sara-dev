...
_operator_isEqual (const GGS_L_translationVector & inOperand) const {
...
GGS_bool GGS_L_translationVector::
_operator_isNotEqual (const GGS_L_translationVector & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), ! isEqualToList (inOperand)) ;
}
...
_operator_isEqual (const GGS_AC_boolExpression & inOperand) const {
...
GGS_bool GGS_AC_boolExpression::
_operator_isNotEqual (const GGS_AC_boolExpression & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_C_importBoolMachine & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_C_importBoolMachine::
_operator_isNotEqual (const GGS_C_importBoolMachine & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_C_andExpression & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_C_andExpression::
_operator_isNotEqual (const GGS_C_andExpression & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_C_orExpression & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_C_orExpression::
_operator_isNotEqual (const GGS_C_orExpression & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_C_xorExpression & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_C_xorExpression::
_operator_isNotEqual (const GGS_C_xorExpression & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_C_impliesExpression & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_C_impliesExpression::
_operator_isNotEqual (const GGS_C_impliesExpression & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_C_equalExpression & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_C_equalExpression::
_operator_isNotEqual (const GGS_C_equalExpression & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_C_notExpression & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_C_notExpression::
_operator_isNotEqual (const GGS_C_notExpression & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_C_VariableExpression & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_C_VariableExpression::
_operator_isNotEqual (const GGS_C_VariableExpression & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
constructor_new (C_Compiler & /* inLexique */
  ...
  macroMyNew (result.mPointer, cPtr_C_trueExpression (THERE)) ;
  return result ;
}
...
_operator_isEqual (const GGS_C_trueExpression & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_C_trueExpression::
_operator_isNotEqual (const GGS_C_trueExpression & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
constructor_new (C_Compiler & /* inLexique */
  ...
  macroMyNew (result.mPointer, cPtr_C_falseExpression (THERE)) ;
  return result ;
}
...
_operator_isEqual (const GGS_C_falseExpression & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_C_falseExpression::
_operator_isNotEqual (const GGS_C_falseExpression & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_L_transitionDefinition & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), isEqualToList (inOperand)) ;
}
...
GGS_bool GGS_L_transitionDefinition::
_operator_isNotEqual (const GGS_L_transitionDefinition & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), ! isEqualToList (inOperand)) ;
}
...
_operator_isEqual (const GGS_L_stateDefinition & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), isEqualToList (inOperand)) ;
}
...
GGS_bool GGS_L_stateDefinition::
_operator_isNotEqual (const GGS_L_stateDefinition & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), ! isEqualToList (inOperand)) ;
}
...
_operator_isEqual (const GGS_L_statesDefinitionList & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), isEqualToList (inOperand)) ;
}
...
GGS_bool GGS_L_statesDefinitionList::
_operator_isNotEqual (const GGS_L_statesDefinitionList & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), ! isEqualToList (inOperand)) ;
}
...
_operator_isEqual (const GGS_AC_machineDefinition & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_AC_machineDefinition::
_operator_isNotEqual (const GGS_AC_machineDefinition & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_ListForModes & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), isEqualToList (inOperand)) ;
}
...
GGS_bool GGS_ListForModes::
_operator_isNotEqual (const GGS_ListForModes & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), ! isEqualToList (inOperand)) ;
}
...
_operator_isEqual (const GGS_C_substractiveModalCompositionComponent & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_C_substractiveModalCompositionComponent::
_operator_isNotEqual (const GGS_C_substractiveModalCompositionComponent & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_C_additiveModalCompositionComponent & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_C_additiveModalCompositionComponent::
_operator_isNotEqual (const GGS_C_additiveModalCompositionComponent & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_C_trans & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_C_trans::
_operator_isNotEqual (const GGS_C_trans & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_C_importMachine & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_C_importMachine::
_operator_isNotEqual (const GGS_C_importMachine & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_C_explicitAutomatonDefinition & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_C_explicitAutomatonDefinition::
_operator_isNotEqual (const GGS_C_explicitAutomatonDefinition & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_C_boolToSeqExpression & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_C_boolToSeqExpression::
_operator_isNotEqual (const GGS_C_boolToSeqExpression & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_C_existsDefinition & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_C_existsDefinition::
_operator_isNotEqual (const GGS_C_existsDefinition & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_C_forallDefinition & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_C_forallDefinition::
_operator_isNotEqual (const GGS_C_forallDefinition & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_C_parallelComposition & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_C_parallelComposition::
_operator_isNotEqual (const GGS_C_parallelComposition & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_C_orComposition & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_C_orComposition::
_operator_isNotEqual (const GGS_C_orComposition & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_C_strongModalComposition & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_C_strongModalComposition::
_operator_isNotEqual (const GGS_C_strongModalComposition & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_C_weakModalComposition & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_C_weakModalComposition::
_operator_isNotEqual (const GGS_C_weakModalComposition & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_C_fullSaturationOperation & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_C_fullSaturationOperation::
_operator_isNotEqual (const GGS_C_fullSaturationOperation & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_C_complementationOperation & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_C_complementationOperation::
_operator_isNotEqual (const GGS_C_complementationOperation & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_C_suppressTerminalStatesOperation & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_C_suppressTerminalStatesOperation::
_operator_isNotEqual (const GGS_C_suppressTerminalStatesOperation & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_C_suppressInitialStatesOperation & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_C_suppressInitialStatesOperation::
_operator_isNotEqual (const GGS_C_suppressInitialStatesOperation & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_AC_job::
_operator_isEqual (const GGS_AC_job & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_AC_job::
_operator_isNotEqual (const GGS_AC_job & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_C_machineCheck::
_operator_isEqual (const GGS_C_machineCheck & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_C_machineCheck::
_operator_isNotEqual (const GGS_C_machineCheck & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_C_machineCheckIdentical & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_C_machineCheckIdentical::
_operator_isNotEqual (const GGS_C_machineCheckIdentical & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_C_machineComponent & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_C_machineComponent::
_operator_isNotEqual (const GGS_C_machineComponent & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_C_machineDefinedByAdditiveModalComp & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_C_machineDefinedByAdditiveModalComp::
_operator_isNotEqual (const GGS_C_machineDefinedByAdditiveModalComp & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_C_machineDefinedBySubstractiveModalComp & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_C_machineDefinedBySubstractiveModalComp::
_operator_isNotEqual (const GGS_C_machineDefinedBySubstractiveModalComp & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_L_inputConfigurationForScenario & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), isEqualToList (inOperand)) ;
}
...
GGS_bool GGS_L_inputConfigurationForScenario::
_operator_isNotEqual (const GGS_L_inputConfigurationForScenario & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), ! isEqualToList (inOperand)) ;
}
...
_operator_isEqual (const GGS_L_inputScenario & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), isEqualToList (inOperand)) ;
}
...
GGS_bool GGS_L_inputScenario::
_operator_isNotEqual (const GGS_L_inputScenario & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), ! isEqualToList (inOperand)) ;
}
...
_operator_isEqual (const GGS_L_scenarioList & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), isEqualToList (inOperand)) ;
}
...
GGS_bool GGS_L_scenarioList::
_operator_isNotEqual (const GGS_L_scenarioList & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), ! isEqualToList (inOperand)) ;
}
...
_operator_isEqual (const GGS_C_scenarioComponent & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_C_scenarioComponent::
_operator_isNotEqual (const GGS_C_scenarioComponent & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_typeResize_AND_cache & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_typeResize_AND_cache::
_operator_isNotEqual (const GGS_typeResize_AND_cache & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_typeResize_ITE_cache & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_typeResize_ITE_cache::
_operator_isNotEqual (const GGS_typeResize_ITE_cache & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_typeResizeMap & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_typeResizeMap::
_operator_isNotEqual (const GGS_typeResizeMap & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
constructor_new (C_Compiler & /* inLexique */
  ...
  macroMyNew (result.mPointer, cPtr_typeDisplayBDDstats (THERE)) ;
  return result ;
}
...
_operator_isEqual (const GGS_typeDisplayBDDstats & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
GGS_bool GGS_typeDisplayBDDstats::
_operator_isNotEqual (const GGS_typeDisplayBDDstats & inOperand) const {
  const bool built = _isBuilt () && inOperand._isBuilt () ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
...
_operator_isEqual (const GGS_L_jobList & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), isEqualToList (inOperand)) ;
}
...
GGS_bool GGS_L_jobList::
_operator_isNotEqual (const GGS_L_jobList & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), ! isEqualToList (inOperand)) ;
}
