...
enumComparisonResult cMapElement_M_5F_variablesMap::compare (const cCollectionElement * inOperand) const {
...
static const utf32 kSearchErrorMessage_M_5F_variablesMap_searchKey [34] = {
  TO_UNICODE ('t'),
  TO_UNICODE ('h'),
  TO_UNICODE ('e'),
  TO_UNICODE (' '),
...
void GALGAS_M_5F_variablesMap::method_searchKey (GALGAS_lstring inKey,
  ...
  const cCollectionElement * attributes = performSearch (inKey, inCompiler, kSearchErrorMessage_M_5F_variablesMap_searchKey COMMA_THERE) ;
  const cMapElement_M_5F_variablesMap * p = (const cMapElement_M_5F_variablesMap *) attributes ;
  if (NULL != p) {
    macroValidObject (p, const cMapElement_M_5F_variablesMap) ;
...
void GALGAS_M_5F_variablesMap::modifier_setMIndexForKey (GALGAS_uint inAttributeValue,
  ...
  if (NULL != p) {
    macroValidObject (p, cMapElement_M_5F_variablesMap) ;
...
cMapElement_M_5F_variablesMap * GALGAS_M_5F_variablesMap::readWriteAccessForWithInstruction_hasKey (C_Compiler * inCompiler,
  ...
  macroNullOrValidObject (result, cMapElement_M_5F_variablesMap) ;
  return result ;
}
...
GALGAS_lstring cEnumerator_M_5F_variablesMap::current_lkey (void) const {
...
GALGAS_uint cEnumerator_M_5F_variablesMap::current_mIndex (void) const {
  const cMapElement_M_5F_variablesMap * p = (const cMapElement_M_5F_variablesMap *) currentObjectPtr () ;
  macroValidObject (p, const cMapElement_M_5F_variablesMap) ;
...
enumComparisonResult cMapElement_M_5F_stateMap::compare (const cCollectionElement * inOperand) const {
...
static const utf32 kSearchErrorMessage_M_5F_stateMap_searchKey [31] = {
  TO_UNICODE ('t'),
  TO_UNICODE ('h'),
  TO_UNICODE ('e'),
  TO_UNICODE (' '),
...
void GALGAS_M_5F_stateMap::method_searchKey (GALGAS_lstring inKey,
                                             ...
                                             C_Compiler * inCompiler
                                             COMMA_LOCATION_ARGS) const {
  const cCollectionElement * attributes = performSearch (inKey, inCompiler, kSearchErrorMessage_M_5F_stateMap_searchKey COMMA_THERE) ;
  const cMapElement_M_5F_stateMap * p = (const cMapElement_M_5F_stateMap *) attributes ;
  if (NULL != p) {
    macroValidObject (p, const cMapElement_M_5F_stateMap) ;
    outArgument0 = p->mAttribute_mIndex ;
  }
}
...
void GALGAS_M_5F_stateMap::modifier_setMIndexForKey (GALGAS_uint inAttributeValue,
  ...
  if (NULL != p) {
    macroValidObject (p, cMapElement_M_5F_stateMap) ;
    p->mAttribute_mIndex = inAttributeValue ;
  }
}
...
cMapElement_M_5F_stateMap * GALGAS_M_5F_stateMap::readWriteAccessForWithInstruction_hasKey (C_Compiler * inCompiler,
  ...
  macroNullOrValidObject (result, cMapElement_M_5F_stateMap) ;
  return result ;
}
...
GALGAS_lstring cEnumerator_M_5F_stateMap::current_lkey (void) const {
  const cMapElement * p = (const cMapElement *) currentObjectPtr () ;
  macroValidObject (p, const cMapElement) ;
  return p->mAttribute_lkey ;
}
...
GALGAS_uint cEnumerator_M_5F_stateMap::current_mIndex (void) const {
  const cMapElement_M_5F_stateMap * p = (const cMapElement_M_5F_stateMap *) currentObjectPtr () ;
  macroValidObject (p, const cMapElement_M_5F_stateMap) ;
  return p->mAttribute_mIndex ;
}
...
enumComparisonResult cCollectionElement_L_5F_translationVector::compare (const cCollectionElement * inOperand) const {
...
void GALGAS_L_5F_translationVector::modifier_popFirst (GALGAS_uint & outOperand0,
  ...
  cCollectionElement_L_5F_translationVector * p = (cCollectionElement_L_5F_translationVector *) attributes.ptrNoVerif () ;
  if (NULL == p) {
    outOperand0.drop () ;
  }else{
    macroValidObject (p, cCollectionElement_L_5F_translationVector) ;
...
void GALGAS_L_5F_translationVector::modifier_setMTargetSlotAtIndex (GALGAS_uint inOperand,
                                                                    GALGAS_uint inIndex,
                                                                    C_Compiler * inCompiler
                                                                    COMMA_LOCATION_ARGS) {
  cCollectionElement_L_5F_translationVector * p = (cCollectionElement_L_5F_translationVector *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidObject (p, cCollectionElement_L_5F_translationVector) ;
    p->mAttribute_mTargetSlot = inOperand ;
  }
}
...
GALGAS_uint cEnumerator_L_5F_translationVector::current_mTargetSlot (void) const {
  const cCollectionElement_L_5F_translationVector * p = (const cCollectionElement_L_5F_translationVector *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_L_5F_translationVector) ;
...
enumComparisonResult cCollectionElement_L_5F_transitionDefinition::compare (const cCollectionElement * inOperand) const {
...
void GALGAS_L_5F_transitionDefinition::modifier_popFirst (GALGAS_AC_5F_boolExpression & outOperand0,
  ...
  capCollectionElement attributes ;
  removeFirstObject (attributes, inCompiler COMMA_THERE) ;
  cCollectionElement_L_5F_transitionDefinition * p = (cCollectionElement_L_5F_transitionDefinition *) attributes.ptrNoVerif () ;
  if (NULL == p) {
    outOperand0.drop () ;
    outOperand1.drop () ;
    outOperand2.drop () ;
  }else{
    macroValidObject (p, cCollectionElement_L_5F_transitionDefinition) ;
...
void GALGAS_L_5F_transitionDefinition::modifier_setMActionExpressionAtIndex (GALGAS_AC_5F_boolExpression inOperand,
                                                                             GALGAS_uint inIndex,
                                                                             C_Compiler * inCompiler
                                                                             COMMA_LOCATION_ARGS) {
  cCollectionElement_L_5F_transitionDefinition * p = (cCollectionElement_L_5F_transitionDefinition *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidObject (p, cCollectionElement_L_5F_transitionDefinition) ;
    p->mAttribute_mActionExpression = inOperand ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_L_5F_transitionDefinition::modifier_setMEndOfExpressionAtIndex (GALGAS_location inOperand,
                                                                            GALGAS_uint inIndex,
                                                                            C_Compiler * inCompiler
                                                                            COMMA_LOCATION_ARGS) {
  cCollectionElement_L_5F_transitionDefinition * p = (cCollectionElement_L_5F_transitionDefinition *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidObject (p, cCollectionElement_L_5F_transitionDefinition) ;
    p->mAttribute_mEndOfExpression = inOperand ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_L_5F_transitionDefinition::modifier_setMTargetStateIndexAtIndex (GALGAS_uint inOperand,
                                                                             GALGAS_uint inIndex,
                                                                             C_Compiler * inCompiler
                                                                             COMMA_LOCATION_ARGS) {
  cCollectionElement_L_5F_transitionDefinition * p = (cCollectionElement_L_5F_transitionDefinition *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidObject (p, cCollectionElement_L_5F_transitionDefinition) ;
    p->mAttribute_mTargetStateIndex = inOperand ;
  }
}
...
GALGAS_AC_5F_boolExpression cEnumerator_L_5F_transitionDefinition::current_mActionExpression (void) const {
  const cCollectionElement_L_5F_transitionDefinition * p = (const cCollectionElement_L_5F_transitionDefinition *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_L_5F_transitionDefinition) ;
  return p->mAttribute_mActionExpression ;
}

//---------------------------------------------------------------------------*

GALGAS_location cEnumerator_L_5F_transitionDefinition::current_mEndOfExpression (void) const {
  const cCollectionElement_L_5F_transitionDefinition * p = (const cCollectionElement_L_5F_transitionDefinition *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_L_5F_transitionDefinition) ;
...
GALGAS_uint cEnumerator_L_5F_transitionDefinition::current_mTargetStateIndex (void) const {
  const cCollectionElement_L_5F_transitionDefinition * p = (const cCollectionElement_L_5F_transitionDefinition *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_L_5F_transitionDefinition) ;
...
enumComparisonResult cCollectionElement_L_5F_stateDefinition::compare (const cCollectionElement * inOperand) const {
...
void GALGAS_L_5F_stateDefinition::modifier_popFirst (GALGAS_uint & outOperand0,
  ...
  capCollectionElement attributes ;
  removeFirstObject (attributes, inCompiler COMMA_THERE) ;
  cCollectionElement_L_5F_stateDefinition * p = (cCollectionElement_L_5F_stateDefinition *) attributes.ptrNoVerif () ;
  if (NULL == p) {
    outOperand0.drop () ;
    outOperand1.drop () ;
    outOperand2.drop () ;
    ...
    macroValidObject (p, cCollectionElement_L_5F_stateDefinition) ;
...
void GALGAS_L_5F_stateDefinition::modifier_setMStateIndexAtIndex (GALGAS_uint inOperand,
                                                                  GALGAS_uint inIndex,
                                                                  C_Compiler * inCompiler
                                                                  COMMA_LOCATION_ARGS) {
  cCollectionElement_L_5F_stateDefinition * p = (cCollectionElement_L_5F_stateDefinition *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidObject (p, cCollectionElement_L_5F_stateDefinition) ;
    p->mAttribute_mStateIndex = inOperand ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_L_5F_stateDefinition::modifier_setMStateExpressionAtIndex (GALGAS_AC_5F_boolExpression inOperand,
                                                                       GALGAS_uint inIndex,
                                                                       C_Compiler * inCompiler
                                                                       COMMA_LOCATION_ARGS) {
  cCollectionElement_L_5F_stateDefinition * p = (cCollectionElement_L_5F_stateDefinition *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidObject (p, cCollectionElement_L_5F_stateDefinition) ;
    p->mAttribute_mStateExpression = inOperand ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_L_5F_stateDefinition::modifier_setMEndOfStateExpressionAtIndex (GALGAS_location inOperand,
                                                                            GALGAS_uint inIndex,
                                                                            C_Compiler * inCompiler
                                                                            COMMA_LOCATION_ARGS) {
  cCollectionElement_L_5F_stateDefinition * p = (cCollectionElement_L_5F_stateDefinition *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidObject (p, cCollectionElement_L_5F_stateDefinition) ;
    p->mAttribute_mEndOfStateExpression = inOperand ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_L_5F_stateDefinition::modifier_setMTransitionsListAtIndex (GALGAS_L_5F_transitionDefinition inOperand,
                                                                       GALGAS_uint inIndex,
                                                                       C_Compiler * inCompiler
                                                                       COMMA_LOCATION_ARGS) {
  cCollectionElement_L_5F_stateDefinition * p = (cCollectionElement_L_5F_stateDefinition *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidObject (p, cCollectionElement_L_5F_stateDefinition) ;
    p->mAttribute_mTransitionsList = inOperand ;
  }
}
...
GALGAS_uint cEnumerator_L_5F_stateDefinition::current_mStateIndex (void) const {
  const cCollectionElement_L_5F_stateDefinition * p = (const cCollectionElement_L_5F_stateDefinition *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_L_5F_stateDefinition) ;
  return p->mAttribute_mStateIndex ;
}

//---------------------------------------------------------------------------*

GALGAS_AC_5F_boolExpression cEnumerator_L_5F_stateDefinition::current_mStateExpression (void) const {
  const cCollectionElement_L_5F_stateDefinition * p = (const cCollectionElement_L_5F_stateDefinition *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_L_5F_stateDefinition) ;
...
GALGAS_location cEnumerator_L_5F_stateDefinition::current_mEndOfStateExpression (void) const {
  const cCollectionElement_L_5F_stateDefinition * p = (const cCollectionElement_L_5F_stateDefinition *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_L_5F_stateDefinition) ;
...
GALGAS_L_5F_transitionDefinition cEnumerator_L_5F_stateDefinition::current_mTransitionsList (void) const {
  const cCollectionElement_L_5F_stateDefinition * p = (const cCollectionElement_L_5F_stateDefinition *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_L_5F_stateDefinition) ;
...
enumComparisonResult cCollectionElement_L_5F_statesDefinitionList::compare (const cCollectionElement * inOperand) const {
...
void GALGAS_L_5F_statesDefinitionList::modifier_popFirst (GALGAS_uint & outOperand0,
  ...
  capCollectionElement attributes ;
  removeFirstObject (attributes, inCompiler COMMA_THERE) ;
  cCollectionElement_L_5F_statesDefinitionList * p = (cCollectionElement_L_5F_statesDefinitionList *) attributes.ptrNoVerif () ;
  if (NULL == p) {
    outOperand0.drop () ;
    outOperand1.drop () ;
  }else{
    macroValidObject (p, cCollectionElement_L_5F_statesDefinitionList) ;
    outOperand0 = p->mAttribute_mStateIndex ;
...
void GALGAS_L_5F_statesDefinitionList::modifier_setMStateIndexAtIndex (GALGAS_uint inOperand,
                                                                       GALGAS_uint inIndex,
                                                                       C_Compiler * inCompiler
                                                                       COMMA_LOCATION_ARGS) {
  cCollectionElement_L_5F_statesDefinitionList * p = (cCollectionElement_L_5F_statesDefinitionList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidObject (p, cCollectionElement_L_5F_statesDefinitionList) ;
    p->mAttribute_mStateIndex = inOperand ;
  }
...
void GALGAS_L_5F_statesDefinitionList::modifier_setMStateLocationAtIndex (GALGAS_location inOperand,
                                                                          GALGAS_uint inIndex,
                                                                          C_Compiler * inCompiler
                                                                          COMMA_LOCATION_ARGS) {
  cCollectionElement_L_5F_statesDefinitionList * p = (cCollectionElement_L_5F_statesDefinitionList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidObject (p, cCollectionElement_L_5F_statesDefinitionList) ;
    p->mAttribute_mStateLocation = inOperand ;
  }
}
...
GALGAS_uint cEnumerator_L_5F_statesDefinitionList::current_mStateIndex (void) const {
  const cCollectionElement_L_5F_statesDefinitionList * p = (const cCollectionElement_L_5F_statesDefinitionList *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_L_5F_statesDefinitionList) ;
  return p->mAttribute_mStateIndex ;
}

//---------------------------------------------------------------------------*

GALGAS_location cEnumerator_L_5F_statesDefinitionList::current_mStateLocation (void) const {
  const cCollectionElement_L_5F_statesDefinitionList * p = (const cCollectionElement_L_5F_statesDefinitionList *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_L_5F_statesDefinitionList) ;
...
enumComparisonResult cMapElement_M_5F_modesMap::compare (const cCollectionElement * inOperand) const {
...
static const utf32 kSearchErrorMessage_M_5F_modesMap_searchKey [30] = {
  TO_UNICODE ('t'),
  TO_UNICODE ('h'),
  TO_UNICODE ('e'),
  TO_UNICODE (' '),
...
void GALGAS_M_5F_modesMap::method_searchKey (GALGAS_lstring inKey,
                                             ...
                                             C_Compiler * inCompiler
                                             COMMA_LOCATION_ARGS) const {
  const cCollectionElement * attributes = performSearch (inKey, inCompiler, kSearchErrorMessage_M_5F_modesMap_searchKey COMMA_THERE) ;
  const cMapElement_M_5F_modesMap * p = (const cMapElement_M_5F_modesMap *) attributes ;
  if (NULL != p) {
    macroValidObject (p, const cMapElement_M_5F_modesMap) ;
    outArgument0 = p->mAttribute_mIndex ;
...
void GALGAS_M_5F_modesMap::modifier_setMIndexForKey (GALGAS_uint inAttributeValue,
  ...
  if (NULL != p) {
    macroValidObject (p, cMapElement_M_5F_modesMap) ;
    p->mAttribute_mIndex = inAttributeValue ;
  }
}
...
cMapElement_M_5F_modesMap * GALGAS_M_5F_modesMap::readWriteAccessForWithInstruction_hasKey (C_Compiler * inCompiler,
  ...
  macroNullOrValidObject (result, cMapElement_M_5F_modesMap) ;
  return result ;
}
...
GALGAS_lstring cEnumerator_M_5F_modesMap::current_lkey (void) const {
  const cMapElement * p = (const cMapElement *) currentObjectPtr () ;
  macroValidObject (p, const cMapElement) ;
  return p->mAttribute_lkey ;
}
...
GALGAS_uint cEnumerator_M_5F_modesMap::current_mIndex (void) const {
  const cMapElement_M_5F_modesMap * p = (const cMapElement_M_5F_modesMap *) currentObjectPtr () ;
  macroValidObject (p, const cMapElement_M_5F_modesMap) ;
  return p->mAttribute_mIndex ;
}
...
GALGAS_AC_5F_machineDefinition cEnumerator_M_5F_modesMap::current_mModeDefinition (void) const {
  const cMapElement_M_5F_modesMap * p = (const cMapElement_M_5F_modesMap *) currentObjectPtr () ;
  macroValidObject (p, const cMapElement_M_5F_modesMap) ;
...
enumComparisonResult cCollectionElement_ListForModes::compare (const cCollectionElement * inOperand) const {
...
void GALGAS_ListForModes::modifier_popFirst (GALGAS_uint & outOperand0,
  ...
  capCollectionElement attributes ;
  removeFirstObject (attributes, inCompiler COMMA_THERE) ;
  cCollectionElement_ListForModes * p = (cCollectionElement_ListForModes *) attributes.ptrNoVerif () ;
  if (NULL == p) {
    outOperand0.drop () ;
    outOperand1.drop () ;
  }else{
    macroValidObject (p, cCollectionElement_ListForModes) ;
...
void GALGAS_ListForModes::modifier_setMSourceModeAtIndex (GALGAS_uint inOperand,
                                                          GALGAS_uint inIndex,
                                                          C_Compiler * inCompiler
                                                          COMMA_LOCATION_ARGS) {
  cCollectionElement_ListForModes * p = (cCollectionElement_ListForModes *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidObject (p, cCollectionElement_ListForModes) ;
    p->mAttribute_mSourceMode = inOperand ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_ListForModes::modifier_setMTargetModeAtIndex (GALGAS_uint inOperand,
                                                          GALGAS_uint inIndex,
                                                          C_Compiler * inCompiler
                                                          COMMA_LOCATION_ARGS) {
  cCollectionElement_ListForModes * p = (cCollectionElement_ListForModes *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidObject (p, cCollectionElement_ListForModes) ;
    p->mAttribute_mTargetMode = inOperand ;
  }
}
...
GALGAS_uint cEnumerator_ListForModes::current_mSourceMode (void) const {
  const cCollectionElement_ListForModes * p = (const cCollectionElement_ListForModes *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_ListForModes) ;
  return p->mAttribute_mSourceMode ;
}

//---------------------------------------------------------------------------*

GALGAS_uint cEnumerator_ListForModes::current_mTargetMode (void) const {
  const cCollectionElement_ListForModes * p = (const cCollectionElement_ListForModes *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_ListForModes) ;
...
enumComparisonResult cCollectionElement_L_5F_inputConfigurationForScenario::compare (const cCollectionElement * inOperand) const {
...
void GALGAS_L_5F_inputConfigurationForScenario::modifier_popFirst (GALGAS_luint & outOperand0,
  ...
  capCollectionElement attributes ;
  removeFirstObject (attributes, inCompiler COMMA_THERE) ;
  cCollectionElement_L_5F_inputConfigurationForScenario * p = (cCollectionElement_L_5F_inputConfigurationForScenario *) attributes.ptrNoVerif () ;
  if (NULL == p) {
    outOperand0.drop () ;
  }else{
    macroValidObject (p, cCollectionElement_L_5F_inputConfigurationForScenario) ;
...
void GALGAS_L_5F_inputConfigurationForScenario::modifier_setMInputValueAtIndex (GALGAS_luint inOperand,
                                                                                GALGAS_uint inIndex,
                                                                                C_Compiler * inCompiler
                                                                                COMMA_LOCATION_ARGS) {
  cCollectionElement_L_5F_inputConfigurationForScenario * p = (cCollectionElement_L_5F_inputConfigurationForScenario *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidObject (p, cCollectionElement_L_5F_inputConfigurationForScenario) ;
    p->mAttribute_mInputValue = inOperand ;
  }
}
...
GALGAS_luint cEnumerator_L_5F_inputConfigurationForScenario::current_mInputValue (void) const {
  const cCollectionElement_L_5F_inputConfigurationForScenario * p = (const cCollectionElement_L_5F_inputConfigurationForScenario *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_L_5F_inputConfigurationForScenario) ;
...
enumComparisonResult cCollectionElement_L_5F_inputScenario::compare (const cCollectionElement * inOperand) const {
...
void GALGAS_L_5F_inputScenario::modifier_popFirst (GALGAS_L_5F_inputConfigurationForScenario & outOperand0,
  ...
  capCollectionElement attributes ;
  removeFirstObject (attributes, inCompiler COMMA_THERE) ;
  cCollectionElement_L_5F_inputScenario * p = (cCollectionElement_L_5F_inputScenario *) attributes.ptrNoVerif () ;
  if (NULL == p) {
    outOperand0.drop () ;
  }else{
    macroValidObject (p, cCollectionElement_L_5F_inputScenario) ;
...
void GALGAS_L_5F_inputScenario::modifier_setMInputConfigurationAtIndex (GALGAS_L_5F_inputConfigurationForScenario inOperand,
                                                                        GALGAS_uint inIndex,
                                                                        C_Compiler * inCompiler
                                                                        COMMA_LOCATION_ARGS) {
  cCollectionElement_L_5F_inputScenario * p = (cCollectionElement_L_5F_inputScenario *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidObject (p, cCollectionElement_L_5F_inputScenario) ;
    p->mAttribute_mInputConfiguration = inOperand ;
  }
}
...
GALGAS_L_5F_inputConfigurationForScenario cEnumerator_L_5F_inputScenario::current_mInputConfiguration (void) const {
  const cCollectionElement_L_5F_inputScenario * p = (const cCollectionElement_L_5F_inputScenario *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_L_5F_inputScenario) ;
...
enumComparisonResult cCollectionElement_L_5F_scenarioList::compare (const cCollectionElement * inOperand) const {
...
void GALGAS_L_5F_scenarioList::modifier_popFirst (GALGAS_lstring & outOperand0,
  ...
  capCollectionElement attributes ;
  removeFirstObject (attributes, inCompiler COMMA_THERE) ;
  cCollectionElement_L_5F_scenarioList * p = (cCollectionElement_L_5F_scenarioList *) attributes.ptrNoVerif () ;
  if (NULL == p) {
    outOperand0.drop () ;
    outOperand1.drop () ;
  }else{
    macroValidObject (p, cCollectionElement_L_5F_scenarioList) ;
...
void GALGAS_L_5F_scenarioList::modifier_setMScenarioTitleAtIndex (GALGAS_lstring inOperand,
                                                                  GALGAS_uint inIndex,
                                                                  C_Compiler * inCompiler
                                                                  COMMA_LOCATION_ARGS) {
  cCollectionElement_L_5F_scenarioList * p = (cCollectionElement_L_5F_scenarioList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidObject (p, cCollectionElement_L_5F_scenarioList) ;
    p->mAttribute_mScenarioTitle = inOperand ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_L_5F_scenarioList::modifier_setMInputScenarioAtIndex (GALGAS_L_5F_inputScenario inOperand,
                                                                  GALGAS_uint inIndex,
                                                                  C_Compiler * inCompiler
                                                                  COMMA_LOCATION_ARGS) {
  cCollectionElement_L_5F_scenarioList * p = (cCollectionElement_L_5F_scenarioList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidObject (p, cCollectionElement_L_5F_scenarioList) ;
    p->mAttribute_mInputScenario = inOperand ;
  }
}
...
GALGAS_lstring cEnumerator_L_5F_scenarioList::current_mScenarioTitle (void) const {
  const cCollectionElement_L_5F_scenarioList * p = (const cCollectionElement_L_5F_scenarioList *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_L_5F_scenarioList) ;
  return p->mAttribute_mScenarioTitle ;
}

//---------------------------------------------------------------------------*

GALGAS_L_5F_inputScenario cEnumerator_L_5F_scenarioList::current_mInputScenario (void) const {
  const cCollectionElement_L_5F_scenarioList * p = (const cCollectionElement_L_5F_scenarioList *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_L_5F_scenarioList) ;
...
enumComparisonResult cCollectionElement_L_5F_jobList::compare (const cCollectionElement * inOperand) const {
...
void GALGAS_L_5F_jobList::modifier_popFirst (GALGAS_AC_5F_job & outOperand0,
  ...
  capCollectionElement attributes ;
  removeFirstObject (attributes, inCompiler COMMA_THERE) ;
  cCollectionElement_L_5F_jobList * p = (cCollectionElement_L_5F_jobList *) attributes.ptrNoVerif () ;
  if (NULL == p) {
    outOperand0.drop () ;
  }else{
    macroValidObject (p, cCollectionElement_L_5F_jobList) ;
...
void GALGAS_L_5F_jobList::modifier_setMComponentAtIndex (GALGAS_AC_5F_job inOperand,
                                                         GALGAS_uint inIndex,
                                                         C_Compiler * inCompiler
                                                         COMMA_LOCATION_ARGS) {
  cCollectionElement_L_5F_jobList * p = (cCollectionElement_L_5F_jobList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidObject (p, cCollectionElement_L_5F_jobList) ;
    p->mAttribute_mComponent = inOperand ;
  }
}
...
GALGAS_AC_5F_job cEnumerator_L_5F_jobList::current_mComponent (void) const {
  const cCollectionElement_L_5F_jobList * p = (const cCollectionElement_L_5F_jobList *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_L_5F_jobList) ;
...
enumComparisonResult cMapElement_M_5F_machinesMap::compare (const cCollectionElement * inOperand) const {
...
static const utf32 kSearchErrorMessage_M_5F_machinesMap_searchKey [32] = {
  TO_UNICODE ('t'),
  TO_UNICODE ('h'),
  TO_UNICODE ('e'),
  TO_UNICODE (' '),
...
void GALGAS_M_5F_machinesMap::method_searchKey (GALGAS_lstring inKey,
                                                ...
                                                C_Compiler * inCompiler
                                                COMMA_LOCATION_ARGS) const {
  const cCollectionElement * attributes = performSearch (inKey, inCompiler, kSearchErrorMessage_M_5F_machinesMap_searchKey COMMA_THERE) ;
  const cMapElement_M_5F_machinesMap * p = (const cMapElement_M_5F_machinesMap *) attributes ;
  if (NULL != p) {
    macroValidObject (p, const cMapElement_M_5F_machinesMap) ;
    outArgument0 = p->mAttribute_mIndex ;
...
void GALGAS_M_5F_machinesMap::modifier_removeKey (GALGAS_lstring inKey,
                                                  ...
                                                  C_Compiler * inCompiler
                                                  COMMA_LOCATION_ARGS) {
  const utf32 kRemoveErrorMessage [32] = {
    TO_UNICODE ('t'),
    TO_UNICODE ('h'),
    TO_UNICODE ('e'),
    TO_UNICODE (' '),
  ...
  cMapElement_M_5F_machinesMap * p = (cMapElement_M_5F_machinesMap *) attributes.ptrNoVerif () ;
  if (NULL != p) {
    macroValidObject (p, cMapElement_M_5F_machinesMap) ;
    outArgument0 = p->mAttribute_mIndex ;
    outArgument1 = p->mAttribute_mInputVariableCount ;
    outArgument2 = p->mAttribute_mInputAndInternalVariableCount ;
    outArgument3 = p->mAttribute_mVariablesMap ;
...
cMapElement_M_5F_machinesMap * GALGAS_M_5F_machinesMap::readWriteAccessForWithInstruction_hasKey (C_Compiler * inCompiler,
  ...
  macroNullOrValidObject (result, cMapElement_M_5F_machinesMap) ;
  return result ;
}
...
GALGAS_lstring cEnumerator_M_5F_machinesMap::current_lkey (void) const {
  const cMapElement * p = (const cMapElement *) currentObjectPtr () ;
  macroValidObject (p, const cMapElement) ;
  return p->mAttribute_lkey ;
}
...
GALGAS_uint cEnumerator_M_5F_machinesMap::current_mIndex (void) const {
  const cMapElement_M_5F_machinesMap * p = (const cMapElement_M_5F_machinesMap *) currentObjectPtr () ;
  macroValidObject (p, const cMapElement_M_5F_machinesMap) ;
  return p->mAttribute_mIndex ;
}
...
GALGAS_uint cEnumerator_M_5F_machinesMap::current_mInputVariableCount (void) const {
  const cMapElement_M_5F_machinesMap * p = (const cMapElement_M_5F_machinesMap *) currentObjectPtr () ;
  macroValidObject (p, const cMapElement_M_5F_machinesMap) ;
...
GALGAS_uint cEnumerator_M_5F_machinesMap::current_mInputAndInternalVariableCount (void) const {
  const cMapElement_M_5F_machinesMap * p = (const cMapElement_M_5F_machinesMap *) currentObjectPtr () ;
  macroValidObject (p, const cMapElement_M_5F_machinesMap) ;
...
GALGAS_M_5F_variablesMap cEnumerator_M_5F_machinesMap::current_mVariablesMap (void) const {
  const cMapElement_M_5F_machinesMap * p = (const cMapElement_M_5F_machinesMap *) currentObjectPtr () ;
  macroValidObject (p, const cMapElement_M_5F_machinesMap) ;
...
enumComparisonResult GALGAS_AC_5F_boolExpression::objectCompare (const GALGAS_AC_5F_boolExpression & inOperand) const {
...
AC_GALGAS_class (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_AC_5F_boolExpression) ;
}
...
enumComparisonResult GALGAS_C_5F_VariableExpression::objectCompare (const GALGAS_C_5F_VariableExpression & inOperand) const {
  enumComparisonResult result = GALGAS_AC_5F_boolExpression::objectCompare (inOperand) ;
  const cPtr_C_5F_VariableExpression * p = (const cPtr_C_5F_VariableExpression *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_C_5F_VariableExpression) ;
  const cPtr_C_5F_VariableExpression * q = (const cPtr_C_5F_VariableExpression *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_C_5F_VariableExpression) ;
  if (kOperandEqual == result) {
...
GALGAS_AC_5F_boolExpression (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_C_5F_VariableExpression) ;
}
...
void GALGAS_C_5F_VariableExpression::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_C_5F_VariableExpression) ;
...
GALGAS_uint GALGAS_C_5F_VariableExpression::reader_mInputVarIndex (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_C_5F_VariableExpression * p = (const cPtr_C_5F_VariableExpression *) mObjectPtr ;
    macroValidObject (p, const cPtr_C_5F_VariableExpression) ;
...
enumComparisonResult GALGAS_C_5F_andExpression::objectCompare (const GALGAS_C_5F_andExpression & inOperand) const {
  enumComparisonResult result = GALGAS_AC_5F_boolExpression::objectCompare (inOperand) ;
  const cPtr_C_5F_andExpression * p = (const cPtr_C_5F_andExpression *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_C_5F_andExpression) ;
  const cPtr_C_5F_andExpression * q = (const cPtr_C_5F_andExpression *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_C_5F_andExpression) ;
  if (kOperandEqual == result) {
...
GALGAS_AC_5F_boolExpression (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_C_5F_andExpression) ;
}
...
void GALGAS_C_5F_andExpression::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_C_5F_andExpression) ;
...
GALGAS_AC_5F_boolExpression GALGAS_C_5F_andExpression::reader_mLeftExpression (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_C_5F_andExpression * p = (const cPtr_C_5F_andExpression *) mObjectPtr ;
    macroValidObject (p, const cPtr_C_5F_andExpression) ;
...
enumComparisonResult GALGAS_C_5F_equalExpression::objectCompare (const GALGAS_C_5F_equalExpression & inOperand) const {
  enumComparisonResult result = GALGAS_AC_5F_boolExpression::objectCompare (inOperand) ;
  const cPtr_C_5F_equalExpression * p = (const cPtr_C_5F_equalExpression *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_C_5F_equalExpression) ;
  const cPtr_C_5F_equalExpression * q = (const cPtr_C_5F_equalExpression *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_C_5F_equalExpression) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mLeftExpression.objectCompare (q->mAttribute_mLeftExpression) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_AC_5F_boolExpression (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_C_5F_equalExpression) ;
}
...
void GALGAS_C_5F_equalExpression::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_C_5F_equalExpression) ;
...
GALGAS_AC_5F_boolExpression GALGAS_C_5F_equalExpression::reader_mLeftExpression (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_C_5F_equalExpression * p = (const cPtr_C_5F_equalExpression *) mObjectPtr ;
    macroValidObject (p, const cPtr_C_5F_equalExpression) ;
    result = p->mAttribute_mLeftExpression ;
  }
  return result ;
}
...
enumComparisonResult GALGAS_C_5F_falseExpression::objectCompare (const GALGAS_C_5F_falseExpression & inOperand) const {
  return (isValid () && inOperand.isValid ()) ? kOperandEqual : kOperandNotValid ;
}
...
GALGAS_AC_5F_boolExpression (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_C_5F_falseExpression) ;
}
...
enumComparisonResult GALGAS_C_5F_impliesExpression::objectCompare (const GALGAS_C_5F_impliesExpression & inOperand) const {
  enumComparisonResult result = GALGAS_AC_5F_boolExpression::objectCompare (inOperand) ;
  const cPtr_C_5F_impliesExpression * p = (const cPtr_C_5F_impliesExpression *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_C_5F_impliesExpression) ;
  const cPtr_C_5F_impliesExpression * q = (const cPtr_C_5F_impliesExpression *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_C_5F_impliesExpression) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mLeftExpression.objectCompare (q->mAttribute_mLeftExpression) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_AC_5F_boolExpression (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_C_5F_impliesExpression) ;
}
...
void GALGAS_C_5F_impliesExpression::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_C_5F_impliesExpression) ;
...
GALGAS_AC_5F_boolExpression GALGAS_C_5F_impliesExpression::reader_mLeftExpression (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_C_5F_impliesExpression * p = (const cPtr_C_5F_impliesExpression *) mObjectPtr ;
    macroValidObject (p, const cPtr_C_5F_impliesExpression) ;
    result = p->mAttribute_mLeftExpression ;
  }
  return result ;
}
...
enumComparisonResult GALGAS_C_5F_importBoolMachine::objectCompare (const GALGAS_C_5F_importBoolMachine & inOperand) const {
  enumComparisonResult result = GALGAS_AC_5F_boolExpression::objectCompare (inOperand) ;
  const cPtr_C_5F_importBoolMachine * p = (const cPtr_C_5F_importBoolMachine *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_C_5F_importBoolMachine) ;
  const cPtr_C_5F_importBoolMachine * q = (const cPtr_C_5F_importBoolMachine *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_C_5F_importBoolMachine) ;
  if (kOperandEqual == result) {
...
GALGAS_AC_5F_boolExpression (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_C_5F_importBoolMachine) ;
}
...
void GALGAS_C_5F_importBoolMachine::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_C_5F_importBoolMachine) ;
...
GALGAS_uint GALGAS_C_5F_importBoolMachine::reader_mIndexOfImportedMachine (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_C_5F_importBoolMachine * p = (const cPtr_C_5F_importBoolMachine *) mObjectPtr ;
    macroValidObject (p, const cPtr_C_5F_importBoolMachine) ;
...
enumComparisonResult GALGAS_C_5F_notExpression::objectCompare (const GALGAS_C_5F_notExpression & inOperand) const {
  enumComparisonResult result = GALGAS_AC_5F_boolExpression::objectCompare (inOperand) ;
  const cPtr_C_5F_notExpression * p = (const cPtr_C_5F_notExpression *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_C_5F_notExpression) ;
  const cPtr_C_5F_notExpression * q = (const cPtr_C_5F_notExpression *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_C_5F_notExpression) ;
  if (kOperandEqual == result) {
...
GALGAS_AC_5F_boolExpression (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_C_5F_notExpression) ;
}
...
void GALGAS_C_5F_notExpression::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_C_5F_notExpression) ;
...
GALGAS_AC_5F_boolExpression GALGAS_C_5F_notExpression::reader_mExpression (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_C_5F_notExpression * p = (const cPtr_C_5F_notExpression *) mObjectPtr ;
    macroValidObject (p, const cPtr_C_5F_notExpression) ;
...
enumComparisonResult GALGAS_C_5F_orExpression::objectCompare (const GALGAS_C_5F_orExpression & inOperand) const {
  enumComparisonResult result = GALGAS_AC_5F_boolExpression::objectCompare (inOperand) ;
  const cPtr_C_5F_orExpression * p = (const cPtr_C_5F_orExpression *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_C_5F_orExpression) ;
  const cPtr_C_5F_orExpression * q = (const cPtr_C_5F_orExpression *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_C_5F_orExpression) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mLeftExpression.objectCompare (q->mAttribute_mLeftExpression) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_AC_5F_boolExpression (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_C_5F_orExpression) ;
}
...
void GALGAS_C_5F_orExpression::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_C_5F_orExpression) ;
...
GALGAS_AC_5F_boolExpression GALGAS_C_5F_orExpression::reader_mLeftExpression (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_C_5F_orExpression * p = (const cPtr_C_5F_orExpression *) mObjectPtr ;
    macroValidObject (p, const cPtr_C_5F_orExpression) ;
    result = p->mAttribute_mLeftExpression ;
  }
  return result ;
}
...
enumComparisonResult GALGAS_C_5F_trueExpression::objectCompare (const GALGAS_C_5F_trueExpression & inOperand) const {
  return (isValid () && inOperand.isValid ()) ? kOperandEqual : kOperandNotValid ;
}
...
GALGAS_AC_5F_boolExpression (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_C_5F_trueExpression) ;
}
...
enumComparisonResult GALGAS_C_5F_xorExpression::objectCompare (const GALGAS_C_5F_xorExpression & inOperand) const {
  enumComparisonResult result = GALGAS_AC_5F_boolExpression::objectCompare (inOperand) ;
  const cPtr_C_5F_xorExpression * p = (const cPtr_C_5F_xorExpression *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_C_5F_xorExpression) ;
  const cPtr_C_5F_xorExpression * q = (const cPtr_C_5F_xorExpression *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_C_5F_xorExpression) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mLeftExpression.objectCompare (q->mAttribute_mLeftExpression) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_AC_5F_boolExpression (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_C_5F_xorExpression) ;
}
...
void GALGAS_C_5F_xorExpression::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_C_5F_xorExpression) ;
...
GALGAS_AC_5F_boolExpression GALGAS_C_5F_xorExpression::reader_mLeftExpression (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_C_5F_xorExpression * p = (const cPtr_C_5F_xorExpression *) mObjectPtr ;
    macroValidObject (p, const cPtr_C_5F_xorExpression) ;
    result = p->mAttribute_mLeftExpression ;
  }
  return result ;
}
...
enumComparisonResult GALGAS_AC_5F_job::objectCompare (const GALGAS_AC_5F_job & inOperand) const {
  return (isValid () && inOperand.isValid ()) ? kOperandEqual : kOperandNotValid ;
}
...
AC_GALGAS_class (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_AC_5F_job) ;
}
...
enumComparisonResult GALGAS_C_5F_machineCheck::objectCompare (const GALGAS_C_5F_machineCheck & inOperand) const {
  enumComparisonResult result = GALGAS_AC_5F_job::objectCompare (inOperand) ;
  const cPtr_C_5F_machineCheck * p = (const cPtr_C_5F_machineCheck *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_C_5F_machineCheck) ;
  const cPtr_C_5F_machineCheck * q = (const cPtr_C_5F_machineCheck *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_C_5F_machineCheck) ;
  if (kOperandEqual == result) {
...
GALGAS_AC_5F_job (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_C_5F_machineCheck) ;
}
...
void GALGAS_C_5F_machineCheck::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_C_5F_machineCheck) ;
...
GALGAS_uint GALGAS_C_5F_machineCheck::reader_mMachineIndex (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_C_5F_machineCheck * p = (const cPtr_C_5F_machineCheck *) mObjectPtr ;
    macroValidObject (p, const cPtr_C_5F_machineCheck) ;
...
enumComparisonResult GALGAS_C_5F_machineCheckIdentical::objectCompare (const GALGAS_C_5F_machineCheckIdentical & inOperand) const {
  enumComparisonResult result = GALGAS_AC_5F_job::objectCompare (inOperand) ;
  const cPtr_C_5F_machineCheckIdentical * p = (const cPtr_C_5F_machineCheckIdentical *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_C_5F_machineCheckIdentical) ;
  const cPtr_C_5F_machineCheckIdentical * q = (const cPtr_C_5F_machineCheckIdentical *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_C_5F_machineCheckIdentical) ;
  if (kOperandEqual == result) {
...
GALGAS_AC_5F_job (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_C_5F_machineCheckIdentical) ;
}
...
void GALGAS_C_5F_machineCheckIdentical::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_C_5F_machineCheckIdentical) ;
...
GALGAS_uint GALGAS_C_5F_machineCheckIdentical::reader_mMachineIndex_31_ (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_C_5F_machineCheckIdentical * p = (const cPtr_C_5F_machineCheckIdentical *) mObjectPtr ;
    macroValidObject (p, const cPtr_C_5F_machineCheckIdentical) ;
...
enumComparisonResult GALGAS_C_5F_machineComponent::objectCompare (const GALGAS_C_5F_machineComponent & inOperand) const {
  enumComparisonResult result = GALGAS_AC_5F_job::objectCompare (inOperand) ;
  const cPtr_C_5F_machineComponent * p = (const cPtr_C_5F_machineComponent *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_C_5F_machineComponent) ;
  const cPtr_C_5F_machineComponent * q = (const cPtr_C_5F_machineComponent *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_C_5F_machineComponent) ;
  if (kOperandEqual == result) {
...
GALGAS_AC_5F_job (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_C_5F_machineComponent) ;
}
...
void GALGAS_C_5F_machineComponent::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_C_5F_machineComponent) ;
...
GALGAS_lstring GALGAS_C_5F_machineComponent::reader_mMachineName (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_C_5F_machineComponent * p = (const cPtr_C_5F_machineComponent *) mObjectPtr ;
    macroValidObject (p, const cPtr_C_5F_machineComponent) ;
...
enumComparisonResult GALGAS_C_5F_machineDefinedByAdditiveModalComp::objectCompare (const GALGAS_C_5F_machineDefinedByAdditiveModalComp & inOperand) const {
  enumComparisonResult result = GALGAS_AC_5F_job::objectCompare (inOperand) ;
  const cPtr_C_5F_machineDefinedByAdditiveModalComp * p = (const cPtr_C_5F_machineDefinedByAdditiveModalComp *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_C_5F_machineDefinedByAdditiveModalComp) ;
  ...
  macroNullOrValidObject (q, const cPtr_C_5F_machineDefinedByAdditiveModalComp) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mMachineName.objectCompare (q->mAttribute_mMachineName) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_AC_5F_job (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_C_5F_machineDefinedByAdditiveModalComp) ;
}
...
void GALGAS_C_5F_machineDefinedByAdditiveModalComp::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_C_5F_machineDefinedByAdditiveModalComp) ;
...
GALGAS_lstring GALGAS_C_5F_machineDefinedByAdditiveModalComp::reader_mMachineName (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_C_5F_machineDefinedByAdditiveModalComp * p = (const cPtr_C_5F_machineDefinedByAdditiveModalComp *) mObjectPtr ;
    macroValidObject (p, const cPtr_C_5F_machineDefinedByAdditiveModalComp) ;
    result = p->mAttribute_mMachineName ;
  }
  return result ;
}
...
enumComparisonResult GALGAS_C_5F_machineDefinedBySubstractiveModalComp::objectCompare (const GALGAS_C_5F_machineDefinedBySubstractiveModalComp & inOperand) const {
  enumComparisonResult result = GALGAS_AC_5F_job::objectCompare (inOperand) ;
  const cPtr_C_5F_machineDefinedBySubstractiveModalComp * p = (const cPtr_C_5F_machineDefinedBySubstractiveModalComp *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_C_5F_machineDefinedBySubstractiveModalComp) ;
  ...
  macroNullOrValidObject (q, const cPtr_C_5F_machineDefinedBySubstractiveModalComp) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mMachineName.objectCompare (q->mAttribute_mMachineName) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_AC_5F_job (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_C_5F_machineDefinedBySubstractiveModalComp) ;
}
...
void GALGAS_C_5F_machineDefinedBySubstractiveModalComp::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_C_5F_machineDefinedBySubstractiveModalComp) ;
...
GALGAS_lstring GALGAS_C_5F_machineDefinedBySubstractiveModalComp::reader_mMachineName (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_C_5F_machineDefinedBySubstractiveModalComp * p = (const cPtr_C_5F_machineDefinedBySubstractiveModalComp *) mObjectPtr ;
    macroValidObject (p, const cPtr_C_5F_machineDefinedBySubstractiveModalComp) ;
    result = p->mAttribute_mMachineName ;
  }
  return result ;
}
...
enumComparisonResult GALGAS_C_5F_machineDisplayInitialStates::objectCompare (const GALGAS_C_5F_machineDisplayInitialStates & inOperand) const {
  enumComparisonResult result = GALGAS_AC_5F_job::objectCompare (inOperand) ;
  const cPtr_C_5F_machineDisplayInitialStates * p = (const cPtr_C_5F_machineDisplayInitialStates *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_C_5F_machineDisplayInitialStates) ;
  const cPtr_C_5F_machineDisplayInitialStates * q = (const cPtr_C_5F_machineDisplayInitialStates *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_C_5F_machineDisplayInitialStates) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mMachineIndex.objectCompare (q->mAttribute_mMachineIndex) ;
  }
  return result ;
...
GALGAS_AC_5F_job (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_C_5F_machineDisplayInitialStates) ;
}
...
void GALGAS_C_5F_machineDisplayInitialStates::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_C_5F_machineDisplayInitialStates) ;
...
GALGAS_uint GALGAS_C_5F_machineDisplayInitialStates::reader_mMachineIndex (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_C_5F_machineDisplayInitialStates * p = (const cPtr_C_5F_machineDisplayInitialStates *) mObjectPtr ;
    macroValidObject (p, const cPtr_C_5F_machineDisplayInitialStates) ;
    result = p->mAttribute_mMachineIndex ;
  }
  return result ;
}
...
enumComparisonResult GALGAS_C_5F_machineDisplayStates::objectCompare (const GALGAS_C_5F_machineDisplayStates & inOperand) const {
  enumComparisonResult result = GALGAS_AC_5F_job::objectCompare (inOperand) ;
  const cPtr_C_5F_machineDisplayStates * p = (const cPtr_C_5F_machineDisplayStates *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_C_5F_machineDisplayStates) ;
  const cPtr_C_5F_machineDisplayStates * q = (const cPtr_C_5F_machineDisplayStates *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_C_5F_machineDisplayStates) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mMachineIndex.objectCompare (q->mAttribute_mMachineIndex) ;
  }
  return result ;
...
GALGAS_AC_5F_job (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_C_5F_machineDisplayStates) ;
}
...
void GALGAS_C_5F_machineDisplayStates::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_C_5F_machineDisplayStates) ;
...
GALGAS_uint GALGAS_C_5F_machineDisplayStates::reader_mMachineIndex (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_C_5F_machineDisplayStates * p = (const cPtr_C_5F_machineDisplayStates *) mObjectPtr ;
    macroValidObject (p, const cPtr_C_5F_machineDisplayStates) ;
    result = p->mAttribute_mMachineIndex ;
  }
  return result ;
}
...
enumComparisonResult GALGAS_C_5F_machineDisplayTerminalStates::objectCompare (const GALGAS_C_5F_machineDisplayTerminalStates & inOperand) const {
  enumComparisonResult result = GALGAS_AC_5F_job::objectCompare (inOperand) ;
  const cPtr_C_5F_machineDisplayTerminalStates * p = (const cPtr_C_5F_machineDisplayTerminalStates *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_C_5F_machineDisplayTerminalStates) ;
  const cPtr_C_5F_machineDisplayTerminalStates * q = (const cPtr_C_5F_machineDisplayTerminalStates *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_C_5F_machineDisplayTerminalStates) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mMachineIndex.objectCompare (q->mAttribute_mMachineIndex) ;
  }
  return result ;
...
GALGAS_AC_5F_job (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_C_5F_machineDisplayTerminalStates) ;
}
...
void GALGAS_C_5F_machineDisplayTerminalStates::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_C_5F_machineDisplayTerminalStates) ;
...
GALGAS_uint GALGAS_C_5F_machineDisplayTerminalStates::reader_mMachineIndex (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_C_5F_machineDisplayTerminalStates * p = (const cPtr_C_5F_machineDisplayTerminalStates *) mObjectPtr ;
    macroValidObject (p, const cPtr_C_5F_machineDisplayTerminalStates) ;
    result = p->mAttribute_mMachineIndex ;
  }
  return result ;
}
...
enumComparisonResult GALGAS_C_5F_machineDisplayTransitions::objectCompare (const GALGAS_C_5F_machineDisplayTransitions & inOperand) const {
  enumComparisonResult result = GALGAS_AC_5F_job::objectCompare (inOperand) ;
  const cPtr_C_5F_machineDisplayTransitions * p = (const cPtr_C_5F_machineDisplayTransitions *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_C_5F_machineDisplayTransitions) ;
  const cPtr_C_5F_machineDisplayTransitions * q = (const cPtr_C_5F_machineDisplayTransitions *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_C_5F_machineDisplayTransitions) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mMachineIndex.objectCompare (q->mAttribute_mMachineIndex) ;
  }
  return result ;
...
GALGAS_AC_5F_job (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_C_5F_machineDisplayTransitions) ;
}
...
void GALGAS_C_5F_machineDisplayTransitions::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_C_5F_machineDisplayTransitions) ;
...
GALGAS_uint GALGAS_C_5F_machineDisplayTransitions::reader_mMachineIndex (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_C_5F_machineDisplayTransitions * p = (const cPtr_C_5F_machineDisplayTransitions *) mObjectPtr ;
    macroValidObject (p, const cPtr_C_5F_machineDisplayTransitions) ;
    result = p->mAttribute_mMachineIndex ;
  }
  return result ;
}
...
enumComparisonResult GALGAS_C_5F_scenarioComponent::objectCompare (const GALGAS_C_5F_scenarioComponent & inOperand) const {
  enumComparisonResult result = GALGAS_AC_5F_job::objectCompare (inOperand) ;
  const cPtr_C_5F_scenarioComponent * p = (const cPtr_C_5F_scenarioComponent *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_C_5F_scenarioComponent) ;
  const cPtr_C_5F_scenarioComponent * q = (const cPtr_C_5F_scenarioComponent *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_C_5F_scenarioComponent) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mMachineIndex.objectCompare (q->mAttribute_mMachineIndex) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_AC_5F_job (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_C_5F_scenarioComponent) ;
}
...
void GALGAS_C_5F_scenarioComponent::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_C_5F_scenarioComponent) ;
...
GALGAS_uint GALGAS_C_5F_scenarioComponent::reader_mMachineIndex (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_C_5F_scenarioComponent * p = (const cPtr_C_5F_scenarioComponent *) mObjectPtr ;
    macroValidObject (p, const cPtr_C_5F_scenarioComponent) ;
    result = p->mAttribute_mMachineIndex ;
  }
  return result ;
}
...
enumComparisonResult GALGAS_typeDisplayBDDstats::objectCompare (const GALGAS_typeDisplayBDDstats & inOperand) const {
  return (isValid () && inOperand.isValid ()) ? kOperandEqual : kOperandNotValid ;
}
...
GALGAS_AC_5F_job (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_typeDisplayBDDstats) ;
}
...
enumComparisonResult GALGAS_typeResizeMap::objectCompare (const GALGAS_typeResizeMap & inOperand) const {
  enumComparisonResult result = GALGAS_AC_5F_job::objectCompare (inOperand) ;
  const cPtr_typeResizeMap * p = (const cPtr_typeResizeMap *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_typeResizeMap) ;
  const cPtr_typeResizeMap * q = (const cPtr_typeResizeMap *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_typeResizeMap) ;
  if (kOperandEqual == result) {
...
GALGAS_AC_5F_job (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_typeResizeMap) ;
}
...
void GALGAS_typeResizeMap::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_typeResizeMap) ;
...
GALGAS_luint GALGAS_typeResizeMap::reader_mNewSize (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_typeResizeMap * p = (const cPtr_typeResizeMap *) mObjectPtr ;
    macroValidObject (p, const cPtr_typeResizeMap) ;
...
enumComparisonResult GALGAS_typeResize_5F_AND_5F_cache::objectCompare (const GALGAS_typeResize_5F_AND_5F_cache & inOperand) const {
  enumComparisonResult result = GALGAS_AC_5F_job::objectCompare (inOperand) ;
  const cPtr_typeResize_5F_AND_5F_cache * p = (const cPtr_typeResize_5F_AND_5F_cache *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_typeResize_5F_AND_5F_cache) ;
  const cPtr_typeResize_5F_AND_5F_cache * q = (const cPtr_typeResize_5F_AND_5F_cache *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_typeResize_5F_AND_5F_cache) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mNewSize.objectCompare (q->mAttribute_mNewSize) ;
  }
  return result ;
...
GALGAS_AC_5F_job (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_typeResize_5F_AND_5F_cache) ;
}
...
void GALGAS_typeResize_5F_AND_5F_cache::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_typeResize_5F_AND_5F_cache) ;
...
GALGAS_luint GALGAS_typeResize_5F_AND_5F_cache::reader_mNewSize (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_typeResize_5F_AND_5F_cache * p = (const cPtr_typeResize_5F_AND_5F_cache *) mObjectPtr ;
    macroValidObject (p, const cPtr_typeResize_5F_AND_5F_cache) ;
    result = p->mAttribute_mNewSize ;
  }
  return result ;
}
...
enumComparisonResult GALGAS_typeResize_5F_ITE_5F_cache::objectCompare (const GALGAS_typeResize_5F_ITE_5F_cache & inOperand) const {
  enumComparisonResult result = GALGAS_AC_5F_job::objectCompare (inOperand) ;
  const cPtr_typeResize_5F_ITE_5F_cache * p = (const cPtr_typeResize_5F_ITE_5F_cache *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_typeResize_5F_ITE_5F_cache) ;
  const cPtr_typeResize_5F_ITE_5F_cache * q = (const cPtr_typeResize_5F_ITE_5F_cache *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_typeResize_5F_ITE_5F_cache) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mNewSize.objectCompare (q->mAttribute_mNewSize) ;
  }
  return result ;
...
GALGAS_AC_5F_job (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_typeResize_5F_ITE_5F_cache) ;
}
...
void GALGAS_typeResize_5F_ITE_5F_cache::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_typeResize_5F_ITE_5F_cache) ;
...
GALGAS_luint GALGAS_typeResize_5F_ITE_5F_cache::reader_mNewSize (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_typeResize_5F_ITE_5F_cache * p = (const cPtr_typeResize_5F_ITE_5F_cache *) mObjectPtr ;
    macroValidObject (p, const cPtr_typeResize_5F_ITE_5F_cache) ;
    result = p->mAttribute_mNewSize ;
  }
  return result ;
}
...
enumComparisonResult GALGAS_typeUse_5F_AND::objectCompare (const GALGAS_typeUse_5F_AND & inOperand) const {
  return (isValid () && inOperand.isValid ()) ? kOperandEqual : kOperandNotValid ;
}
...
GALGAS_AC_5F_job (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_typeUse_5F_AND) ;
}
...
enumComparisonResult GALGAS_typeUse_5F_AND_5F_ITE::objectCompare (const GALGAS_typeUse_5F_AND_5F_ITE & inOperand) const {
  return (isValid () && inOperand.isValid ()) ? kOperandEqual : kOperandNotValid ;
}
...
GALGAS_AC_5F_job (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_typeUse_5F_AND_5F_ITE) ;
}
...
enumComparisonResult GALGAS_typeUse_5F_ITE::objectCompare (const GALGAS_typeUse_5F_ITE & inOperand) const {
  return (isValid () && inOperand.isValid ()) ? kOperandEqual : kOperandNotValid ;
}
...
GALGAS_AC_5F_job (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_typeUse_5F_ITE) ;
}
...
enumComparisonResult GALGAS_AC_5F_machineDefinition::objectCompare (const GALGAS_AC_5F_machineDefinition & inOperand) const {
  return (isValid () && inOperand.isValid ()) ? kOperandEqual : kOperandNotValid ;
}
...
AC_GALGAS_class (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_AC_5F_machineDefinition) ;
}
...
enumComparisonResult GALGAS_C_5F_additiveModalCompositionComponent::objectCompare (const GALGAS_C_5F_additiveModalCompositionComponent & inOperand) const {
  enumComparisonResult result = GALGAS_AC_5F_machineDefinition::objectCompare (inOperand) ;
  const cPtr_C_5F_additiveModalCompositionComponent * p = (const cPtr_C_5F_additiveModalCompositionComponent *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_C_5F_additiveModalCompositionComponent) ;
  ...
  macroNullOrValidObject (q, const cPtr_C_5F_additiveModalCompositionComponent) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mModeMap.objectCompare (q->mAttribute_mModeMap) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_AC_5F_machineDefinition (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_C_5F_additiveModalCompositionComponent) ;
}
...
void GALGAS_C_5F_additiveModalCompositionComponent::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_C_5F_additiveModalCompositionComponent) ;
...
GALGAS_M_5F_modesMap GALGAS_C_5F_additiveModalCompositionComponent::reader_mModeMap (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_C_5F_additiveModalCompositionComponent * p = (const cPtr_C_5F_additiveModalCompositionComponent *) mObjectPtr ;
    macroValidObject (p, const cPtr_C_5F_additiveModalCompositionComponent) ;
    result = p->mAttribute_mModeMap ;
  }
  return result ;
}
...
enumComparisonResult GALGAS_C_5F_boolToSeqExpression::objectCompare (const GALGAS_C_5F_boolToSeqExpression & inOperand) const {
  enumComparisonResult result = GALGAS_AC_5F_machineDefinition::objectCompare (inOperand) ;
  const cPtr_C_5F_boolToSeqExpression * p = (const cPtr_C_5F_boolToSeqExpression *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_C_5F_boolToSeqExpression) ;
  const cPtr_C_5F_boolToSeqExpression * q = (const cPtr_C_5F_boolToSeqExpression *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_C_5F_boolToSeqExpression) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mExpression.objectCompare (q->mAttribute_mExpression) ;
  }
  return result ;
...
GALGAS_AC_5F_machineDefinition (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_C_5F_boolToSeqExpression) ;
}
...
void GALGAS_C_5F_boolToSeqExpression::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_C_5F_boolToSeqExpression) ;
...
GALGAS_AC_5F_boolExpression GALGAS_C_5F_boolToSeqExpression::reader_mExpression (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_C_5F_boolToSeqExpression * p = (const cPtr_C_5F_boolToSeqExpression *) mObjectPtr ;
    macroValidObject (p, const cPtr_C_5F_boolToSeqExpression) ;
    result = p->mAttribute_mExpression ;
  }
  return result ;
}
...
enumComparisonResult GALGAS_C_5F_complementationOperation::objectCompare (const GALGAS_C_5F_complementationOperation & inOperand) const {
  enumComparisonResult result = GALGAS_AC_5F_machineDefinition::objectCompare (inOperand) ;
  const cPtr_C_5F_complementationOperation * p = (const cPtr_C_5F_complementationOperation *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_C_5F_complementationOperation) ;
  const cPtr_C_5F_complementationOperation * q = (const cPtr_C_5F_complementationOperation *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_C_5F_complementationOperation) ;
  if (kOperandEqual == result) {
...
GALGAS_AC_5F_machineDefinition (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_C_5F_complementationOperation) ;
}
...
void GALGAS_C_5F_complementationOperation::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_C_5F_complementationOperation) ;
...
GALGAS_AC_5F_machineDefinition GALGAS_C_5F_complementationOperation::reader_mOperand (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_C_5F_complementationOperation * p = (const cPtr_C_5F_complementationOperation *) mObjectPtr ;
    macroValidObject (p, const cPtr_C_5F_complementationOperation) ;
...
enumComparisonResult GALGAS_C_5F_existsDefinition::objectCompare (const GALGAS_C_5F_existsDefinition & inOperand) const {
  enumComparisonResult result = GALGAS_AC_5F_machineDefinition::objectCompare (inOperand) ;
  const cPtr_C_5F_existsDefinition * p = (const cPtr_C_5F_existsDefinition *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_C_5F_existsDefinition) ;
  const cPtr_C_5F_existsDefinition * q = (const cPtr_C_5F_existsDefinition *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_C_5F_existsDefinition) ;
  if (kOperandEqual == result) {
...
GALGAS_AC_5F_machineDefinition (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_C_5F_existsDefinition) ;
}
...
void GALGAS_C_5F_existsDefinition::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_C_5F_existsDefinition) ;
...
GALGAS_uint GALGAS_C_5F_existsDefinition::reader_mPreviousVariableCount (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_C_5F_existsDefinition * p = (const cPtr_C_5F_existsDefinition *) mObjectPtr ;
    macroValidObject (p, const cPtr_C_5F_existsDefinition) ;
...
enumComparisonResult GALGAS_C_5F_explicitAutomatonDefinition::objectCompare (const GALGAS_C_5F_explicitAutomatonDefinition & inOperand) const {
  enumComparisonResult result = GALGAS_AC_5F_machineDefinition::objectCompare (inOperand) ;
  const cPtr_C_5F_explicitAutomatonDefinition * p = (const cPtr_C_5F_explicitAutomatonDefinition *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_C_5F_explicitAutomatonDefinition) ;
  const cPtr_C_5F_explicitAutomatonDefinition * q = (const cPtr_C_5F_explicitAutomatonDefinition *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_C_5F_explicitAutomatonDefinition) ;
  if (kOperandEqual == result) {
...
GALGAS_AC_5F_machineDefinition (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_C_5F_explicitAutomatonDefinition) ;
}
...
void GALGAS_C_5F_explicitAutomatonDefinition::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_C_5F_explicitAutomatonDefinition) ;
...
GALGAS_M_5F_stateMap GALGAS_C_5F_explicitAutomatonDefinition::reader_mStatesMap (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_C_5F_explicitAutomatonDefinition * p = (const cPtr_C_5F_explicitAutomatonDefinition *) mObjectPtr ;
    macroValidObject (p, const cPtr_C_5F_explicitAutomatonDefinition) ;
...
enumComparisonResult GALGAS_C_5F_forallDefinition::objectCompare (const GALGAS_C_5F_forallDefinition & inOperand) const {
  enumComparisonResult result = GALGAS_AC_5F_machineDefinition::objectCompare (inOperand) ;
  const cPtr_C_5F_forallDefinition * p = (const cPtr_C_5F_forallDefinition *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_C_5F_forallDefinition) ;
  const cPtr_C_5F_forallDefinition * q = (const cPtr_C_5F_forallDefinition *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_C_5F_forallDefinition) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mPreviousVariableCount.objectCompare (q->mAttribute_mPreviousVariableCount) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_AC_5F_machineDefinition (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_C_5F_forallDefinition) ;
}
...
void GALGAS_C_5F_forallDefinition::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_C_5F_forallDefinition) ;
...
GALGAS_uint GALGAS_C_5F_forallDefinition::reader_mPreviousVariableCount (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_C_5F_forallDefinition * p = (const cPtr_C_5F_forallDefinition *) mObjectPtr ;
    macroValidObject (p, const cPtr_C_5F_forallDefinition) ;
    result = p->mAttribute_mPreviousVariableCount ;
  }
  return result ;
}
...
enumComparisonResult GALGAS_C_5F_fullSaturationOperation::objectCompare (const GALGAS_C_5F_fullSaturationOperation & inOperand) const {
  enumComparisonResult result = GALGAS_AC_5F_machineDefinition::objectCompare (inOperand) ;
  const cPtr_C_5F_fullSaturationOperation * p = (const cPtr_C_5F_fullSaturationOperation *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_C_5F_fullSaturationOperation) ;
  const cPtr_C_5F_fullSaturationOperation * q = (const cPtr_C_5F_fullSaturationOperation *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_C_5F_fullSaturationOperation) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mOperand.objectCompare (q->mAttribute_mOperand) ;
  }
  return result ;
...
GALGAS_AC_5F_machineDefinition (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_C_5F_fullSaturationOperation) ;
}
...
void GALGAS_C_5F_fullSaturationOperation::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_C_5F_fullSaturationOperation) ;
...
GALGAS_AC_5F_machineDefinition GALGAS_C_5F_fullSaturationOperation::reader_mOperand (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_C_5F_fullSaturationOperation * p = (const cPtr_C_5F_fullSaturationOperation *) mObjectPtr ;
    macroValidObject (p, const cPtr_C_5F_fullSaturationOperation) ;
    result = p->mAttribute_mOperand ;
  }
  return result ;
}
...
enumComparisonResult GALGAS_C_5F_importMachine::objectCompare (const GALGAS_C_5F_importMachine & inOperand) const {
  enumComparisonResult result = GALGAS_AC_5F_machineDefinition::objectCompare (inOperand) ;
  const cPtr_C_5F_importMachine * p = (const cPtr_C_5F_importMachine *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_C_5F_importMachine) ;
  const cPtr_C_5F_importMachine * q = (const cPtr_C_5F_importMachine *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_C_5F_importMachine) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mIndexOfImportedMachine.objectCompare (q->mAttribute_mIndexOfImportedMachine) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_AC_5F_machineDefinition (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_C_5F_importMachine) ;
}
...
void GALGAS_C_5F_importMachine::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_C_5F_importMachine) ;
...
GALGAS_uint GALGAS_C_5F_importMachine::reader_mIndexOfImportedMachine (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_C_5F_importMachine * p = (const cPtr_C_5F_importMachine *) mObjectPtr ;
    macroValidObject (p, const cPtr_C_5F_importMachine) ;
    result = p->mAttribute_mIndexOfImportedMachine ;
  }
  return result ;
}
...
enumComparisonResult GALGAS_C_5F_orComposition::objectCompare (const GALGAS_C_5F_orComposition & inOperand) const {
  enumComparisonResult result = GALGAS_AC_5F_machineDefinition::objectCompare (inOperand) ;
  const cPtr_C_5F_orComposition * p = (const cPtr_C_5F_orComposition *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_C_5F_orComposition) ;
  const cPtr_C_5F_orComposition * q = (const cPtr_C_5F_orComposition *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_C_5F_orComposition) ;
  if (kOperandEqual == result) {
...
GALGAS_AC_5F_machineDefinition (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_C_5F_orComposition) ;
}
...
void GALGAS_C_5F_orComposition::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_C_5F_orComposition) ;
...
GALGAS_AC_5F_machineDefinition GALGAS_C_5F_orComposition::reader_mLeftOperand (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_C_5F_orComposition * p = (const cPtr_C_5F_orComposition *) mObjectPtr ;
    macroValidObject (p, const cPtr_C_5F_orComposition) ;
...
enumComparisonResult GALGAS_C_5F_parallelComposition::objectCompare (const GALGAS_C_5F_parallelComposition & inOperand) const {
  enumComparisonResult result = GALGAS_AC_5F_machineDefinition::objectCompare (inOperand) ;
  const cPtr_C_5F_parallelComposition * p = (const cPtr_C_5F_parallelComposition *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_C_5F_parallelComposition) ;
  const cPtr_C_5F_parallelComposition * q = (const cPtr_C_5F_parallelComposition *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_C_5F_parallelComposition) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mLeftOperand.objectCompare (q->mAttribute_mLeftOperand) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_AC_5F_machineDefinition (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_C_5F_parallelComposition) ;
}
...
void GALGAS_C_5F_parallelComposition::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_C_5F_parallelComposition) ;
...
GALGAS_AC_5F_machineDefinition GALGAS_C_5F_parallelComposition::reader_mLeftOperand (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_C_5F_parallelComposition * p = (const cPtr_C_5F_parallelComposition *) mObjectPtr ;
    macroValidObject (p, const cPtr_C_5F_parallelComposition) ;
    result = p->mAttribute_mLeftOperand ;
  }
  return result ;
}
...
enumComparisonResult GALGAS_C_5F_strongModalComposition::objectCompare (const GALGAS_C_5F_strongModalComposition & inOperand) const {
  enumComparisonResult result = GALGAS_AC_5F_machineDefinition::objectCompare (inOperand) ;
  const cPtr_C_5F_strongModalComposition * p = (const cPtr_C_5F_strongModalComposition *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_C_5F_strongModalComposition) ;
  const cPtr_C_5F_strongModalComposition * q = (const cPtr_C_5F_strongModalComposition *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_C_5F_strongModalComposition) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mLeftOperand.objectCompare (q->mAttribute_mLeftOperand) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_AC_5F_machineDefinition (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_C_5F_strongModalComposition) ;
}
...
void GALGAS_C_5F_strongModalComposition::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_C_5F_strongModalComposition) ;
...
GALGAS_AC_5F_machineDefinition GALGAS_C_5F_strongModalComposition::reader_mLeftOperand (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_C_5F_strongModalComposition * p = (const cPtr_C_5F_strongModalComposition *) mObjectPtr ;
    macroValidObject (p, const cPtr_C_5F_strongModalComposition) ;
    result = p->mAttribute_mLeftOperand ;
  }
  return result ;
}
...
enumComparisonResult GALGAS_C_5F_substractiveModalCompositionComponent::objectCompare (const GALGAS_C_5F_substractiveModalCompositionComponent & inOperand) const {
  enumComparisonResult result = GALGAS_AC_5F_machineDefinition::objectCompare (inOperand) ;
  const cPtr_C_5F_substractiveModalCompositionComponent * p = (const cPtr_C_5F_substractiveModalCompositionComponent *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_C_5F_substractiveModalCompositionComponent) ;
  ...
  macroNullOrValidObject (q, const cPtr_C_5F_substractiveModalCompositionComponent) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mModeMap.objectCompare (q->mAttribute_mModeMap) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_AC_5F_machineDefinition (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_C_5F_substractiveModalCompositionComponent) ;
}
...
void GALGAS_C_5F_substractiveModalCompositionComponent::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_C_5F_substractiveModalCompositionComponent) ;
...
GALGAS_M_5F_modesMap GALGAS_C_5F_substractiveModalCompositionComponent::reader_mModeMap (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_C_5F_substractiveModalCompositionComponent * p = (const cPtr_C_5F_substractiveModalCompositionComponent *) mObjectPtr ;
    macroValidObject (p, const cPtr_C_5F_substractiveModalCompositionComponent) ;
    result = p->mAttribute_mModeMap ;
  }
  return result ;
}
...
enumComparisonResult GALGAS_C_5F_suppressInitialStatesOperation::objectCompare (const GALGAS_C_5F_suppressInitialStatesOperation & inOperand) const {
  enumComparisonResult result = GALGAS_AC_5F_machineDefinition::objectCompare (inOperand) ;
  const cPtr_C_5F_suppressInitialStatesOperation * p = (const cPtr_C_5F_suppressInitialStatesOperation *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_C_5F_suppressInitialStatesOperation) ;
  const cPtr_C_5F_suppressInitialStatesOperation * q = (const cPtr_C_5F_suppressInitialStatesOperation *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_C_5F_suppressInitialStatesOperation) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mOperand.objectCompare (q->mAttribute_mOperand) ;
  }
  return result ;
...
GALGAS_AC_5F_machineDefinition (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_C_5F_suppressInitialStatesOperation) ;
}
...
void GALGAS_C_5F_suppressInitialStatesOperation::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_C_5F_suppressInitialStatesOperation) ;
...
GALGAS_AC_5F_machineDefinition GALGAS_C_5F_suppressInitialStatesOperation::reader_mOperand (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_C_5F_suppressInitialStatesOperation * p = (const cPtr_C_5F_suppressInitialStatesOperation *) mObjectPtr ;
    macroValidObject (p, const cPtr_C_5F_suppressInitialStatesOperation) ;
    result = p->mAttribute_mOperand ;
  }
  return result ;
}
...
enumComparisonResult GALGAS_C_5F_suppressTerminalStatesOperation::objectCompare (const GALGAS_C_5F_suppressTerminalStatesOperation & inOperand) const {
  enumComparisonResult result = GALGAS_AC_5F_machineDefinition::objectCompare (inOperand) ;
  const cPtr_C_5F_suppressTerminalStatesOperation * p = (const cPtr_C_5F_suppressTerminalStatesOperation *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_C_5F_suppressTerminalStatesOperation) ;
  const cPtr_C_5F_suppressTerminalStatesOperation * q = (const cPtr_C_5F_suppressTerminalStatesOperation *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_C_5F_suppressTerminalStatesOperation) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mOperand.objectCompare (q->mAttribute_mOperand) ;
  }
  return result ;
...
GALGAS_AC_5F_machineDefinition (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_C_5F_suppressTerminalStatesOperation) ;
}
...
void GALGAS_C_5F_suppressTerminalStatesOperation::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_C_5F_suppressTerminalStatesOperation) ;
...
GALGAS_AC_5F_machineDefinition GALGAS_C_5F_suppressTerminalStatesOperation::reader_mOperand (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_C_5F_suppressTerminalStatesOperation * p = (const cPtr_C_5F_suppressTerminalStatesOperation *) mObjectPtr ;
    macroValidObject (p, const cPtr_C_5F_suppressTerminalStatesOperation) ;
    result = p->mAttribute_mOperand ;
  }
  return result ;
}
...
enumComparisonResult GALGAS_C_5F_trans::objectCompare (const GALGAS_C_5F_trans & inOperand) const {
  enumComparisonResult result = GALGAS_AC_5F_machineDefinition::objectCompare (inOperand) ;
  const cPtr_C_5F_trans * p = (const cPtr_C_5F_trans *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_C_5F_trans) ;
  const cPtr_C_5F_trans * q = (const cPtr_C_5F_trans *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_C_5F_trans) ;
  if (kOperandEqual == result) {
...
GALGAS_AC_5F_machineDefinition (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_C_5F_trans) ;
}
...
void GALGAS_C_5F_trans::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_C_5F_trans) ;
...
GALGAS_AC_5F_boolExpression GALGAS_C_5F_trans::reader_mSourceStateExpression (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_C_5F_trans * p = (const cPtr_C_5F_trans *) mObjectPtr ;
    macroValidObject (p, const cPtr_C_5F_trans) ;
...
enumComparisonResult GALGAS_C_5F_weakModalComposition::objectCompare (const GALGAS_C_5F_weakModalComposition & inOperand) const {
  enumComparisonResult result = GALGAS_AC_5F_machineDefinition::objectCompare (inOperand) ;
  const cPtr_C_5F_weakModalComposition * p = (const cPtr_C_5F_weakModalComposition *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_C_5F_weakModalComposition) ;
  const cPtr_C_5F_weakModalComposition * q = (const cPtr_C_5F_weakModalComposition *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_C_5F_weakModalComposition) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mLeftOperand.objectCompare (q->mAttribute_mLeftOperand) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_AC_5F_machineDefinition (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_C_5F_weakModalComposition) ;
}
...
void GALGAS_C_5F_weakModalComposition::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_C_5F_weakModalComposition) ;
...
GALGAS_AC_5F_machineDefinition GALGAS_C_5F_weakModalComposition::reader_mLeftOperand (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_C_5F_weakModalComposition * p = (const cPtr_C_5F_weakModalComposition *) mObjectPtr ;
    macroValidObject (p, const cPtr_C_5F_weakModalComposition) ;
    result = p->mAttribute_mLeftOperand ;
  }
  return result ;
}
