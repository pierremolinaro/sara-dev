...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    equal = mTargetSlot._operator_isEqual (ptr->mTargetSlot).boolValue () ;
  }
  return equal ;
}
...
/* const */ GGS_luint  & GGS_L_translationVector::cEnumerator::_mTargetSlot (LOCATION_ARGS) const {
  ...
  return ((cElement *) mCurrentEnumeratedObject)->mTargetSlot ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mIndexOfImportedMachine._operator_isEqual (ptr->mIndexOfImportedMachine).boolValue ()
         && mErrorLocation._operator_isEqual (ptr->mErrorLocation).boolValue ()
         && mTranslationVector._operator_isEqual (ptr->mTranslationVector).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mLeftExpression._operator_isEqual (ptr->mLeftExpression).boolValue ()
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mInputVarIndex._operator_isEqual (ptr->mInputVarIndex).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mActionExpression._operator_isEqual (ptr->mActionExpression).boolValue ()
         && mEndOfExpression._operator_isEqual (ptr->mEndOfExpression).boolValue ()
         && mTargetStateIndex._operator_isEqual (ptr->mTargetStateIndex).boolValue () ;
  }
  return equal ;
}
...
/* const */ GGS_AC_boolExpression  & GGS_L_transitionDefinition::cEnumerator::_mActionExpression (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->mActionExpression ;
}
...
/* const */ GGS_location  & GGS_L_transitionDefinition::cEnumerator::_mEndOfExpression (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->mEndOfExpression ;
}
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mStateIndex._operator_isEqual (ptr->mStateIndex).boolValue ()
         && mStateExpression._operator_isEqual (ptr->mStateExpression).boolValue ()
         && mEndOfStateExpression._operator_isEqual (ptr->mEndOfStateExpression).boolValue ()
         && mTransitionsList._operator_isEqual (ptr->mTransitionsList).boolValue () ;
  }
  return equal ;
}
...
/* const */ GGS_luint  & GGS_L_stateDefinition::cEnumerator::_mStateIndex (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->mStateIndex ;
}
...
/* const */ GGS_AC_boolExpression  & GGS_L_stateDefinition::cEnumerator::_mStateExpression (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->mStateExpression ;
}
...
/* const */ GGS_location  & GGS_L_stateDefinition::cEnumerator::_mEndOfStateExpression (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->mEndOfStateExpression ;
}
...
/* const */ GGS_L_transitionDefinition  & GGS_L_stateDefinition::cEnumerator::_mTransitionsList (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->mTransitionsList ;
}
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mStateIndex._operator_isEqual (ptr->mStateIndex).boolValue ()
         && mStateLocation._operator_isEqual (ptr->mStateLocation).boolValue () ;
  }
  return equal ;
}
...
/* const */ GGS_location  & GGS_L_statesDefinitionList::cEnumerator::_mStateLocation (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->mStateLocation ;
}
...
isEqualToMapElement (const AC_galgas_map_element * inOperand) const {
  ...
  macroValidPointer (ptr) ;
  return (mInfo.mModeDefinition._operator_isEqual (ptr->mInfo.mModeDefinition)).boolValue () ;
}
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mSourceMode._operator_isEqual (ptr->mSourceMode).boolValue ()
         && mTargetMode._operator_isEqual (ptr->mTargetMode).boolValue () ;
  }
  return equal ;
}
...
/* const */ GGS_luint  & GGS_ListForModes::cEnumerator::_mSourceMode (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->mSourceMode ;
}
...
/* const */ GGS_luint  & GGS_ListForModes::cEnumerator::_mTargetMode (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->mTargetMode ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mModeMap._operator_isEqual (ptr->mModeMap).boolValue ()
         && mExclusionList._operator_isEqual (ptr->mExclusionList).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mModeMap._operator_isEqual (ptr->mModeMap).boolValue ()
         && mInclusionList._operator_isEqual (ptr->mInclusionList).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mSourceStateExpression._operator_isEqual (ptr->mSourceStateExpression).boolValue ()
         && mTargetStateExpression._operator_isEqual (ptr->mTargetStateExpression).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mStatesMap._operator_isEqual (ptr->mStatesMap).boolValue ()
         && mInitialStatesDefinitionList._operator_isEqual (ptr->mInitialStatesDefinitionList).boolValue ()
         && mTerminalStatesDefinitionList._operator_isEqual (ptr->mTerminalStatesDefinitionList).boolValue ()
         && mStateDefinitionList._operator_isEqual (ptr->mStateDefinitionList).boolValue ()
         && mEndOfDefinition._operator_isEqual (ptr->mEndOfDefinition).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mPreviousVariableCount._operator_isEqual (ptr->mPreviousVariableCount).boolValue ()
         && mTotalVariableCount._operator_isEqual (ptr->mTotalVariableCount).boolValue ()
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mMachineIndex._operator_isEqual (ptr->mMachineIndex).boolValue ()
         && mCheckMachineIsBoolean._operator_isEqual (ptr->mCheckMachineIsBoolean).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mMachineIndex1._operator_isEqual (ptr->mMachineIndex1).boolValue ()
         && mMachineIndex2._operator_isEqual (ptr->mMachineIndex2).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mMachineName._operator_isEqual (ptr->mMachineName).boolValue ()
         && mMachineIndex._operator_isEqual (ptr->mMachineIndex).boolValue ()
         && mInputVariableCount._operator_isEqual (ptr->mInputVariableCount).boolValue ()
         && mInputAndInternalVariableCount._operator_isEqual (ptr->mInputAndInternalVariableCount).boolValue ()
         && mVariablesMap._operator_isEqual (ptr->mVariablesMap).boolValue ()
         && mDefinition._operator_isEqual (ptr->mDefinition).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    equal = mMachineName._operator_isEqual (ptr->mMachineName).boolValue ()
         ...
         && mInputAndInternalVariableCount._operator_isEqual (ptr->mInputAndInternalVariableCount).boolValue ()
         && mVariablesMap._operator_isEqual (ptr->mVariablesMap).boolValue ()
         && mModeMap._operator_isEqual (ptr->mModeMap).boolValue ()
         && mInclusionList._operator_isEqual (ptr->mInclusionList).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mInputValue._operator_isEqual (ptr->mInputValue).boolValue () ;
  }
  return equal ;
}
...
/* const */ GGS_luint  & GGS_L_inputConfigurationForScenario::cEnumerator::_mInputValue (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->mInputValue ;
}
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mInputConfiguration._operator_isEqual (ptr->mInputConfiguration).boolValue () ;
  }
  return equal ;
}
...
/* const */ GGS_L_inputConfigurationForScenario  & GGS_L_inputScenario::cEnumerator::_mInputConfiguration (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->mInputConfiguration ;
}
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mScenarioTitle._operator_isEqual (ptr->mScenarioTitle).boolValue ()
         && mInputScenario._operator_isEqual (ptr->mInputScenario).boolValue () ;
  }
  return equal ;
}
...
/* const */ GGS_lstring  & GGS_L_scenarioList::cEnumerator::_mScenarioTitle (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->mScenarioTitle ;
}
...
/* const */ GGS_L_inputScenario  & GGS_L_scenarioList::cEnumerator::_mInputScenario (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->mInputScenario ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    equal = mMachineIndex._operator_isEqual (ptr->mMachineIndex).boolValue ()
         ...
         && mInputAndInternalVariableCount._operator_isEqual (ptr->mInputAndInternalVariableCount).boolValue ()
         && mVariablesMap._operator_isEqual (ptr->mVariablesMap).boolValue ()
         && mScenarioList._operator_isEqual (ptr->mScenarioList).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mNewSize._operator_isEqual (ptr->mNewSize).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mComponent._operator_isEqual (ptr->mComponent).boolValue () ;
  }
  return equal ;
}
...
/* const */ GGS_AC_job  & GGS_L_jobList::cEnumerator::_mComponent (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->mComponent ;
}
...
isEqualToMapElement (const AC_galgas_map_element * inOperand) const {
  ...
  macroValidPointer (ptr) ;
  return (mInfo.mInputVariableCount._operator_isEqual (ptr->mInfo.mInputVariableCount)).boolValue ()
           && (mInfo.mInputAndInternalVariableCount._operator_isEqual (ptr->mInfo.mInputAndInternalVariableCount)).boolValue ()
           && (mInfo.mVariablesMap._operator_isEqual (ptr->mInfo.mVariablesMap)).boolValue () ;
}
