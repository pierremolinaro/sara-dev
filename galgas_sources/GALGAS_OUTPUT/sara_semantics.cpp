...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->mTargetSlot ;
  }else{
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mLastItem->mTargetSlot ;
  }else{
    _out_0._drop_operation () ;
  }
}
...
void GGS_L_transitionDefinition::
_internalPrependItem (const GGS_AC_boolExpression & argument_0,
                    const GGS_location & argument_1,
                    const GGS_luint & argument_2) {
  element_type * nouvelElement = (element_type *) NULL ;
  macroMyNew (nouvelElement, element_type (argument_0,
    ...
    if (count () == 0) {
      ...
      if (inOperand.count () > 0) {
        ...
        while (p != NULL) {
          ...
          result._internalAppendItem (p_0, p_1, p_2) ;
          p = p->nextObject () ;
        }
      }
    }
...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->mActionExpression ;
    _out_1 = _mRoot->mFirstItem->mEndOfExpression ;
    _out_2 = _mRoot->mFirstItem->mTargetStateIndex ;
  }else{
    _out_0._drop_operation () ;
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mLastItem->mActionExpression ;
    _out_1 = _mRoot->mLastItem->mEndOfExpression ;
    _out_2 = _mRoot->mLastItem->mTargetStateIndex ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
    _out_2._drop_operation () ;
...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->mStateIndex ;
    _out_1 = _mRoot->mFirstItem->mStateExpression ;
    _out_2 = _mRoot->mFirstItem->mEndOfStateExpression ;
    _out_3 = _mRoot->mFirstItem->mTransitionsList ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
    _out_2._drop_operation () ;
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mLastItem->mStateIndex ;
    _out_1 = _mRoot->mLastItem->mStateExpression ;
    _out_2 = _mRoot->mLastItem->mEndOfStateExpression ;
    _out_3 = _mRoot->mLastItem->mTransitionsList ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
    _out_2._drop_operation () ;
...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->mStateIndex ;
    _out_1 = _mRoot->mFirstItem->mStateLocation ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
  }
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mLastItem->mStateIndex ;
    _out_1 = _mRoot->mLastItem->mStateLocation ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
  }
...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->mSourceMode ;
    _out_1 = _mRoot->mFirstItem->mTargetMode ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
  }
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mLastItem->mSourceMode ;
    _out_1 = _mRoot->mLastItem->mTargetMode ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
  }
...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->mInputValue ;
  }else{
    _out_0._drop_operation () ;
  }
}
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mLastItem->mInputValue ;
  }else{
    _out_0._drop_operation () ;
  }
}
...
void GGS_L_inputScenario::
_internalPrependItem (const GGS_L_inputConfigurationForScenario & argument_0) {
  element_type * nouvelElement = (element_type *) NULL ;
  macroMyNew (nouvelElement, element_type (argument_0)) ;
  if (nouvelElement != NULL) {
    macroValidPointer (nouvelElement) ;
...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->mInputConfiguration ;
  }else{
    _out_0._drop_operation () ;
  }
}
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mLastItem->mInputConfiguration ;
  }else{
    _out_0._drop_operation () ;
  }
}
...
void GGS_L_scenarioList::
_internalPrependItem (const GGS_lstring & argument_0,
                    const GGS_L_inputScenario & argument_1) {
  element_type * nouvelElement = (element_type *) NULL ;
  macroMyNew (nouvelElement, element_type (argument_0,
                                argument_1)) ;
...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->mScenarioTitle ;
    _out_1 = _mRoot->mFirstItem->mInputScenario ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
  }
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mLastItem->mScenarioTitle ;
    _out_1 = _mRoot->mLastItem->mInputScenario ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
  }
...
void GGS_L_jobList::
_internalPrependItem (const GGS_AC_job & argument_0) {
  element_type * nouvelElement = (element_type *) NULL ;
  macroMyNew (nouvelElement, element_type (argument_0)) ;
  if (nouvelElement != NULL) {
    macroValidPointer (nouvelElement) ;
...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->mComponent ;
  }else{
    _out_0._drop_operation () ;
  }
}
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mLastItem->mComponent ;
  }else{
    _out_0._drop_operation () ;
  }
}
