...
GGS_L_translationVector::GGS_L_translationVector (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_L_transitionDefinition::GGS_L_transitionDefinition (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_L_stateDefinition::GGS_L_stateDefinition (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_L_statesDefinitionList::GGS_L_statesDefinitionList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_ListForModes::GGS_ListForModes (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_L_inputConfigurationForScenario::GGS_L_inputConfigurationForScenario (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_L_inputScenario::GGS_L_inputScenario (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_L_scenarioList::GGS_L_scenarioList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_L_jobList::GGS_L_jobList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
void GGS_semanticContext::_drop_operation (void) {
  componentsMap._drop_operation () ;
  machinesMap._drop_operation () ;
}
