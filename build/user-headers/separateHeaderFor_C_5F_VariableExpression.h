...
//--------------------------------- Initializers
  public: void C_5F_VariableExpression_init_21_ (const class GGS_uint & inOperand0,
                                                 Compiler * inCompiler) ;
...
//--- END OF USER ZONE 2
//--- Properties
  public: GGS_uint mProperty_mInputVarIndex ;
...
//--- Constructor
  public: cPtr_C_5F_VariableExpression (const GGS_uint & in_mInputVarIndex,
                                        Compiler * inCompiler
                                        COMMA_LOCATION_ARGS) ;
