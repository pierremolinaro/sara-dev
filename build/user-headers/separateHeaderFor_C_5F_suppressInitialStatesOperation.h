...
//--------------------------------- Initializers
  public: void C_5F_suppressInitialStatesOperation_init_21_ (const class GGS_AC_5F_machineDefinition & inOperand0,
                                                             Compiler * inCompiler) ;
...
//--- Constructor
  public: cPtr_C_5F_suppressInitialStatesOperation (const GGS_AC_5F_machineDefinition & in_mOperand,
                                                    Compiler * inCompiler
                                                    COMMA_LOCATION_ARGS) ;
